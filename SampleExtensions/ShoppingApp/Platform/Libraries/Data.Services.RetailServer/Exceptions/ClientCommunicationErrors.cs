...
namespace Contoso.Commerce.Client.Data.Services.RetailServer
{
    ...
    public static class ClientCommunicationErrors
    {
        ...
        /// </summary>
        public const string NotFound = "Contoso.Commerce.Client_Communication_NotFound";

        /// <summary>
        /// Indicates that there was an error in communicating with the remote server due to network timeout (HTTP 408).
        /// </summary>
        public const string RequestTimeout = "Contoso.Commerce.Client_Communication_RequestTimeOut";
        ...
        /// </summary>
        public const string BadRequest = "Contoso.Commerce.Client_Communication_BadRequest";

        /// <summary>
        /// Indicates that there was an error in deserializations.
        /// </summary>
        public const string DeserializationError = "Contoso.Commerce.Client_Communication_DeserializationError";

        /// <summary>
        /// Indicates that there was an error in communication due to ambiguous requests (HTTP 300).
        /// </summary>
        public const string Ambiguous = "Contoso.Commerce.Client_Communication_Ambiguous";

        /// <summary>
        /// Indicates that there was an error in communication due to redirection (HTTP 306).
        /// </summary>
        public const string Redirection = "Contoso.Commerce.Client_Communication_Redirection";

        /// <summary>
        /// Indicates that there was an error in the user authorization request (HTTP 403).
        /// </summary>
        public const string UserAuthorizationError = "Contoso.Commerce.Client_Communication_UserAuthorizationError";

        /// <summary>
        /// Indicates that there was an error in the user authentication request (HTTP 401).
        /// </summary>
        public const string UserAuthenticationFailure = "Contoso.Commerce.Client_Communication_UserAuthenticationFailure";

        /// <summary>
        /// Indicates that there was an error in establishing communication with the remote server (catch all).
        /// </summary>
        public const string OtherErrors = "Contoso.Commerce.Client_Communication_OtherErrors";
