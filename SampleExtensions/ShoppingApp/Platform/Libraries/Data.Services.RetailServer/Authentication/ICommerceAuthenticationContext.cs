...
namespace Contoso.Commerce.Client.Data.Services.RetailServer.Authentication
{
    ...
    public abstract class CommerceAuthenticationProvider
    {
        ...
        internal abstract Task<string> ChangePassword(string userId, string oldPassword, string newPassword);
        ...
        /// <returns>A Task.</returns>
        internal abstract Task<string> ResetPassword(string userId, string newPassword, bool mustChangePasswordAtNextLogOn);
