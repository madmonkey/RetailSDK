...
namespace Contoso.Commerce.Client.Data.Services.RetailServer
{
    ...
    public sealed class ManagerFactory: IManagerFactory
    {
        ...
        public void Initialize(Uri serviceUrl, string operatingUnitNumber, string locale)
        {
            this.Context = new RetailServerProxyContext(RetailServerContext.Create(serviceUrl, operatingUnitNumber), new ServiceOperationDecorator());
        ...
        public UserToken UserToken
        {
            ...
            set
            {
                this.Context.SetUserToken(value);
            }
        }
