...
namespace Contoso
{
    namespace RetailServer.TestClient
    {
        ...
        internal partial class MainForm
        {
            ...
            this.groupBoxActivation.Text = string.Format("Retailserver / Device details               AppSession ID: {0}", MainForm.AppSessionID.ToString());
            // 
            // chkUseOnlineMode
            // 
            ...
            this.txtNewRetailServerUrl.Text = "https://usnconeboxax1ret.cloud.onebox.dynamics.com";
            // 
            // btnDeactivate
            // 
