namespace Contoso
{
    namespace Commerce.Runtime.DocumentProvider.PosnetSample.DocumentBuilder
    {
        ...
        using Microsoft.Dynamics.Commerce.Runtime.TaxRegistrationIdPoland.DataModel;
        using Microsoft.Dynamics.Commerce.Runtime.TaxRegistrationIdPoland.Messages;
        ...
        public class SalesReceiptBuilder : IFiscalDocumentRequestBuilder
        {
            ...
            private IEnumerable<IPosnetCommandRequest> TransactionNipSet(SalesOrder salesOrder)
            {
                ...
                var fiscalCustomerData = this.Request.RequestContext.Execute<SingleEntityDataServiceResponse<FiscalCustomerData>>(request).Entity;
