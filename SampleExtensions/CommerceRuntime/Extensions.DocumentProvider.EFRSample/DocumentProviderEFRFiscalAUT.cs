...
namespace Contoso
{
    namespace Commerce.Runtime.DocumentProvider.EFRSample
    {
        ...
        /// </summary>
        public class DocumentProviderEFRFiscalAUT : INamedRequestHandlerAsync, IDocumentProviderEFR
        {
            /// <summary>
            ...
            {
                return SalesTransactionAdjustmentHelper.GetSalesOrderAdjustmentType(salesOrder);
            }
