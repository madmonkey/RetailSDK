...
namespace Contoso
{
    namespace Commerce.Runtime.DocumentProvider.EFRSample.DocumentBuilders.GermanyBuilders
    {
        ...
        public class ExpenseAccountsBuilder : IDocumentBuilder
        {
            ...
            /// <summary>
            /// Creates a new instance of <see cref="ExpenseAccountsBuilder"/>.
            /// </summary>
            /// <param name="request">The request.</param>
            /// <param name="transactionId">The transaction identifier.</param>
            public ExpenseAccountsBuilder(GetFiscalDocumentDocumentProviderRequest request, string transactionId)
            {
            ...
            {
                var filteredExpenseExpenseLines = salesOrder.IncomeExpenseLines.Where(incomeExpenseLine => incomeExpenseLine.AccountType == IncomeExpenseAccountType.Expense);

                return filteredExpenseExpenseLines.Select(iel =>
                new ReceiptPosition
                {
