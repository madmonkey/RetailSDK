...
namespace Contoso
{
    ...
    {
        using Contoso.Commerce.Runtime.DocumentProvider.CleanCashSample.DocumentBuilders;
        ...
        public class DocumentProviderCleanCashAsync : INamedRequestHandlerAsync
        {
            ...
            public async Task<Response> Execute(Request request)
            {
                ...
                {
                    response = this.GetSupportedRegisterableEvents();
            ...
            private GetSupportedRegistrableEventsDocumentProviderResponse GetSupportedRegisterableEvents()
            {
