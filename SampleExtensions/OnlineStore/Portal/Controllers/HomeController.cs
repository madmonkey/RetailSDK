    ...
    namespace Retail.Ecommerce.Web.Storefront.Controllers
    {
        ...
        public class HomeController : ActionControllerBase
        {
            ...
            public async Task<ActionResult> Index()
            {
                ...
                var storeDayHours = await orgUnitOperationsHandler.GetStoreDaysByStore("HOUSTON", Utilities.DefaultQuerySettings);
                // Verify storeDayHours value in debugger.
                ...
                IEnumerable<long> catalogs = await productOperationsHandler.GetProductCatalogs(Utilities.DefaultQuerySettings);
                if (catalogs.Any())
                {
                    ...
                    PagedResult<Product> products = await productOperationsHandler.SearchProducts(searchCriteria, new long[] { catalogs.First() }, Utilities.DefaultQuerySettings);
