...
namespace Contoso
{
    namespace Retail.Ecommerce.Web.Storefront.Controllers
    {
        ...
        public class MyAccountController : ActionControllerBase
        {
            ...
            /// <summary>
            /// The wish list action name.
            /// </summary>
            public const string WishListActionName = "WishList";
            ...
            private const string WishListViewName = "WishList";
            ...
            public ActionResult Index()
            {
                ...
                {
                    throw new UserAuthorizationException(SecurityErrors.Microsoft_Dynamics_Commerce_Runtime_AuthorizationFailed.ToString(), "User must sign in first.");
                }
            ...
            /// <summary>
            /// Action for fetching wish lists.
            /// </summary>
            /// <returns>View showing the wish lists.</returns>
            [HttpGet]
            public ActionResult WishList()
            {
                ...
                return this.View(MyAccountController.WishListViewName);
            }
        }
    }
}