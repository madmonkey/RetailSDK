        ...
        public class SignInController : ActionControllerBase
        {
            ...
            public ActionResult Index()
            {
                ...
                if (isActivationFlow)
                {
                    ...
                    authenticationProvidersViewModel.Messages = new []
                    {
                        $"Congratulations! We were able to successfully link your '{externalIdProvider}' account with the Contoso account belonging to '{existingAccount}'",
