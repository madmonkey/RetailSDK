...
[assembly: WebResource("Contoso.Retail.Ecommerce.Sdk.Controls.Common.Images.i_Delete_24_on.png", "image/png")]
[assembly: WebResource("Contoso.Retail.Ecommerce.Sdk.Controls.Common.Images.i_Favorite_24_on.png", "image/png")]
[assembly: WebResource("Contoso.Retail.Ecommerce.Sdk.Controls.Common.Images.i_Edit_24_on.png", "image/png")]
...
namespace Contoso
{
    namespace Retail.Ecommerce.Sdk.Controls
    {
        ...
        public class RetailWebControl : WebControl
        {
            ...
            /// </summary>
            /// <returns>The header markup.</returns>
            internal virtual string GetHeaderMarkup<T>(T argument)
            {
                Collection<string> cssUrls = this.GetCssUrls();
                Collection<string> scriptUrls = this.GetScriptUrls();
                ...
                output += this.GetStartupMarkup(existingHeaderMarkup, argument);
            ...
            protected virtual string GetStartupMarkup(string existingHeaderMarkup)
            {
                ...
                bool configExists = ControlsSection != null
                    ...
                    && !string.IsNullOrWhiteSpace(ControlsSection.Services.WishListWebApiUrl)
                ...
                if (configExists)
                {
                    ...
                    string wishListWebApiUrl = ControlsSection.Services.WishListWebApiUrl;
                    ...
                    string baseStartupScript = string.Format(
                        @"<script type='text/javascript'> var msaxValues = {{
                            ...
                            msax_WishListWebApiUrl: '{6}',
                            msax_RetailOperationsWebApiUrl: '{7}'
                        }};
            ...
            /// <returns>Startup markup.</returns>
            protected virtual string GetStartupMarkup<T>(string existingHeaderMarkup, T argument)
            {
                throw new NotSupportedException("The method must be overriden in inherited classes.");
            }
            ...
            {
                if (existingHeaderMarkup == null)
                {
                    throw new ArgumentNullException(nameof(cssUrls));
                }
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1055:UriReturnValuesShouldNotBeStrings", Justification = "The change would result in cascade changes which would eventually break backward compatibility.")]
