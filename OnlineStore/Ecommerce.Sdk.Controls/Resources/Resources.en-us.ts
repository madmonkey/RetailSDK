...
module Contoso.Retail.Ecommerce.Sdk.Controls {
    ResourceStrings["en-us"] = {
        ...
        String_243: "Create a wish list",
        String_244: "Please enter a name for the wish list",
        String_245: "Wish list",
        String_246: "New wish list",
        String_247: "You have not created any wish lists yet.",
        String_248: "Make a wish list to keep track of the things you really want.",
        String_249: "Edit wish list",
        String_250: "Please enter a new name for the wish list",
        String_251: "Sorry, something went wrong. We couldn't create the wish list.",
        String_252: "Sorry, something went wrong. We couldn't delete the wish list.",
        String_253: "Sorry, something went wrong. We couldn't edit the wish list details. Please refresh the page and try again.",
        String_254: "Sorry, something went wrong. The wish list information couldn't be retrieved. Please refresh the page and try again.",
        String_255: "Items",
        String_256: "Actions",
        String_257: "Last item added",
        String_258: "Please enter a valid name for the wish list",
        String_259: "There are no items in your wish list. Please add items to the list.",
        String_260: "Default",
        String_261: "Add to cart",
        String_262: "Sorry, something went wrong. We couldn't remove the item from your wish list.",
        String_263: "Sorry, something went wrong. We couldn't update the item in your wish list.",
        String_264: "Please select a wish list from the list: ",
        String_265: "Delete wish list",
        String_266: "Are you sure that you want to delete the wish list?",
        String_267: "Delete",
        String_268: "Complete",
        String_269: "Product info unavailable",
        String_270: "This product is not available in the current store.",
        ...
        String_400: "Payment card info is incomplete or not valid, please make sure to fill all the payment fields correctly.",
        String_401: "Sorry, something went wrong. We couldn't save required payment info before redirect.",
        String_402: "Sorry, something went wrong. We couldn't retrieve saved payment info after redirect from payment challenge.",
        ...
        String_610: "Pin",
        String_611: "Expiration year",
        String_612: "Please enter a valid pin",
        String_613: "Please enter a valid expiration year",
        String_614: "Please enter a valid expiration month",
        String_615: "Expiration month",
