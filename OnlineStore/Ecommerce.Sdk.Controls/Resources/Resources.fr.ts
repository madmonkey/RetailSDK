...
module Contoso.Retail.Ecommerce.Sdk.Controls {
    ResourceStrings["fr"] = {
        ...
        String_240: "(FR) Processing",
        String_241: "(FR) Order number: ",
        String_242: "(FR) Order status: ",
        String_243: "(FR) Create a wish list",
        String_244: "(FR) Please enter a name for the wish list",
        String_245: "(FR) Wish list",
        String_246: "(FR) New wish list",
        String_247: "(FR) You have not created any wish lists yet.",
        String_248: "(FR) Make a wish list to keep track of the things you really want.",
        String_249: "(FR) Edit wish list",
        String_250: "(FR) Please enter a new name for the wish list",
        String_251: "(FR) Sorry, something went wrong. We couldn't create the wish list.",
        String_252: "(FR) Sorry, something went wrong. We couldn't delete the wish list.",
        String_253: "(FR) Sorry, something went wrong. We couldn't edit the wish list details. Please refresh the page and try again.",
        String_254: "(FR) Sorry, something went wrong. The wish list information couldn't be retrieved. Please refresh the page and try again.",
        String_255: "(FR) Items",
        String_256: "(FR) Actions",
        String_257: "(FR) Last item added",
        String_258: "(FR) Please enter a valid name for the wish list",
        String_259: "(FR) There are no items in your wish list. Please add items to the list.",
        String_260: "(FR) Default",
        String_262: "(FR) Sorry, something went wrong. We couldn't remove the item from your wish list.",
        String_263: "(FR) Sorry, something went wrong. We couldn't update the item in your wish list.",
        String_264: "(FR) Please select a wish list from the list: ",
        String_265: "(FR) Delete wish list",
        String_266: "(FR) Are you sure that you want to delete the wish list?",
        String_267: "(FR) Delete",
        String_268: "(FR) Complete",
        String_269: "(FR) Product info unavailable",
        String_270: "(FR) This product is not available in the current store.",
