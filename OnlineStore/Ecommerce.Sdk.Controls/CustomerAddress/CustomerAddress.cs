...
namespace Contoso
{
    namespace Retail.Ecommerce.Sdk.Controls
    {
        ...
        [ComVisible(false)]
        public sealed class CustomerAddress : RetailWebControl
        {
            /// <summary>
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "existingHeaderMarkup", Justification = "Ths method is part of the contract which may not be violated.")]
