...
module msaxValues {
    ...
    export var msax_WishListWebApiUrl;
    ...
    export var msax_WishListCount;
    export var msax_WishListIsFullView;
    export var msax_WishListDetailsUrl;
    export var msax_ShowPaging;
    export var msax_EncodedRedirectResponse;
}
...
module Contoso.Retail.Ecommerce.Sdk.Controls {
    ...
    export class Core {
        ...
        public static populateProductDetailsForWishListLine(line: CommerceProxy.Entities.CommerceListLine, simpleProductsByIdMap: CommerceProxy.Entities.SimpleProduct[], currencyStringTemplate: string) {
            Core.populateProductDetailsForLine(line, simpleProductsByIdMap, currencyStringTemplate);
        }

        private static populateProductDetailsForLine(line: any, simpleProductsByIdMap: CommerceProxy.Entities.SimpleProduct[], currencyStringTemplate: string) {
            ...
            if (Utils.isNullOrUndefined(simpleProduct)) {
                line[Constants.ProductNameProperty] = Resources.String_269; /* Product info unavailable */
                line[Constants.ProductDescriptionProperty] = Resources.String_270; /* This product is not available in the current store. */
            ...
            line[Constants.BasePriceProperty] = simpleProduct.BasePrice;
            line[Constants.ItemIdProperty] = simpleProduct.ItemId;
        ...
        public static populateKitItemDetailsForWishListLine(line: CommerceProxy.Entities.CommerceListLine, simpleProductsByIdMap: CommerceProxy.Entities.SimpleProduct[], currencyStringTemplate: string) {
            Core.populateKitItemDetails(line, simpleProductsByIdMap, currencyStringTemplate);
        }
        ...
        public static getSalesStatusString(statusValue: number, transactionTypeValue: number): string {
            var salesStatus = "";
            if (transactionTypeValue == CommerceProxy.Entities.TransactionType.Sales && statusValue == CommerceProxy.Entities.SalesStatus.Unknown) {
                salesStatus = Resources.String_268; /* Complete */
            }
            else if (statusValue == CommerceProxy.Entities.SalesStatus.Unknown) {
