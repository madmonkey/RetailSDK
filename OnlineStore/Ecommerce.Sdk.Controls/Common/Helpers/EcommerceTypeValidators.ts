    ...
    */
    ...
    export class AddressValidator extends EntityValidatorBase {
        ...
        constructor() {
            ...
            this.CountryRegion = new FieldValidator({ required: true, title: Resources.String_83 });
        }
    }
    ...
    export class GiftCardTypeValidator extends EntityValidatorBase {
        ...
        constructor() {
            ...
            this.CardPin = new FieldValidator({ maxLength: 6, required: true, title: Resources.String_612 }); //Please enter a valid pin
            this.CardExpirationYear = new FieldValidator({ maxLength: 4, required: true, title: Resources.String_613 }); //Please enter a valid expiration year
            this.CardExpirationMonth = new FieldValidator({ maxLength: 2, required: true, title: Resources.String_614 }); //Please enter a valid expiration month
        }
    }
    ...
    /**
     * Validator for wish list entity.
     */
    export class WishListValidator extends EntityValidatorBase {
        public WishListName;

        constructor() {
            super();

            this.WishListName = new FieldValidator({ maxLength: 100, required: true, title: Resources.String_184 }); // Please enter a valid name for the wish list
        }
    }
} 