...
namespace Contoso
{
    namespace Retail.Ecommerce.Sdk.Controls
    {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces", Justification = "The full name of the namespace is actually unique.")]
        [ComVisible(false)]
        public sealed class Services : ConfigurationElement
        {
            ...
            private const string WishListWebApiUrlKeyName = "wishListWebApiUrl";
            ...
            /// <summary>
            /// Gets the wish list web API url.
            /// </summary>
            [ConfigurationProperty(WishListWebApiUrlKeyName)]
            public string WishListWebApiUrl
            {
                get { return (string)this[WishListWebApiUrlKeyName]; }
            }
        }
    }
}