...
module Contoso.Retail.Ecommerce.Sdk.Controls {
    export class StoreOperationsWebApi {
        ...
        public static GetGiftCardBalance(tenderTypeId: string,
            giftCardNumber: string,
            giftCardPin: string,
            giftCardExpirationYear: number,
            giftCardExpirationMonth: number,
            callerContext: any): CommerceProxy.IAsyncResult<CommerceProxy.Entities.GiftCard> {
            ...
            var data = {
                ...
                "giftCardExpirationYear": giftCardExpirationYear,
                "giftCardExpirationMonth": giftCardExpirationMonth
            };
