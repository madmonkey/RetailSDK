...
module Contoso.Retail.Ecommerce.Sdk.Controls {
    export class SalesOrderWebApi {
        ...
        public static GetSalesOrderDetailsByTransactionId(transactionId: string, searchLocationValue: number, callerContext: any): CommerceProxy.IAsyncResult<CommerceProxy.Entities.SalesOrder> {
        ...
        public static GetSalesOrderDetailsBySalesId(salesId: string, callerContext: any): CommerceProxy.IAsyncResult<CommerceProxy.Entities.SalesOrder> {
            var asyncResult = new CommerceProxy.AsyncResult<CommerceProxy.Entities.SalesOrder>(callerContext);
