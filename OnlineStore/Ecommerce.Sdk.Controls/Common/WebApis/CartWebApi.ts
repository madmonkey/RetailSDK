...
module Contoso.Retail.Ecommerce.Sdk.Controls {
    export class Constants {
        ...
        public static ItemIdProperty: string = 'ItemId';
        ...
        public static BasePriceProperty: string = 'BasePrice';
        public static NetAmountProperty: string = 'NetAmount';
    ...
    export class CartWebApi {
        ...
        // Calls the RemoveFromCart method.
        public static AddToCart(isCheckoutSession: boolean, cartLines: CommerceProxy.Entities.CartLine[], callerContext: any): CommerceProxy.IAsyncResult<CommerceProxy.Entities.Cart> {
            var asyncResult = new CommerceProxy.AsyncResult<CommerceProxy.Entities.Cart>(callerContext);
        ...
        public static CommenceCheckout(callerContext: any, checkoutData: { isRedirect: boolean }): CommerceProxy.IAsyncResult<CommerceProxy.Entities.Cart> {
            var asyncResult = new CommerceProxy.AsyncResult<CommerceProxy.Entities.Cart>(callerContext);
