...
module Contoso.Retail.Ecommerce.Sdk.Controls {
    ...
    export class OrderHistory {
        ...
        private getSalesStatusString(statusValue: number, transactionTypeValue: number): string {
            return Core.getSalesStatusString(statusValue, transactionTypeValue);
        }
        ...
        private getOrderDetailUrl(salesOrder: CommerceProxy.Entities.SalesOrder): string {
            ...
            if (!Utils.isNullOrWhiteSpace(salesOrder.Id)) {
                url += "?tid=" + salesOrder.Id;
            }

            if (!Utils.isNullOrWhiteSpace(salesOrder.SalesId)) {
            ...
            if (Utils.isNullOrWhiteSpace(url)) {
                ...
                url += "?slv=" + CommerceProxy.Entities.SearchLocation.All;
            }
