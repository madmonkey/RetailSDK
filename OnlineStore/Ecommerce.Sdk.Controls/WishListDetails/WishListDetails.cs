...
[assembly: WebResource("Contoso.Retail.Ecommerce.Sdk.Controls.WishListDetails.WishListDetails.css", "text/css", PerformSubstitution = true)]
...
namespace Contoso
{
    ...
    {
        /// <summary>
        /// The wish list details control.
        /// </summary>
        [AspNetHostingPermission(SecurityAction.Demand, Level = AspNetHostingPermissionLevel.Minimal)]
        [ToolboxData("<{0}:WishListDetails runat=server></{0}:WishListDetails>")]
        [ComVisible(false)]
        public sealed class WishListDetails : RetailWebControl
        {
            /// <summary>
            ...
            {
                return base.GetControlMarkup(WishListDetails.CssClassName);
            }
            ...
            {
                return this.GetHtmlFragment("WishListDetails.WishListDetails.html");
            }
            ...
            private new Collection<string> GetCssUrls()
            {
                ...
                cssUrls.Add(this.GetFileUrl("WishListDetails.WishListDetails.css"));
            ...
            private new string GetStartupMarkup(string existingHeaderMarkup)
            {
                ...
                string wishListStartupScript = @"<script type='text/javascript'></script>";
