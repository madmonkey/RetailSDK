...
namespace Contoso
{
    namespace Retail.Ecommerce.Sdk.Controls
    {
        ...
        public static class MvcHelperExtension
        {
            ...
            /// <param name="encodedRedirectResponse">The encoded response from payment redirect.</param>
            /// <returns>
            /// Checkout control header markup.
            /// </returns>
            public static MvcHtmlString GetCheckoutControlHeader(string orderConfirmationUrl, bool hasInventoryCheck, string encodedRedirectResponse)
            {
                string htmlContent;

                using (Checkout checkout = new Checkout(encodedRedirectResponse))
                {
            ...
            /// <summary>
            /// Gets the wish list control.
            /// </summary>
            /// <returns>
            /// Wish list control markup.
            /// </returns>
            public static MvcHtmlString GetWishListControl()
            {
                string htmlContent;

                using (WishList wishList = new WishList())
                {
                    htmlContent = wishList.GetControlMarkup();
                }
            ...
            /// <summary>
            /// Gets the header for wish list control header.
            /// </summary>
            /// <param name="wishListCount">Indicates the amount of wish lists shown.</param>
            /// <param name="isFullView">Indicates whether the wish list is displayed in full view or condensed view.</param>
            /// <param name="wishListDetailsUrl">Indicates the Url of the wish list details.</param>
            /// <returns>
            /// Wish list control header markup.
            /// </returns>
            public static MvcHtmlString GetWishListControlHeader(int wishListCount, bool isFullView, string wishListDetailsUrl)
            {
                string htmlContent;
                ...
                using (WishList wishList = new WishList())
                {
                    ...
                    wishList.IsFullView = isFullView;
                    wishList.WishListDetailsUrl = wishListDetailsUrl;

                    htmlContent = wishList.GetHeaderMarkup();
                }
            ...
            /// <summary>
            /// Gets the wish list details control.
            /// </summary>
            /// <returns>
            /// Wish list control details markup.
            /// </returns>
            public static MvcHtmlString GetWishListDetailsControl()
            {
                string htmlContent;

                using (WishListDetails wishListDetails = new WishListDetails())
                {
                    htmlContent = wishListDetails.GetControlMarkup();
                }
            ...
            /// <summary>
            /// Gets the header for wish list details control header.
            /// </summary>
            /// <returns>
            /// Wish list details control header markup.
            /// </returns>
            public static MvcHtmlString GetWishListDetailsControlHeader()
            {
                string htmlContent;

                using (WishListDetails wishListDetails = new WishListDetails())
                {
                    htmlContent = wishListDetails.GetHeaderMarkup();
                }
