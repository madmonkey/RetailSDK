...
namespace Contoso
{
    namespace Retail.Ecommerce.Sdk.Controls
    {
        ...
        [ComVisible(false)]
        public sealed class Checkout : RetailWebControl
        {
            private readonly string encodedRedirectResponse;
            ...
            public Checkout(string encodedRedirectResponse) : this()
            {
                this.encodedRedirectResponse = encodedRedirectResponse;
            }
            ...
            internal new string GetHeaderMarkup()
            {
                ...
                string bingMapsLink = string.Format("<script type=\"text/javascript\" src=\"{0}\"></script>", "https://www.bing.com/api/maps/mapcontrol");
                ...
                output += this.GetStartupMarkup(existingHeaderMarkup, this.encodedRedirectResponse);
            ...
            private new string GetStartupMarkup<T>(string existingHeaderMarkup, T argument)
            {
                ...
                if (configExists)
                {
                    ...
                    //JsonConvert.SerializeObject will result in a string "null" if the input object is null, the below line is to avoid that.
                    string convertedArgument = (argument == null) ? null : JsonConvert.SerializeObject(argument);
                    string checkoutStartupScript = string.Format(
                        ...
                        msaxValues['msax_EncodedRedirectResponse'] = '{5}';
                    </script>",
