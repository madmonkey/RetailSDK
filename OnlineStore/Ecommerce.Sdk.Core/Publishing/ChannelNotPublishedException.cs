...
namespace Contoso
{
    namespace Retail.Ecommerce.Sdk.Core.Publishing
    {
        ...
        public class ChannelNotPublishedException : InvalidOperationException
        {
            ...
            /// </summary>
            /// <param name="messageTemplate">The message template with 1 parameter = the channel status value.</param>
            /// <param name="publishingStatus">The publishing status.</param>
            public ChannelNotPublishedException(string messageTemplate, OnlineChannelPublishStatusType publishingStatus) : base()
            {
