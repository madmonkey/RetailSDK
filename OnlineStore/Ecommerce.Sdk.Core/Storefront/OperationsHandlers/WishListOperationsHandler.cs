    ...
    namespace Retail.Ecommerce.Sdk.Core.OperationsHandlers
    {
        ...
        public class WishListOperationsHandler : OperationsHandlerBase
        {
            ...
            public async virtual Task<CommerceList> GetWishList(long wishListId)
            {
                ...
                wishList = await DataAugmenter.GetAugmentedWishList(this.EcommerceContext, wishList);
            ...
            /// </summary>
            /// <param name="wishListId">The wish list identifier.</param>
            /// <param name="lineIds">The line ids to remove from the wish list.</param>
            /// <returns>Returns the updated wish list.</returns>
            public virtual async Task<CommerceList> RemoveItemsFromWishList(long wishListId, IEnumerable<long> lineIds)
            {
                if (lineIds == null)
                {
                ...
                foreach (long lineId in lineIds)
                {
