Sample overview:
The sample shows how the implementation of connecting hardware station via network for cash drawer, payment terminal, and printer.
...
1. Extend Hardware station and Peripheral projects. 
    ...
    - Compile the project, copy the assemblies under Peripherals.Network\bin\Debug. 
    ...
    - Add the below section assembly to the composition:
          <add source="assembly" value="Contoso.Commerce.HardwareStation.Peripherals.Network" />
