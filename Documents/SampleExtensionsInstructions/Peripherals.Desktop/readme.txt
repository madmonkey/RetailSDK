Sample overview:
The sample shows how the implementation of hardware station on Windows PC / desktop for cash drawer, printer, and payment terminal.
...
1. Extend Hardware station and Peripheral projects. 
    ...
    - Compile the project, copy the assemblies under Peripherals.Desktop\bin\Debug. 
    ...
    - Add the below section assembly to the composition:
          <add source="assembly" value="Contoso.Commerce.HardwareStation.Peripherals.Desktop" />
