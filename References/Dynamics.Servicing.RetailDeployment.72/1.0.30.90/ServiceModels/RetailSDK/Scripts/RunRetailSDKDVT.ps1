...
try
{
    ...
    $dvtHelperModuleScriptName = 'CommonDVTHelperModule.psm1'
    Import-Module (Join-Path -Path $scriptDir -ChildPath $dvtHelperModuleScriptName) -DisableNameChecking

    # Script Variables
    [string]$parentDir = Split-Path -Path $PSCommandPath -Parent
    [string]$dvtScript = (Join-Path -Path $parentDir -ChildPath 'ValidateRetailSDK.ps1')
    [string]$serviceModelDirName = 'RunRetailSDKDVT'
    [string]$dvtHelperScript = (Join-Path -Path $scriptDir -ChildPath $dvtHelperModuleScriptName)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAOYCJqaFH221MC
# 3QrIHoptF6u3RPYUqQlGZjb1oHzWzqCCDYEwggX/MIID56ADAgECAhMzAAABh3IX
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINgcFpqX
# J7f8BBUsUPyzZGn75PQ0aRxk7UXh2T6i9PyjMIG6BgorBgEEAYI3AgEMMYGrMIGo
...
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAJwWMABo
# um1TGm/8p/UQA7yhxA2HySX5h1kaOBuNjtt29MM6UFyZJKoDyXaBhV1H20JBbNkr
# oYHx1FtGAXcG+61dykHa1Ux+GieJTfbZIotV30lbNSfjE5f0Bxr6Btxx6jChLf/F
# zl1iIzeAFuTVcTE283nuNNvQcMxToooEQDSzgpYHI884ib5JFw9WODG6/qWTo1R6
# HF/C8aD0ashFt28kjHvP+hH+NsXORnrxAqzwxgZVCzixLGpwf1M//v+Or2/NAiTa
# GkDCA0iVytFq1uwDeOV4GjF1rhVdfQmH4a4q+NLGaEL+UnbR+ICOf5u5hywi/acD
# P71r8tDwSkk9+dShghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg0/qa
# ItPjdt3PIh6/ZCPiM3EgiWbeEn+PBQ9BqYmBWbMCBl86qc71eRgTMjAyMDA4MjMw
# NDAyNTAuOTgyWjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCDm+fBe/Arqx/bUh3gGNuaAvhisKn812ZItJz8y
# YvFAPDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHM75FjD33E6UeW9p588
...
# FLRLLRBjqhhx9QzZYI0WCeswDQYJKoZIhvcNAQELBQAEggEAjL6iVE0q3AXVdQi5
# lhoxiCGTIf3LtphdhNRjMCGWLxY4+rRmgZJB4pc7l/Ii/zZfUdvVMDH8SXp6O0A7
# Ju6AXMYpUyiwtptS7KdY6mw/k24I9+ynMrGaTf6Uz4nlh1h854ncZpa74G0xJOcG
# 8IumkAcx5EzVZalqtLiLbDVXUj5Q+zW5VXHl5xCykRjJbUqiwpkvYGjYF0oymuz3
# XtnRg0ceKKYsrndITuYRq5SV48W9qijBn8qR9KdwW4j5Ld1d6NbpNxtRa37HuhIj
# YAva0GMv5VkIgfMrOp78Sz8ZUp2/FHPzMXLIEtZFbHroJD5xC57lUmtyo2QxlmMQ
# tdbxag==
