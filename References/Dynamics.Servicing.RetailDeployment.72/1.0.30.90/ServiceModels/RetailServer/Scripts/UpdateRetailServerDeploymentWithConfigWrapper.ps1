...
)
{
    ...
    $adminPrincipalName = $config.AdminPrincipalName
...
$azureAuthority = Get-TransactionServiceAzureAuthority -config $settings
...
dbPassword: *******, 
AosUrl: $($settings.AosUrl),
AosSoapUrl: $($settings.AosSoapUrl),
AosWebsiteName, $($settings.AosWebsiteName),
AxDbServer: $($settings.AxDbServer), 
AxDbName: $($settings.AxDbName), 
AxDbDeploySqlUser: $($settings.AxDbDeploySqlUser), 
AxDbDeploySqlPwd: *******,
AxDeployExtUser: $($settings.AxDeployExtUser), 
AxDeployExtUserPassword: *******,
serviceUri: $($settings.serviceUri), 
retailCloudPOSUrl: $($settings.retailCloudPOSUrl),
retailStorefrontUrl: $($settings.retailStorefrontUrl),
AADTokenIssuerPrefix: $($settings.AADTokenIssuerPrefix),
AdminPrincipalName: $($settings.AdminPrincipalName),
AllowAnonymousContextRetailServerRequests: $($settings.AllowAnonymousContextRetailServerRequests),
WebSiteName: $($settings.WebSiteName),
DisableDBServerCertificateValidation: $($settings.DisableDBServerCertificateValidation),
EnvironmentId: $($settings.EnvironmentId),
TenantId: $($settings.TenantId),
RetailRTSAuthenticationCertificateThumbprint: $($settings.RetailRTSAuthenticationCertificateThumbprint),
RetailCryptographyThumbprint: $($settings.RetailCryptographyThumbprint),
UserId: $($settings.UserId),
AzureAuthority: $azureAuthority"

Validate-NotNull $settings.dbUser 'settings.dbUser'
Validate-NotNull $settings.dbPassword 'settings.dbPassword'
Validate-NotNull $settings.AxDbDeploySqlUser 'settings.AxDbDeploySqlUser'
Validate-NotNull $settings.AxDbDeploySqlPwd 'settings.AxDbDeploySqlPwd'

Validate-NotNull $settings.AADLoginWsfedEndpointFormat 'settings.AADLoginWsfedEndpointFormat'
Validate-NotNull $settings.AdminPrincipalName 'settings.AdminPrincipalName'
Validate-NotNull $azureAuthority 'azureAuthority'
...
& "$PSScriptRoot\UpdateRetailServerDeployment.ps1" `
-dbServer $settings.dbServer `
-dbName $settings.dbName `
-dbUser $settings.dbUser `
...
-AxDbName $settings.AxDbName `
-AxDbDeploySqlUser $settings.AxDbDeploySqlUser `
-AxDbDeploySqlPwd $settings.AxDbDeploySqlPwd `
-AxDeployExtUser $settings.AxDeployExtUser `
-AxDeployExtUserPassword $settings.AxDeployExtUserPassword `
-serviceUri $settings.serviceUri `
-AADTokenIssuerPrefix $settings.AADTokenIssuerPrefix `
-AdminPrincipalName $settings.AdminPrincipalName `
-AllowAnonymousContextRetailServerRequests $settings.AllowAnonymousContextRetailServerRequests `
-RetailRTSAuthenticationCertificateThumbprint $settings.RetailRTSAuthenticationCertificateThumbprint `
-retailWebSiteName $settings.WebSiteName `
-retailCloudPOSUrl $settings.retailCloudPOSUrl `
-retailStorefrontUrl $settings.retailStorefrontUrl `
-HardwareStationAppInsightsInstrumentationKey "$($settings.HardwareStationAppInsightsInstrumentationKey)" `
-ClientAppInsightsInstrumentationKey "$($settings.ClientAppInsightsInstrumentationKey)" `
-WindowsPhonePosAppInsightsInstrumentationKey "$($settings.WindowsPhonePosAppInsightsInstrumentationKey)" `
-EnvironmentId "$($settings.EnvironmentId)" `
-TenantId "$($settings.TenantId)" `
-azureAuthority $azureAuthority `
...
-userId "$($settings.UserId)" `
-RetailCryptographyThumbprint "$($settings.RetailCryptographyThumbprint)" `
-DisableDBServerCertificateValidation "$($settings.DisableDBServerCertificateValidation)"  } -logFile $log
# SIG # Begin signature block
# MIIkEAYJKoZIhvcNAQcCoIIkATCCI/0CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8TKqTJa9I35zK
# B5ID+veC8NIjZafrC1CY0IeVki8zx6CCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# D6rztrMs1CXN//gdY6M3ln75LeAss5pP/tJRzQ5JJTCBugYKKwYBBAGCNwIBDDGB
...
# oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQA3
# Dgco3kEnY0wU8gseRf93SaUDU8FoAeuW0nquInCOAlkomDDzSjKQ7opi01C/owHf
# pgXN+tYxJhRGpEbhcRivY7ja7GIxS8AZ/Al7ex1Ru70jbO7Cim7XJpmgQUGJrfYy
# UgtoQ1qkHpBXXymRDQz606prZcO82sA6HfjJy7ZlV8E0BYM4VQXy0Ej8IMHH9CXm
# 57obT9LqhY2QdzNAOnN1oG1srci3fiVs2L+VQ5UIpET/DAhBTKbk6BsmgPmN0DqN
# gVVkc/fFYw+M5kQeudxlDHIr9VInHG7aAYh+1LW8sDZiuARIL4ShnNbJrzjfrAgv
# yyvkCaM28wt9OAZaRxxOoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# IIR3pKV1zF4VwWfcY00INyEeh6ppv7vUj2I6LTTGTYd6AgZfO+WMapMYEzIwMjAw
# ODIzMDQwMjUwLjcxM1owBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgx0zNbc3zLCAEhfBs
# 8hY4hOVfpobXka7xUWrXRPTt5UwwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBAFXFYV38nnLEA7l2ljLbNCT/QQf8oPIK5dKyarZ9Ko+fBPff2yqk4DPs5AqE
# jEuBnTeSuGNnTvbmkxuYURc7kQQ19UR7YdGNE+B0+kwPzRgbKRf1TnNWp8CWqCIT
# uWvluaUvwWeslzT3TEnYZ9MOblGJM7Y3IX4OfrswXX5C/62RGVrq7psMGCzQsvsE
# 8BMxt/gspTJYUWJ4mZOZK53CF0HFOWnPLIr3n2SPDBOlsZ6xZ/encdasZ+p6T3Ef
# uovADRDWKAxLd6+PPVCbfN5RqZuWbizns35W9xfUbkNJ9VS1ERpB0NfwsfBG2Ytq
# 7CVL7MswixdyLfMQvE2w3Q8e9Rk=
