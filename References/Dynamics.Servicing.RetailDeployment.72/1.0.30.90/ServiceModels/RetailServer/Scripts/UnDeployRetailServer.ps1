...
try
{
	...
	Uninstall-WebApplication -WebSiteConfig $rsConfig.WebSite
	Disable-WebApplicationMonitoringDiscovery `
	-WebSiteConfig $rsConfig.WebSite `
	-RetailComponentRegistryKey $RetailComponentRegistryKey
		
	$WebApplicationName = $rsConfig.WebSite.WebApplication.Name
	
	$monitoringEventSourceName = "Microsoft Dynamics AX Retail Monitoring : Retail Server $WebApplicationName"
	$productEventSourceName = "Microsoft Dynamics AX Retail : Retail Server $WebApplicationName"
	$mposMonitoringEventSourceName = "Microsoft Dynamics AX Retail Monitoring : Retail Server $WebApplicationName MPOS"
	
	Remove-ApplicationLogEventSource $monitoringEventSourceName
	Remove-ApplicationLogEventSource $productEventSourceName
	Remove-ApplicationLogEventSource $mposMonitoringEventSourceName
	
	Log-TimedMessage "Finished Retail Server Uninstallation successfully."
}
catch
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDn9cD4ZYUidAdR
# PJc206urwj0kbqEszLKVtCKPzyrU9aCCDYEwggX/MIID56ADAgECAhMzAAABh3IX
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIL3O+FqL
# nZebEY83fonKpykPpJgqtMQOs6CySWKqbfUtMIG6BgorBgEEAYI3AgEMMYGrMIGo
...
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAHYhmFEX
# 2LCy7J3jlezf8iSoeP2g9VkMVy/Njxz+flYHNa1VpIxoO2nbioD9esdypmyl+kUp
# Qfa0oK28q6Qp2rUCx++3KxS9YKjWGFZ59TBZ19Rpl5t8QbweawF8aprf6v2cMPWW
# fMUR+o9JxomfxiGEWZ0p3nC3xNUuOSih+4mPNx4it38hnVRt0LXJk3regl3KwzmJ
# Xc9RX43rI1lAnuL7Qcz80aJ15T6EPCylZHGkAwo5qCzhSD7YviGMJRyK6vgxuH8h
# Iv31/FgaIg3KfK89Ibcam2UKRYZwmrkqEhwkFRWUJp2iPcmqkm58kk4DVxPg8UKw
# CNOE3l8rdpTPouChghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgHmpA
# WSCHnmXOpErXx6yDV75vBO9oDXN2brUL4B1V4WYCBl86qc71dxgTMjAyMDA4MjMw
# NDAyNTAuODQ5WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCB2zUFVgTNyYifduNrwn8QUC6S3pIMWvDDlvMup
# w9Gz+zCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHM75FjD33E6UeW9p588
...
# FLRLLRBjqhhx9QzZYI0WCeswDQYJKoZIhvcNAQELBQAEggEAfDDAut1j4YAJ01U0
# YyTFRiOt5OYp1gUuattNymz9CQ3DaRbhKzx9bcEtGwNfrmlMig4p9+Pdg05WqUZz
# COSID9viNPcyro2Lp/BQpGFdz6sBOdk/5a0MbE334b4k8WwM/aS486G2RVSezdje
# YiVw97M3bcK65tP0uERen7F7NMD/7M+lG+KACaTu2/Mr+oWEof80WYxY0lKs9rHk
# zzjEbR253c4YVQn5WZZtP2UzzleNxDgWhRCl4vqESAlOJxAsQQcFgN5jjWLlh6J1
# KdF1RYmtpn6pbGpqjmHIoWrB1bv+sqsiaUCKV7PrE5yz56SEvj5Cq+ulEYs6g4ya
# YQRMDw==
