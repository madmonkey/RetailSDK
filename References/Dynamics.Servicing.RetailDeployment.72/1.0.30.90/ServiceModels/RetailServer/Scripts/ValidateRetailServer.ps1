# Validate Retail Server deployment

Param(
   [string]$inputXml,
   [string]$log = (Join-Path -Path $env:SystemDrive -ChildPath 'ValidateRetailServer.log')
)
...
[string]$logFile = (Join-Path -Path $logDir -ChildPath 'Debug_ValidateRetailServer.log')

try
{
	Log-TimedMessage -logMessage "Running Retail Server DVT Script" -log $logFile
	...
	[string]$collectorName = 'RunRetailServer.DVT'
	[string]$collectorType = 'PowerShellCollector'
	[string]$targetName = $collectorName
	[string]$serviceModelName = 'RetailServer'
	...
	[string]$xmlChildPath = "{0}_RunRetailServerDVTResults.xml" -f [System.DateTime]::Now.ToFileTimeUtc()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBC2LDXaWg3rFLf
# UkTUl+qu5J7ofR7lwno2KN3JyWNUVqCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# byYwbiHmXOPLisszHWGmq7PkyRktk8H2XUjpsiwoCzCBugYKKwYBBAGCNwIBDDGB
...
# oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAD
# 46ortE10X2pYg+So483k3Lmy74lP1j+lT/AonrpSXZ7rUbXtmKLTqZ/jUH1DYcwH
# 9Gs6homsRTh3ttAyR0qJqoG+6c3CupLHckscEXHh5oeY/B4j3KfNETukZsgV4aJ1
# IdnH/krJaIabNiQamV5XHHvgkPHbDPl6PwRQxB+PPsD/kJgQduZ1ZaC5ataFZ51M
# kOZEvWcermDzkU1CpZE8llpJrZ9654IYU5V9yjpF74f1Kzkyv2wa9K2K0gR5XI1R
# q7NYq4u8jpWlLMtzOwpHDLKShjDMFjiMtnD9czA62uhODhEP+68l4I8veS/iehK0
# ngiA/38oYsSz4C06GmvZoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# IFM3hq6qrOlUiHbvOtOazCOfeZAHjY6J+OZ6ZmXEW7MQAgZfO+WMausYEzIwMjAw
# ODIzMDQwMjU0Ljg4N1owBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQg3iqTGp/4rI/sBlJv
# ewUIJ9Lsr9F6MZoACFQ/iUWRmMkwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBAAmJpRBeTvAt79TPilVHPsafkjAVmkWxCyTI7EeekT3U7u2HCWC4MVBmPU1G
# 18VY055p2XOzcad95bxsSec91TABp6Hn26+ehFPiikPApJ+hvgpan6fl4/Sbb8H5
# Nz53NMfBKbIRtUdgxcevxFzVE91sxguAfmx3WuREiY1Vhf3/fljnADHiuYpymn0M
# j4uXKNEFk0p7+gz5q6AeaecuNHBza9ggF/g69/kCwE15lhx4LuvpBMJ0jTFzXWme
# lXWMcV2AOVj2DWDBzQL8J2E5GnNK2B4sZDTsM6NjhZkhxJuSYAdELBQmPtlUo04M
# 0Cowc66X895xGVGNQDXkSlNQNjQ=
