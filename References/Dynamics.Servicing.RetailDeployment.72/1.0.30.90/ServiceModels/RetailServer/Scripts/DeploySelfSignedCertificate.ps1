...
param(
    [string]$HostName = $(Throw 'HostName parameter required'),
    [string]$CertificationAuthorityCerPath = $(Throw 'CertificationAuthorityCerPath parameter required'),
    [string]$CertificationAuthorityPfxPath = $(Throw 'CertificationAuthorityPfxPath parameter required'),
    [string]$CertificationAuthorityPassword = $(Throw 'CertificationAuthorityPassword parameter required'),
    [string]$MakeCertExecutablePath = $(Throw 'MakeCertExecutablePath parameter required'),
    [string]$CertificationAuthoritySubjectName = $(Throw 'CertificationAuthoritySubjectName parameter required'),
    [string]$ServerCertificateRootStore = $(Throw 'ServerCertificateRootStore parameter required'),
    [string]$ServerCertificateStore = $(Throw 'ServerCertificateStore parameter required'),
    [string]$SettingsFileForUpdate = $(Throw 'SettingsFileForUpdate parameter required'))

if((Test-Path -Path $SettingsFileForUpdate) -ne $True)
{
	throw "File $SettingsFileForUpdate was not found!";
}

$ScriptDir = split-path -parent $MyInvocation.MyCommand.Path;
. $ScriptDir\Common-Configuration.ps1

# Call install server certificate first
${global:LASTEXITCODE} = 0
& $ScriptDir\InstallServerCertificate.ps1 -HostName:$HostName -CertificationAuthorityCerPath:$CertificationAuthorityCerPath -CertificationAuthorityPfxPath:$CertificationAuthorityPfxPath -CertificationAuthorityPassword:$CertificationAuthorityPassword -MakeCertExecutablePath:$MakeCertExecutablePath -CertificationAuthoritySubjectName:$CertificationAuthoritySubjectName -ServerCertificateRootStore:$ServerCertificateRootStore -ServerCertificateStore:$ServerCertificateStore
...
# Get the thumbprint
Write-host "Get the server certificate thumbprint"
$cert = New-Object System.Security.Cryptography.X509Certificates.X509Certificate2;
$cert.Import("$pwd\ServerCertificate.cer");
$ServerCertificateThumbprint = $cert.Thumbprint
Remove-item -Force "$pwd\ServerCertificate.cer"
Write-host "Server certificate thumbprint: $ServerCertificateThumbprint"

UpdateSettingsXmlAttributeValue $SettingsFileForUpdate "RetailServerWebSiteSSLCertificateThumbprint" $ServerCertificateThumbprint


# SIG # Begin signature block
# MIIkEAYJKoZIhvcNAQcCoIIkATCCI/0CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBSzB+LydgDLaWc
# ilJXhlH9+eYIrqygcMoGGomQC1T5gKCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# RiJJGT2QoLu+JIgT01YMaObLnpfT0dxt+BVaWAJmijCBugYKKwYBBAGCNwIBDDGB
...
# oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBS
# jnZ3Mi5Ntxf7/m8zPZm1Do7o1ZigjyjsmCHdTILLHW55tISBHlauB8QXEwRaVVDb
# UioGH4UeeEBQe9Esyv5HCXEz5Rc2m5KtshvFKcFpZQB/cRR4sPjZ8FvzAjq1gUqM
# 4F0Vjpj6+heR5KML/TRB8Z0eMuo61EoG58f++rfCRGEZrdbjhxZeTpXlDLULEP9g
# NdFRm3cyk7AoIAXZOfom8Mo5lxjOIA8p3zGP7sqyEBMon7DdmlnqqM2cVGZpkROy
# KnwWoGTDfXRCROxpnoM8B0yXxUzwvIMQ2j0nq6tkB2dpYDdZ4JRWLt12p02M93YK
# qILZ9Xjg7ptqvUtCdJbfoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# IBhkMoPgh9jU1a1F6sR1fDA8MAZrYi11n/pwXhQDQp2hAgZfO+WMar8YEzIwMjAw
# ODIzMDQwMjUzLjMxOVowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgeLeQsx/ISHyvd5FV
# LkPND3a2qUzhNwWfQrZGGV8DECQwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBAGyq+Xj+PjbDNJK/vkV+r0QN9QQzPZpq2eicX9GzpQG9QCCbKpvVLNUb13Xx
# LvN6+8VPb0rUUOj9PkAJA7Qx2VXTP8na8ZhZuEwC5Jp1zudN1ndtE/PODb4vNFWe
# yqf8jL6lt7z0ZuVm+VbCbuCGhEKxZmWwJ4TE0qZSC7FLSZJ5vyVbp+fV0AoUQH00
# mjkjKVgEaV1ALEJa+w5e6helAC0p14A6HKkHKNMrhdEe0PDCUGpX/hxmj/r2pnPn
# /7K9UcDV8dsFEWZD1VIIv2US1GtPeH0y4U8GeeznCw/l7dGIct/2tnxZdrwR937M
# aH5ISzeZPdKlA9iqWdsyi4TFxBI=
