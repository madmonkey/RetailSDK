param (
	...
	[string]$cposSSLCertificateThumbprint,
	[string]$cposServiceBinarySourceFolder,
	[string]$cposUserName,
	[string]$cposWebsiteName,
	[string]$cposAppPoolName,
	[string]$cposWebAppName,
	[string]$cposHttpPort,
	[string]$cposHttpsPort,
	[string]$cposServerCertificateRootStore,
	[string]$cposServerCertificateStore,
	[string]$cposWebsiteInstallFolder,
	[string]$cposWebApplicationWorkingFolder
)
...
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteSSLCertificateThumbprint" $cposSSLCertificateThumbprint
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebApplicationServiceBinarySourceFolder" $cposServiceBinarySourceFolder
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebAppPoolUser" $cposUserName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteName" $cposWebsiteName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "AppPoolName" $cposAppPoolName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebApplicationName" $cposWebAppName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteHttpPort" $cposHttpPort
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteHttpsPort" $cposHttpsPort
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteSSLCertificateRootStore" $cposServerCertificateRootStore
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteSSLCertificateStore" $cposServerCertificateStore
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteWorkingFolder" $cposWebsiteInstallFolder
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebApplicationWorkingFolder" $cposWebApplicationWorkingFolder
# SIG # Begin signature block
# MIIkEAYJKoZIhvcNAQcCoIIkATCCI/0CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDXyRiYfPwA8g9o
# veA0xWisyZFm/OKyqL+hPSdRAwMCVqCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# MBwGCisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCl
# MmJbuy9yzXD9we5NB5Slr7h9ebhpNrYgwzGAwUScPTCBugYKKwYBBAGCNwIBDDGB
...
# ibwx42dw1mw9Y0iX8JtCFLQAfHdmHjtHiTvnmz9M9Iai5gIl8uUXrD8bt8rGspVP
# wlRDpS4awIOB0QFV9lNRALPqDnxY4H7jBXWmAq9igxuFctNtuz0VBZieBl27J45M
# N2oaCKmx2QuWG5/Vc0ZsP2SttCXEf7h0O33Te+ebZLOLmiyYxqoZ/82COKi8J5iW
# jO4K2t7Pw9hgkmjqcq+gbhhN1Jy2zpw2baCnM4Fgo0JE+IczSi0FnWaIEyzPYM2y
# Qytk2LerpkELQby4TCeqMhhCTUbK9j3VUOrlVJAkTc9MdALeH9cMg5baE3ID4+PR
# dZWDWpituhRozxkq9ZGRoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# IOpr3zioAiVMBUyzAHnPFE7MVobwwNqqSRZla8zX5Y6DAgZfO+Tbze8YEzIwMjAw
# ODIzMDQwMjUwLjU1MVowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgB7EHO42EFrZfQHSv
# 1Hw39i5qG0zAgrWApEKc66+L4BwwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBAAHzZvu2lUzb2vhxW1CVR2RGs+oElEI2VKhY7r75X/iWbuZmkh/FrE3cwmgA
# XQ57NJgNMF5dUgN6SjI2eEkaohWei6IXvWFjh6gSqbx8wcxiakqCfqNghXgMOEGY
# 7xXtkrs2FwPweA9Vz+YDMoHlQTedvTETq00S1HSCDAaSLsmfwuMOVAn+CKUlISzw
# hCyjbNHxohgXTtbs14GnC1OWcmWKI+r+lyQ6ZfsTuVX+g+EaBBjh20afQAwM9f0N
# 2OruizAN22G7pT+WkwbKp0SBaIn8/qlHZGhcTsKoL2BjBGU7s9/5d9qe0F6t4AL6
# eUKL9PesgL3neUNO2HG4ZB62ANs=
