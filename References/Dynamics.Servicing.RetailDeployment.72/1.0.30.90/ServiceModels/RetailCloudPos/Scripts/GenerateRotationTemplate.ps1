...
function Generate-RetailCloudPOSServicingTemplate
{
    $retailCloudPOSRotationInfo = New-Object Microsoft.Dynamics.AX.Servicing.Rotation.RotationInfo
    ...
    [void]($retailCloudPOSRotationInfo.Certificates.Add($sslCertificate))

    return $retailCloudPOSRotationInfo
}
...
try
{
    ...
    $retailCloudPOSServicingTemplate = Generate-RetailCloudPOSServicingTemplate
    Remove-ServicingRotationInfo -Name $serviceModelName -Path $targetLocation

    Add-ServicingRotationInfo -Name $serviceModelName -Value $retailCloudPOSServicingTemplate -Path $targetLocation
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAkKKPouXiqk1HW
# U1scxo8yJtwbVB7SZJ2L0zbE0taQ7aCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# z8BUyZoOLX1KaGwfd08c74iY4AxbqW7zyhRzfzzSEDCBugYKKwYBBAGCNwIBDDGB
...
# V2lyMrS4suz99Jh38B+h2piyi0xrMNo84OXJGtdLNrGnBl61dZ6Qqd+ONaqA6mqA
# kBR7FBwPOD//7xYwYGlU0qKusvkK1jIprWOZIZbqYCxNTRec7LeQJyz4ctA/UBlh
# u4eugwbeiEDmuJx9nbWoAy2+vR97HtdzVHS9LCIT9C3z/0ZoA/PqLX8ui2jJD7ln
# TPpgd5aBrtz4TguN1A4JFoUriTz5d0qvjDE+LteykCtAdy8c5C9xBa1DnyvU4qcZ
# U1fTBna71VZTv9P8UDcezP8OrZPJGD/Tp98LTjP810aCNgaPNWBkImysbLy6UuIl
# myCRzsMnCB8mQiUVzJqHoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# IK5qKT48mKFd0DsAH9cOUss2Y4O1e+36jfxjJG4GGmd+AgZfO+Nac04YEzIwMjAw
# ODIzMDQwMjUwLjY4OFowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgBeOW8vhsoZyGniNR
# geIYaljkiV5czPFvCk3v8BH1rcAwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBAGDKZCeHpLzAiYj2LuHDQB4wOG0hUEGsg1vMPQxzlS4vvMEUEUOMBiWTbmLH
# LZcbiOSTuy76KM6RXhxpWZNMbxBlwyNZ7Ar1YE4DIC1hoBL5o0b6bdv6fVPiRbRe
# D0FFKqVWAgZfswbJowKQDCECS0sBT1L4CQ7hmdc0Zao7ezfazCUE3ygBxlJwOQNu
# dGv3Hee0+17CfCzHdlCAQtxmrf5A98QIO3P4/cBN8veyEglEX+MQVqp2kgnRMtIS
# Cx3Rq4Y2tRbqeGE8ZzSCa9Z9sV88ErgRPB+dPhl+O8qZMGAdX9yHm5egJx41X/Vi
# meYkZBC2XK9sxtC6TvUfBvjSVG4=
