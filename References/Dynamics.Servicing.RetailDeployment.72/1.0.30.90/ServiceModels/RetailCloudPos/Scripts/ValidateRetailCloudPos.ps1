# Validate Retail CloudPos deployment

Param(
   [string]$inputXml,
   [string]$log = (Join-Path -Path $env:SystemDrive -ChildPath 'ValidateRetailCloudPos.log')
)
...
[string]$logFile = (Join-Path -Path $logDir -ChildPath 'Debug_ValidateRetailCloudPos.log')

try
{
	Log-TimedMessage -logMessage "Running Retail Cloud Pos DVT Script" -log $logFile
	...
	[string]$collectorName = 'RunRetailCloudPos.DVT'
	[string]$collectorType = 'PowerShellCollector'
	[string]$targetName = $collectorName
	[string]$serviceModelName = 'RetailCloudPos'
	...
	[string]$xmlChildPath = "{0}_RunRetailCloudPosDVTResults.xml" -f [System.DateTime]::Now.ToFileTimeUtc()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB59v4EvwLoCyS+
# wFGVSoBYDUIbzPGpIvFDPq3noUoyXKCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# yzmFSF4rRsnWnOzlmZjypRAJoxmeBfX7QViIybdpkjCBugYKKwYBBAGCNwIBDDGB
...
# 6SsWsbv4Hvzxwj7vfPscfvec+pij0ASUblcd65BfoZIOMbWWU8exgkrnIGi5M5M9
# WXS5FkzTnaOf8NxGGAxfi0gmE2pX67HTt2zXaWivZg9aeq9Sw592m7Nhit0aID2F
# xzwth9VSqff5kYk5bAJHkkN44zdzUOivraUNTvt2ASFsIetRqWnA1wx4/77thCPU
# CNYgp+ox5GqcVWbUrCzwv8BvqcsabDa0tphwz14J3SYE/+4S0UQuSwAdCvWiV+NP
# z+UMO2uaJ8n1jtgwUCjSISv9BRzQ+H6vUB+20Y+zMHTH4cdbM/Cf4/RGP3T69AVY
# vp6rFsLOVBzZ+ST5d798oYIS5TCCEuEGCisGAQQBgjcDAwExghLRMIISzQYJKoZI
...
# IMoGtTYax1m9QYPTa4AWlszLZstJWWdrLss3p+VbvkZPAgZfPSuXhtUYEzIwMjAw
# ODIzMDQwMjQ5LjM4NVowBIACAfSggdCkgc0wgcoxCzAJBgNVBAYTAlVTMQswCQYD
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgqYHhRUzN6s23wtgd81RfK/Ezq9cc66I0
# riSl7q2IC88wgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBXAzYkM7qhDCgN
...
# oooMu/H2aOjzZBnUZTqvwvMjKN1IMA0GCSqGSIb3DQEBCwUABIIBAI5xdkanYJkZ
# xhCJO+L/8slUxzdTM4fQi9I2i4H2oIM5MX0ODTkf2aIdaj8ApYsd0jV9lUayOzhI
# ZGZY2gBBi/4JejWeUIiu859YlFioBO4pwcL/W9vaO1r0/z0GSfgDb+MwPspY/P6I
# nzzOiGxjV/egwk1s63crtC5EfcWsdDb+ySpqvsElEK6jI51kOx35PAinsA6U83Ju
# KhXrKhPU8oc+El6e93GbTwYfKDWJx3iEGeFrCnjHyfwxvOq/Sm56FSzKhoDcAil+
# C1c3ZzI1bEbrHKzoVj7kaIMorK4FWJdZYIYZIIZyOVfQNUOaDAW3LyIC9cZev4pn
# 5vvOZ+prNdk=
