...
try
{
    ...
    [string[]]$FoldersToCopy = @("Code", "ETWManifest", "Scripts");
    ...
    {	
	    ...
	    {
	        $RetailCloudPOSSourceLocation = Join-Path (Join-Path $RetailCloudPOSPackage.DestinationDirectory $RetailCloudPOSWebSite) $folderToCopy
	        $RetailCloudPOSTargetLocation = Join-Path $settings.BuildLocation $folderToCopy

	        Write-Log "Source: $RetailCloudPOSSourceLocation Target: $RetailCloudPOSTargetLocation"
	        if ((Test-Path $RetailCloudPOSSourceLocation) -and (Test-Path $RetailCloudPOSTargetLocation))
	        {
                    Get-ChildItem -Path $RetailCloudPOSSourceLocation -Exclude "Call-RetailCloudPOSServicing.ps1" | % { Copy-Item $_.fullname $RetailCloudPOSTargetLocation -Recurse -Force -Verbose } *>&1 | Tee-Object -Append -FilePath $log
	        }
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDI+XYTrg3KfVdl
# mlCvRBJCkjBvmRYmyEiXKJp2PYYVzKCCDYEwggX/MIID56ADAgECAhMzAAABh3IX
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBZlJ8ez
# bc/yYZBz1asXb4JkybXvgSQwzChNmBytrsn9MIG6BgorBgEEAYI3AgEMMYGrMIGo
...
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBACg9Vwq8
# 0WsFsqYpsNn/TJhkmxoNyob02qkuZUrqQ74CvsrlUvw9q98jqNV45B2IANVmvl2n
# yDw5bD7qRmTf8b2ncFuEAKZuXDQRqKY4+5WDtguPuOg0G4geP3xyM8FXSOwic4hD
# exmvKLK1x7nOEWii6+RG0cjDrN4NyW7pzFKHVOHl0yiyo7piYINMrWvE6gdEe74v
# FkvpxO3ctIr4Pxfh1B0yZy3+dXVuvkZD+7d3pxgSTmvtgvkmZKV7V1/a+zcXPxsS
# oHBaXgyB0vWMUymLNx29QJwzyaaoFj9uz5gjZPdy3KOAz3l8DX+A4jUFJdx5yMpL
# yzg2g/sHrS/2JNKhghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgf9lJ
# 75WYZHXl14LZ3JlyDG79YZv5tVlb98O6lfOJnjkCBl86qc71bBgTMjAyMDA4MjMw
# NDAyNDkuNTQxWjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCBz+XDBCowjNKA6jR1tDIpQclOCbOM8aA2Rt5Fw
# rUEFqjCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHM75FjD33E6UeW9p588
...
# FLRLLRBjqhhx9QzZYI0WCeswDQYJKoZIhvcNAQELBQAEggEAs/sXHDSrC7+loPq2
# Y2ze8v1gib9LRPla0V3U0FqJCRV84/0cVc63PWn53oaKd2pFPmIeYJYH9Kjz2Gfm
# fycAYaSOjxGnZPLje5cDf3Uh0zhLt51PVLkiNEdleji6iWRzT8NIaw4Oav1BR5yz
# GomeAsUz3+mTgpMljlFrbMlJd/4dTqAy2ZcRf7Fyhqyz8ytSiM8pTXkk+BpxGN0e
# gYsvE8kXPkgRheITV3d9xq/3FezL3F0z2q8BNA2NKCjOtahYAtlJOs+q07jVd9OM
# 0hTBTSC2n6RQJjURf+A+Iy4phZCHP+mS4nIKsIdibO7JGov9KoWjF2f8/uuYQQYA
# PsP+pQ==
