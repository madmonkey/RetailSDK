...
# Run DVT script and output results

Param(
   [string]$serviceModelXml,
   [string]$config,
   [string]$log = (Join-Path -Path $env:SystemDrive -ChildPath 'RunRetailHQConfigurationDVT\RunRetailHQConfigurationDVT.log')
)
...
{
	Throw "At least one of config or serviceModelXml parameters required" 
}
...
Import-Module $dvtHelperScript -DisableNameChecking

# Script Variables
[string]$parentDir = Split-Path -Path $PSCommandPath -Parent
[string]$dvtScript = (Join-Path -Path $parentDir -ChildPath 'ValidateRetailHQConfiguration.ps1')
[string]$serviceModelDirName = 'RunRetailHQConfigurationDVT'
...
try
{
	Run-ServiceModelRetailHQConfigurationDVT -serviceModelXml $serviceModelXml -config $config -serviceModelDirName $serviceModelDirName -dvtScript $dvtScript -dvthelperScripts $dvtHelperScripts -log $log
}
catch
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9Lg5OylRQHEUZ
# q/5zJxWb15EGezol8Y24gfaYEUN03KCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# m7r0MNSPn6nOczLLa/PzknBqT0WwLsMB8PKbE8DGdTCBugYKKwYBBAGCNwIBDDGB
...
# 2d02YN8GkHEpaaixFzNoIIAUlT91JEjshRkTeH5fTLZdv6Wi3j82LogZcnZLFjxR
# yooFkVYRY7SIh8Pn7kUSviB5IaE05t7whTymXTdGjMag+aciw47YafJQam+pTR30
# hrPXeFlBUT8+qhSSM/Z+NLaFsVKjRR7AaKDdrUaTICsKRIbc45N6HO2wiqXxVr/v
# c0VhTcu6cXhQ53JTJVJpzimvRTUDBnzOLWnooO50WPViBjuK5PFThpiL7oOugDg/
# rEMUlySem+1/RsQO9KAJzUqg8LDp/c9uRqqks5etmBpueH/mMdKpoqHDdrgLnr0x
# A/knLQJ9hpcRJEk6nkAYoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# IMok2r48WAG1Q23DSz9F8oW5nLgrvVG6GYile6BKzE3BAgZfO+Tb1mkYEzIwMjAw
# ODIzMDQwMzQxLjc4M1owBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgIQHI8mVLHP2yD/Dr
# yJCb4EWJ5vviGY6DAHu8lfue6zAwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBALrPYy+NYnegIO5QlP7Q21TV2vYnrv6Pg49D9gUaFm1L0nBQJhBK+J9HO6kV
# tI5XaH2EH5D0Vok/Kg4N7qFJUH3cf7/xMJKzEcmpMM8Un7+jMRtW+BkyFGHEb4Ev
# op13AX8k4Amc5NKJL0B9ZyUyo0tUF/4pbq4v9l0UUo1ua9U4/92ZDaLhEZax+IRa
# MnTITOypuYXosawj9NHwCpfIgfyN0Pg7EGMtFmoEUYzbpGoFEYSspK1EiQzQ+BCW
# U3qb//R21f0K97CecMOCXEDeYB54BDvwclnwnsvd7WzN5aQ0EplDhbn4ZrzJmkEN
# Bxx4u2HQCkJKWsA99fRDVwmP0cA=
