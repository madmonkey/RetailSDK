...
function Generate-RetailStoreFrontServicingTemplate
{
    $retailStoreFrontRotationInfo = New-Object Microsoft.Dynamics.AX.Servicing.Rotation.RotationInfo
    ...
    [void]($retailStoreFrontRotationInfo.Certificates.Add($sslCertificate))

    return $retailStoreFrontRotationInfo
}
...
try
{
    ...
    $retailStoreFrontServicingTemplate = Generate-RetailStoreFrontServicingTemplate
    Remove-ServicingRotationInfo -Name $serviceModelName -Path $targetLocation

    Add-ServicingRotationInfo -Name $serviceModelName -Value $retailStoreFrontServicingTemplate -Path $targetLocation
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmIIxJFyI7FXTZ
# FwnrMdbV3+od/g3aTyHCUJUQ6kVKxqCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# zuvzJMjCirX4usu3FXDiUKS7qVrfBZv5reN9NRnfIDCBugYKKwYBBAGCNwIBDDGB
...
# td5v8ERu1n7LggHQZKlSkqNTrHnZH89wVnm9fNCfFqD1I4r+WlMA8OQQlD1XpvnP
# xclROuLVVJibUAIIhnw+8ueaoerWGarQ9R74lxMze1J4aqzywxRwyMl761qpxQBZ
# mP5jFPZTJNuLmXcGWpTbdjOHvRYMs44zI9rvZ12qfebgBc+ByFEK3SQWVs37eFtQ
# ENw6+/qR4DU7L4QyIvq83pOP1cW/pjL3/MF06koR5QKOqH15IjqCPG+vHQ+jI2tY
# dLKX2dOiSoaQDInCpdIBvqEClqs+xTbP+sNKvH5A/xHtLbtbUqVkw+g9Y88EWeBB
# PgNxf/AatoK/+XozcjOEoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# ICw5Y7z720DJXNxBunA96eXyZ0ZieIrZfwaDxPtoDYq4AgZfO+TbzUgYEzIwMjAw
# ODIzMDQwMjQ2Ljk3OFowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQg1lbvKOrUi0+/o3Ce
# FJS1rSew814+ZgbbeI7RsylvtRUwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBAA8lvzMm577/32kzv8SbFDLUKzbBou8Y3zpOoP+1nw+cL6lqnZvsxu3/oxMI
# hf1ut/MJM9/nvbWoRP+J6Ey5Yjuq3Ewe1ivZr7ncwMo4C92PLy8JY7FHR3c4R5aP
# rIzoC26wxagV8BrOLZ/UKKVCbUgCbPXyMgdl6NfO++qO1dY04/vhoUewrdSdmiQk
# +lXk2shhj1ovBXKy9Kk3CORHDf8Z7bbNsCwk2W+2H4SHiAJqoaPpLxha6U5DBxAQ
# 6StYp/E41l11g7b08k701L/8HRZ17b7u5YLM4Cuc5H5dL2GQxBOGgIleG1FxsHFY
# zpFeeN/HXQznnFZhV5r59Im0a3g=
