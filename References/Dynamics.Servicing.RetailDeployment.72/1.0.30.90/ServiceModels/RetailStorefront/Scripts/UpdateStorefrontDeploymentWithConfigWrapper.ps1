...
Write-Log "Got parameters: 
    AADTokenIssuerPrefix: $($settings.RetailServerUrl)"

$componentRootDir  = Split-Path -Path $MyInvocation.MyCommand.Path -Parent
. $componentRootDir\Common-Configuration.ps1

Invoke-ScriptAndRedirectOutput -scriptBlock { & "$PSScriptRoot\UpdateStorefrontDeployment.ps1" `
            -RetailServerUrl $settings.RetailServerUrl } -logFile $log


# SIG # Begin signature block
# MIIkDwYJKoZIhvcNAQcCoIIkADCCI/wCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDfFISwGpG3f8eF
# 8hdPWpVaE2jA++ZPovwwSQWLq4t5zaCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# bWkIqLYefEScavhNGqT5soDfreX9A/rnNwYFXFToHTCBugYKKwYBBAGCNwIBDDGB
...
# dkjJunbTpV1OirX+nSco5wLbKud8qKAdL7BbnkJnxKFRKArjEto9/O66FY34DsLQ
# 8Ehg3DqyZLBZwfFG7fNQfzdxqt9tfPYZIRPa9OvWDiXWosAQfUlkxz92k7YQWYbl
# /WcbkGSSLz90mBwcKLk9c7dJrE7DQIyPHZ/fMm9QOx/hjINPskDCVNgq3mo3lo23
# sEwmPt49kTgtF/fplRGrQnUCuc7HohhHQpwIkqny2tGli8+fNIzxgqQyQMU1QHaR
# dwtXWSZq7mMR9+HGALQMPuXgc/cMVQYHbVkVOrBsaRAqCk9Yr14qr/jYwJPndzOs
# 9PAvCxOlNT0GCJRoBwzcoYIS8DCCEuwGCisGAQQBgjcDAwExghLcMIIS2AYJKoZI
...
# IC79mSU0zIjppjVN1sRBEMiEMRuAYJJjQsaMSY80OoUeAgZfO+TbzfEYEjIwMjAw
# ODIzMDQwMjUwLjYyWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMCVVMxEzARBgNV
# BAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jv
...
# AQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAbEdtsXWtk6iJOXqF2
# 5Oafo97MTobY72Z2h2BEr1hrdDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0E
...
# ggEAby/mwYs9l+2y1zPmtGYrwlSTO03jbTgCsA6JIjt7h4jrmDSFc5EszlGsYy80
# F4v85cCWb0EaPw0uP9jHmmQ5tjp44Ps1vg9DQzBBJzZi7uEcSUx7SpOv13c1RRzV
# FxmikWKssde1EQxdcmN871MZCgBeYeqnMH9hupu93BbrnjNp0iEXP7TbCAn8n5VY
# c6ngoGGjYMdILDgSe/qt4b6WeglfOFxQ6+bRYaLk0X7XUOxQax47uyxcKKbGJRMT
# 1tbJz39Yr7sAScicGTLFS0vs7QKGeILWIeFOjDkiYvY2RF+61qhqqESBPuJ4fPMF
# inVPGwLiHW/lxESYXfe6upznew==
