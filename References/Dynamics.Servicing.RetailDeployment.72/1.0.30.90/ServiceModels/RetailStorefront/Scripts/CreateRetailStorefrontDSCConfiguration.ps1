...
Configuration RetailStorefrontConfiguration {
    param (
        $MachineName,
        $PackageDirectory,
        [xml] $ServiceModelXml)
    ...
    Node $MachineName {        
        ...
        RetailWebsite CreateRetailStorefrontWebsite @params
    }    
}
...
try
{
	...
	RetailStorefrontConfiguration -PackageDirectory $packageDir -MachineName $env:COMPUTERNAME -ServiceModelXml $global:decodedservicemodelxml  -OutputPath $outputpath

	Start-DscConfiguration -Path $outputpath -Wait -Verbose -force
	$ConfigStatus = Get-DscConfigurationStatus
	$ConfigStatus | Format-List -Property * | Out-File -FilePath (Join-Path -Path $global:logdir -ChildPath 'RetailStorefrontConfiguration.log') -Force
    ...
    {
        throw "Retail storefront configuration did not complete, Message: $($ConfigStatus.StatusMessage), see log for details"
    }
}
catch
{    
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDlF64SnQuOekIY
# D0t//DvXcnMmoh+rgBAqO4bs2jtlLKCCDYEwggX/MIID56ADAgECAhMzAAABh3IX
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN9doyEp
# rZanm1TNURuSPHqnN7GnuD5jnRKbWRpueFcOMIG6BgorBgEEAYI3AgEMMYGrMIGo
...
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAEmRYUvn
# l4LgMe3dpMRIX171KBpqN0bbJINK9TLO/KJb7cG0N52OY2g3GEhxRbbi77gTkrDI
# mty6N8UVRaUydJCgkhOJn2LFFSDRZpPaLmOVBAnVOkV4/FdKLJzbas5F/lrYm8No
# nM4N641G4lyRF7omRe7/g3yh6/NIjyN1r/I6wkictKhyPwfrps5IqCDti/jVeAxm
# g+0eUDpx30o5Cdw45v9aR8Q8nAQmgstBBS54Ggemgrvz49fh0auiCT0fOYo/X63B
# Th/FC7voK6FVyzdIK7w1L2fXZ8pChxcyC7Ltxc1deyoW6nuHluyMJ1MUnQFml0+l
# 6oR/h09NmSm4TOKhghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg2Vnk
# wvUEzYxZhIodrWXHDEcUE8WdVybUtR/0dUmlLA4CBl861lpDTxgTMjAyMDA4MjMw
# NDAyNDguMTM2WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCDzOS1YDr/UUxc5992KpwsQ3Xa4vx18dwtneThi
# 71ISRTCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIGxpZsjislnMX7qYH49q
...
# Co3enoOu0wkRoMQ+SLvX6WswDQYJKoZIhvcNAQELBQAEggEAoxzSRpbfPsvOGIdF
# gSwiniNUgVE37QwEj83zElUHJFr8TNrK4XTcmqtbd/bOrDs/xooTysC/oCOsB6VB
# m/Hl9mWXhXH2Nq/8rFZbXp0WFCxQdUv9971sWGSsa/vki+VeACBRS70jQwDf4y+6
# wqg9BVIgK936PxqbM/RkludcuYvoBdkaZ6ttxAnILyD/6d0vGKUkmVaeMKa6bx02
# raD/zegRu9sT9rU8hjqf3IREUWinOyZm5Y1VamLG1oWGhabgE9p1cWws0osMLRWd
# BhTK4C9Nz2+0Nw/21+N8cNrOJ1SHkWmtYmG2SjUB26qPm+StA7iKSqewphtzJVES
# q2+fDQ==
