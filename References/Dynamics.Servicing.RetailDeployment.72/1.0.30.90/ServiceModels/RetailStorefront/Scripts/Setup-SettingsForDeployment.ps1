...
param (
	...
	[string]$storefrontSSLCertificateThumbprint,
	[string]$storefrontServiceBinarySourceFolder,
	[string]$storefrontUserName,
	[string]$storefrontWebsiteName,
	[string]$storefrontAppPoolName,
	[string]$storefrontWebAppName,
	[string]$storefrontHttpPort,
	[string]$storefrontHttpsPort,
	[string]$storefrontServerCertificateRootStore,
	[string]$storefrontServerCertificateStore,
	[string]$storefrontWebsiteInstallFolder,
	[string]$storefrontWebApplicationWorkingFolder
)
...
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteSSLCertificateThumbprint" $storefrontSSLCertificateThumbprint
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebApplicationServiceBinarySourceFolder" $storefrontServiceBinarySourceFolder
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebAppPoolUser" $storefrontUserName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteName" $storefrontWebsiteName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "AppPoolName" $storefrontAppPoolName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebApplicationName" $storefrontWebAppName
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteHttpPort" $storefrontHttpPort
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteHttpsPort" $storefrontHttpsPort
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteSSLCertificateRootStore" $storefrontServerCertificateRootStore
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteSSLCertificateStore" $storefrontServerCertificateStore
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebSiteWorkingFolder" $storefrontWebsiteInstallFolder
UpdateSettingsXmlAttributeValue $SettingsXmlFilePathOutput "WebApplicationWorkingFolder" $storefrontWebApplicationWorkingFolder
# SIG # Begin signature block
# MIIkBAYJKoZIhvcNAQcCoIIj9TCCI/ECAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCCtE1YJme8ciLF
# N4dhanb/0rqK9ekQcKI2EWNDI1s6x6CCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# PSUUBvQOA1Udt/IQPUb2R8HbMt1i5dgBsCxRBfww/jCBugYKKwYBBAGCNwIBDDGB
...
# RJUoTMeG2g4usEZHiAmWZT50Yd1rcGXNSVYmalXXIduwr0mSbY2EjvEyqlrpvdCh
# fHAS4bdRZOKVNOP5kKx+z0oFIMLxNod8G3LZBz1qdYSBUafa9x5Gc0TqYalxuCz3
# 374/pTgH6fQlUZ6+LwthJsXe4d9E/3FzRgDHdAUuUzFiDlovdP30do0mHFPIUZzm
# MceSkXyW12CsqJ6jk7m/gdKYrBicbij547u/ppYLYfMNLCqUfHmyAAoDjS3SFYV5
# 5j9DpHGbXwx5s5lQlMisrxVApIPStQ5FQJ2jSDhSqCw79pe7XVuWRLBZCg7MBCAH
# BwpByQmU30Tmxo5dJ7SdoYIS5TCCEuEGCisGAQQBgjcDAwExghLRMIISzQYJKoZI
...
# IGWQTjlX0dlJLPitQ8So7ASR+P74/og5bPW39zpxXh0aAgZfPVxFK9UYEzIwMjAw
# ODIzMDQwMjQ4LjgyNFowBIACAfSggdCkgc0wgcoxCzAJBgNVBAYTAlVTMQswCQYD
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQghNKh2B3zSGNv4berV2bxvlL/jIGr3VjQ
# rpbHSu41K2owgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAkErCCv+giGoqp
...
# 6ysYf/NGbUI4EY8DaTxh143FJO9UMA0GCSqGSIb3DQEBCwUABIIBAIy8w0e9QCfn
# Tmetpbjv61V1SY7e3QDXQUGbra7rdx92QdDBywmZ1B3Qeyl2S9breGo/g+5ygAvS
# hW0sXg4tnIk9oGlHSkixjCAQ7yKk/7PFaduuqHYceg+Lg1/MqMk1HB4fYXqKJmwu
# DlUjNWDtj5LltVvvofrdUa2ioHKnyzSrHYrJeIsya+sUy9RMWT+FxwRhLlS76kK3
# vtJbHOpC2eAQ7h3fRFx4AbdKBSVtDcTuHL1ob1r+sNnmI+TldeuyYA4RUx7x4kCW
# 7rp7U7DgKbbZqAG+Wd/aVLbzzv+AvxVvVbTDa6WbpwJ3TdwG2cAbyfpw8fx+heL4
# O5CUchkA+Gc=
