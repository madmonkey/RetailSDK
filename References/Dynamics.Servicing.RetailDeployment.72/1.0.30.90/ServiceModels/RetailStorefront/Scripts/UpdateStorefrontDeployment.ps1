param(
    [string]$RetailServerUrl = $(Throw 'RetailServerUrl parameter required'),
    [string]$StorefrontWebSiteName = "RetailStorefront")

$ErrorActionPreference = 'Stop';

$storefrontWebSite = Get-WebSite -Name $StorefrontWebSiteName
$storefrontAppPhysicalPath = $storefrontWebSite.PhysicalPath
$storefrontConfigPath = Join-Path $storefrontAppPhysicalPath 'web.config'

$RetailServerUrl = $RetailServerUrl.trimEnd('/')
...
{
    $RetailServerUrl = $RetailServerUrl.substring(0, $RetailServerUrl.toLower().indexOf('/commerce'))
}

$retailServerFullUrl = ('{0}/Commerce' -f $RetailServerUrl.TrimEnd('/'))

[xml] $storefrontConfigContent = (Get-Content -Path $storefrontConfigPath)
$storefrontConfigContent.SelectSingleNode("/configuration/appSettings/add[@key='RetailServerRoot']").Value = $retailServerFullUrl
$storefrontConfigContent.Save($storefrontConfigPath)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA2m1DPRFuuknxw
# 251HSZVrvkYtTdFdGd8QI2B1RrqEaaCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# MBwGCisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCC3
# xRGw5sCl0SK88QWMVgicN3THtH35Wgsg24NNAcGK5zCBugYKKwYBBAGCNwIBDDGB
...
# 7XvrxlhkUNRWqZ1o2xYRyw29qJCv0CCBhFRGMYMeraT9sbxx9IIDnremlLmdgZLJ
# dWofQOIzvqtlopAm07cPomR4r3cyopbRQAU066eadq0jwOErxk6+Or/skcvzEVX+
# c1LmRF2uSD85vx+yxSAT/r5GnH/V5/GuZnfcSOyu6oJUy+WaFNlU0x11YpLpkfDA
# MWUTu6PPcKlv3IPY/azQQZ1EVKedxj/Thjxph9ftiiSxMlbblmHxX1qnW9QzseHx
# n+DWZJOw/hX1Egyln+J+bc/c/48J9B8ZqGvG9E1QZ0+DhH/wrvjWKHQTvvLEJSOu
# tCkyy7uUPx9tiH4904+PoYIS8TCCEu0GCisGAQQBgjcDAwExghLdMIIS2QYJKoZI
...
# IJBsOGRIS1U+1HTJdSF6DEyCCMSJg23mRZbXyrCN2B1gAgZfO+TbzeMYEzIwMjAw
# ODIzMDQwMjUwLjI4MlowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgJ53H/QHd3ehUWejL
# OA+DAhsKY+JXp4+B6Q31xDCDYXYwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9
...
# BIIBALQCgMI0QU6jyIfEXUGqRQphR3r6hJUIRDV0iuMkXYw0xQ8dpQDA4NlBW3x7
# HAVPHdJYxAPP8yXXvLhP8eOW9ZZDxbaFLqiJr5P6w2LkVmUdxV1JCyHxtt0jntmJ
# DFrMrlkRJ5LWHCjp+1oCIwGfQmKaMQM77JZj6TAMY9TkwrIf7e+bl+PcFohjYKbJ
# NIxxHkOzoKjUnewROLQtYB4FuEbLgKW+S0XmB2Y+IUQnYVOQrK4ExhED53nRJ0oq
# r/5YtwOKiitJ0NXurBgIfU2LbcoQrVXVBdkFeVVqdqbmDGlxznEEy0gzqZqM3GSZ
# KOA+6XAu3TISNZlGbWo7VsRzzno=
