...
export default class MessageDialog {
    ...
    /* Displays a dialog view with a message on the side of the screen. This has the OK and the Cancel buttons.
     *
     * @param {IExtensionContext} context The context of the extension.
     * @param {string} message The message that will be displayed on the dialog.
     * @return {Promise<string>} The dialog result based on the pressed button, either 'OKResult' or 'CancelResult'.
     */
