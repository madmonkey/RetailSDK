System.register(["PosApi/Extend/Triggers/ProductTriggers", "../Managers/AuditEventManager"], function (exports_1, context_1) {
    ...
    var Triggers, AuditEventManager_1, PostVoidProductsTrigger;
    ...
    return {
        ...
        execute: function () {
            PostVoidProductsTrigger = (function (_super) {
                __extends(PostVoidProductsTrigger, _super);
                function PostVoidProductsTrigger() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                PostVoidProductsTrigger.prototype.execute = function (options) {
                    var cart = options.cart;
                    var voidedCartLines = options.cartLines;
                    return new AuditEventManager_1.default(this.context).registerVoidProducts(cart, voidedCartLines);
                };
                return PostVoidProductsTrigger;
            }(Triggers.PostVoidProductsTrigger));
            exports_1("default", PostVoidProductsTrigger);
        }
    };
});
...
// SIG // AIiCeBHNh9uIE0gO340qysrToGZiTHxPn7cFgnjZNEmg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg6Zqv6T8zK6sd
// SIG // 17kai3lCoP0nf2do6GDh6FXMA88yyUkwgboGCisGAQQB
...
// SIG // jZzF4gVtakqNbHZU108luNdmo7C8Dcg1B5CieZnE8P1O
// SIG // ORrNsJIeRsAt93/kFy7qIaz7Wa9EmYC3Y4FDYt6GTQI0
// SIG // 2uiOoEAZRQ43oKkTx8b8PT3ELKM1Axy9kVEiiE3vAOUK
// SIG // PMEX2ZadLjR8Da28tl0Dl71DyQ2eRiWsaAznFXYPsTPB
// SIG // JrWXHtClrG1upFbnwkagklP9+4VgxflwdN3EwqIQBBqK
// SIG // i1IeJoLUmpTxq2sQIpHBkTpcpyYvaiWO5B/QubhhG2zW
// SIG // ggowLw+54lD+iug7+4hxGdalxUvgFt5Les6uBOhZKnzp
// SIG // LHLPwmrSsfXpVYexUScgDmDH43hLf9+636GCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCBdBBNQaQVKuKPT
// SIG // gUt2u3Yv5fP6SMfdb3zMUFuLGGEa4AIGXzvjWnN1GBMy
// SIG // MDIwMDgyMzA0MDI1MS44MjNaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIKTwskHL
// SIG // 7Bdzk/gDZBw3kzn/MmKPWDJkLFmTgbJEg2PKMIH6Bgsq
...
// SIG // AQCOSHwtaryWyxqzd5KIaYYNRLANF/dKF65Ypz2wt4LM
// SIG // 5o4kVmyiq3ELshOqLMynVHSnzA/wAFyrreNa2LQJYypq
// SIG // PUL+zOLlhgTgaaQ9eo3mpr1ihtLfULIE5iie3r0Tw+By
// SIG // rIhQ8dDkK598B/L8r0JJfiwFsto/aaLhIdrXCxaLZ1ps
// SIG // 6wpbyzFI92NrI8ZCyLQqH8Evs9w4+chlLNNURYj4zgPp
// SIG // ipuU8USYcolQoTAjPIVYcNqxX0Vwk7zJXszM+UaZtK5m
// SIG // pPnuWeQAU2MMXvqetLFmQslbAG7+qIaUWbZ7aMR4PCGF
// SIG // i3vQlhKgCJK2s5nFBQ5fE2lFzk5dt9JFIL2x
