System.register(["PosApi/Extend/Triggers/TransactionTriggers", "../Managers/AuditEventManager"], function (exports_1, context_1) {
    "use strict";
    ...
    var Triggers, AuditEventManager_1, PostVoidTransactionTrigger;
    ...
    return {
        ...
        execute: function () {
            PostVoidTransactionTrigger = (function (_super) {
                __extends(PostVoidTransactionTrigger, _super);
                function PostVoidTransactionTrigger() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                PostVoidTransactionTrigger.prototype.execute = function (options) {
                    var voidedCart = options.cart;
                    return new AuditEventManager_1.default(this.context).registerVoidTransaction(voidedCart.Id);
                };
                return PostVoidTransactionTrigger;
            }(Triggers.PostVoidTransactionTrigger));
            exports_1("default", PostVoidTransactionTrigger);
        }
    };
});
...
// SIG // k2xRySqMJdo7C95vQot8c+b3DXN4yOff9hR7sc03zcug
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgtVen1P6k9Q67
// SIG // kxZFHQSNRqmWM62wdO09K34P3qtoqUIwgboGCisGAQQB
...
// SIG // ZaAOI4jRSWAKeKvG2FlAtQpDq+2Gdt3trfj2sGzTNTaD
// SIG // XGzJ2HJD9KN1nzaTrdtshUNlP7MUIGU0SduvYC2yG0Kh
// SIG // mg7JBvMxqERFYNEjD8LgDNQ9hIdCAe+cgnvQKO7q2CCG
// SIG // cvp+5SBl59EAURiYqJcSM910VGVRxirh/svU2W2JWY58
// SIG // LnksDifxrr5/7dczKOlect9P/19FfxShEX3IvcCydAZr
// SIG // OVOpx/vJO69spqnWJesFGowbbc2p+43Ml2g8eN2a6NwE
// SIG // f5yP/AcuE83fCc0JbtxueoOmW9+gsLbAOuzExEamUbsa
// SIG // 0P2jGGp1cJOO4mH4ypQo7qADBB/F3LGIZaGCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCDj39h83gPEpm/S
// SIG // IajUy/TgX6qkyUfltuuhjjXhTD7I3AIGXzvk280KGBMy
// SIG // MDIwMDgyMzA0MDI0Ni4wMzRaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIDOjUh6w
// SIG // SHIdFvRA27MvJ4ZwJv+3/HdlgPmGdO67Rn9fMIH6Bgsq
...
// SIG // AQArt++9oWfrPsOBk7RaYaGW+sewyjXlS9EsUu6Qa1PI
// SIG // fIdygXBINlyJsPxj4Ewkh7DcXBUUVV4sLJswW1wDq8mq
// SIG // evhhOitgGgpXV+46OWTCMXXxkhWwcGoo4EbL7J5iToWE
// SIG // VFGcBatmCcjMWva3RJZRsgz3WpZUEYrCFv3GzdFJKbFA
// SIG // d6PH2JuZBP+50bOci/Rt+7de/0vcF7+c3/WZZ7R10YJQ
// SIG // 9i8g7vG5M/F002A4UngoW/rvYmJGRLl6icGyr2krIZXi
// SIG // 13BeMeJudfY/P7G8ta9+H70p89+6DUWajEPhd0scB6i2
// SIG // hPZVL/odKqSBLPheUJM09zDhi0j2vVnZogKI
