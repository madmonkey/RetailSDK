System.register(["PosApi/Create/RequestHandlers"], function (exports_1, context_1) {
    ...
    var RequestHandlers_1, CancelTransactionResponse;
    ...
    return {
        ...
        execute: function () {
            CancelTransactionResponse = (function (_super) {
            ...
            exports_1("default", CancelTransactionResponse);
        }
    };
});
...
// SIG // kz2uvhSfl8R5ppILY/Pg6P+kfBqx17Ji5W2b0kCx3Cug
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgxmv0FoxY9F12
// SIG // Ew8FZUnJYqO1pEHt9YxH2BlRyDXczj4wgboGCisGAQQB
...
// SIG // DZMR+Zvw7jSdzvHEiKzXT6x3JT7k2YaJ9RqiHmzB+UVA
// SIG // fDdfoTBnZSMBsTyG2G0vTytCCaSPd+lakAnIPsoM5Lav
// SIG // 5sBeoqiaCUwBb5OTYEYuJwOBLb1agZauiagmRsI5B65w
// SIG // zcFN4CpW2aUufe8FSj6KqyyPOpnJfnsyhamqv0AaS+ip
// SIG // B+ax5pxPf7nA0oago34GeJWx1+h6R8vXlz5rnKEcXvDZ
// SIG // MKohckqkR7wz4UQKbatdBs2ruVlCecctwoeXSA1fAjgJ
// SIG // LjLHtOEJQXgC0DYFGAUbYhXdAPuOr3hJy9p3d8//ZWA2
// SIG // as94iWsQwRg1D/T2a7V3zhpc2aHPecLBSqGCEuUwghLh
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCDQ21TCVBSCGUJ8
// SIG // 3rPmOWy2dX1oiRFNxuyyyt7IoCPtdgIGXz1EKhjYGBMy
// SIG // MDIwMDgyMzA0MDI0OC43NDNaMASAAgH0oIHQpIHNMIHK
...
// SIG // LwYJKoZIhvcNAQkEMSIEIGV5tMn9l6S1OTh9KFdHvftF
// SIG // +7QUe03YbL7R4g5Y+/LDMIH6BgsqhkiG9w0BCRACLzGB
...
// SIG // gmehcDANBgkqhkiG9w0BAQsFAASCAQCMZUIgqLlK4N7s
// SIG // VQfpOuNmlWJQTPe/PQG0a9MOQPn83fSAKgHRBCnz+EIZ
// SIG // J0e86s+yVSkgCcw17v4XB+YZcZLx4Dg2dwCW/RvspkGx
// SIG // 6wcInBHX8Rqxing+4D+bsguOVZJcZfBa1nhuh0nJAGGm
// SIG // 65qpf9e6TbD1hZUETmBjPEZfMgxHOCxVcSHMGqCPWT5A
// SIG // H1NtYPD89i5qj1BNuhkvGVwZoI6Ge9j/40HDzNNfrUvp
// SIG // 1zcvzSo+RAKLfpb0G9VMCf4df1LEJYF2xJqLjDH0k3bk
// SIG // 6L2DSfKJ2ddJDMIKHL+90UitQNA4/to2dNYDEWMO6Qdh
// SIG // vHJ2TBPKKLiEp2wBEmQ+
