System.register(["PosApi/Extend/Views/ShowJournalView", "../../Managers/CancelTransactionOperationManager", "../../Messages/CancelTransactionRequest", "../../Helpers/ErrorHelper"], function (exports_1, context_1) {
    "use strict";
    ...
    var ShowJournalView, CancelTransactionOperationManager_1, CancelTransactionRequest_1, ErrorHelper_1, CancelTransactionOperationCommand;
    ...
    return {
        ...
        execute: function () {
            CancelTransactionOperationCommand = (function (_super) {
                __extends(CancelTransactionOperationCommand, _super);
                function CancelTransactionOperationCommand(context) {
                    var _this = _super.call(this, context) || this;
                    _this.id = "cancelTransactionOperationCommand";
                    _this.label = _this.context.resources.getString("EFD_BR_Show_Journal_Command_Label");
                ...
                CancelTransactionOperationCommand.prototype.init = function (state) {
                    this.isVisible = true;
                };
                CancelTransactionOperationCommand.prototype.execute = function () {
                    var _this = this;
                    this.isProcessing = true;
                    var cancelTransactionRequest = new CancelTransactionRequest_1.default(this.context.logger.getNewCorrelationId(), this._selectedJournal);
                    this.context.runtime.executeAsync(cancelTransactionRequest)
                        .then(function () {
                        _this.isProcessing = false;
                    })
                        .catch(function (reason) {
                        _this.isProcessing = false;
                        ErrorHelper_1.ErrorHelper.displayErrorAsync(_this.context, reason);
                    });
                };
                CancelTransactionOperationCommand.prototype._journalChanged = function (data) {
                    this._selectedJournal = data.salesOrder;
                    this.canExecute = CancelTransactionOperationManager_1.default.isJournalCanBeCanceled(data.salesOrder);
                };
                return CancelTransactionOperationCommand;
            }(ShowJournalView.ShowJournalExtensionCommandBase));
            exports_1("default", CancelTransactionOperationCommand);
        }
    };
});
...
// SIG // q97RmSbWSmqUnP05f/KiLsRSqhjQKfRYpNRXGISyKpGg
...
// SIG // AgEVMC8GCSqGSIb3DQEJBDEiBCBwlKfKVCnlAiKUcfRu
// SIG // ic5F+LfOw0ZdehREi6r3+cV7eTCBugYKKwYBBAGCNwIB
...
// SIG // cm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQCdnQjR
// SIG // sjirakcwSNZqlZVrfXpw6XDc4+Ok7a32VoNAUAS1cOeq
// SIG // ERQUJHR9Zn56ZOQGV4wMt3lwkGdU8o/RlDdE/3O1XhvP
// SIG // DHRzyledn7Xong5ns6Yl2n7nC40BUec4jOSu2QhRiugq
// SIG // 8t1eiS+umlESPwyxU0EmwI8VqvAuUIcEdqk5Dmmd98Dp
// SIG // k0qIAn0nLyd/Ob3eVwkz2c6jXDQwRc9BjB4XoaI2scSP
// SIG // zjD4qbfVYEbP3TQq9PTH42Ot8AMTA/SQ53a4oywkZLy4
// SIG // rEADwODtuvHInBROWfiUcCZuXjiq9aGTThxOicLFOgWP
// SIG // M44U1ki8z/iT099QIDmHBpnfQUvYoYIS5TCCEuEGCisG
...
// SIG // MDEwDQYJYIZIAWUDBAIBBQAEIBK7paBGE8byt5tyLVIU
// SIG // +YrWWmxfHu2Zu2YlMDh2rSMCAgZfOqnO9XQYEzIwMjAw
// SIG // ODIzMDQwMjUwLjU5NlowBIACAfSggdCkgc0wgcoxCzAJ
...
// SIG // hkiG9w0BCQQxIgQg8WlkAS+HDR8tPdIaZEBrV199fR1Q
// SIG // QyDOBTlAgGICmtMwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
// SIG // MA0GCSqGSIb3DQEBCwUABIIBAJB5Mw/gZJ1CoXHSckCC
// SIG // 9BVCLdJ3uolLR4MujmR7S+nQ+8mwyHfQretVT2+N31yE
// SIG // ns9DDoi3tebEkeANDedbr05/4ahic0HVXCMf7E4ZAAPg
// SIG // wlJw/daui7gQgLdWEbQuaSLjOJGf4tU8Zx4jYv8Sjll0
// SIG // tpg8nyklEj+RYhiuv5kmwyA4KzF+X9Z5Hn1mRYEB37iE
// SIG // ZnyRPWyua5E2N34Idas1K2+QVXSXBGiZaGekjzt0SLIn
// SIG // /jciF382iyEA26eUv/DJBbxc6pGed7u6x21WO/mljnzv
// SIG // QtDKVb9x+FatBVAgTcvfrqYyKz+hO0IpuviSVl9lirtP
// SIG // PjU1KwpzkRj3c0o=
