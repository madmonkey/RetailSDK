System.register(["PosApi/Extend/Views/CustomerAddEditView", "../../Helpers/ExtensionPropertyHelper", "../../TaxRegistrationIdItalyConstants", "PosApi/TypeExtensions"], function (exports_1, context_1) {
    "use strict";
    ...
    var CustomerAddEditView_1, ExtensionPropertyHelper_1, TaxRegistrationIdItalyConstants_1, TypeExtensions_1, CustomerTaxRegistrationIdFieldsControl;
        ...
        execute: function () {
            CustomerTaxRegistrationIdFieldsControl = (function (_super) {
                ...
                function CustomerTaxRegistrationIdFieldsControl(id, context) {
                    ...
                    _this.fiscalCode = ko.observable(null);
                    return _this;
                }
                ...
                CustomerTaxRegistrationIdFieldsControl.prototype.init = function (state) {
                    var _this = this;
                    var fiscalCode = TypeExtensions_1.StringExtensions.EMPTY;
                    var fiscalCodeExtensionProperty = ExtensionPropertyHelper_1.default.getExtensionPropertyByName(this.customer.ExtensionProperties, TaxRegistrationIdItalyConstants_1.default.CUSTOMER_FISCAL_CODE_EXTENSION_PROPERTY_NAME);
                    if (!TypeExtensions_1.ObjectExtensions.isNullOrUndefined(fiscalCodeExtensionProperty)) {
                        fiscalCode = fiscalCodeExtensionProperty.StringValue;
                    }
                    this.fiscalCode(fiscalCode);
                    this.isVisible = true;
                    this.fiscalCode.subscribe(function (newValue) {
                        _this.updateCustomerFiscalCodeExtensionProperty(newValue);
                    });
                };
                CustomerTaxRegistrationIdFieldsControl.prototype.updateCustomerFiscalCodeExtensionProperty = function (fiscalCode) {
                    var updatedCustomer = this.customer;
                    var newExtensionPropertyValue = {
                        StringValue: fiscalCode
                    };
                    updatedCustomer.ExtensionProperties = ExtensionPropertyHelper_1.default.setExtensionPropertyByName(updatedCustomer.ExtensionProperties, TaxRegistrationIdItalyConstants_1.default.CUSTOMER_FISCAL_CODE_EXTENSION_PROPERTY_NAME, newExtensionPropertyValue);
...
// SIG // QRXH3Zaxo6yADKCWF53vqXNjuSFK98t8c1DI9fTe79qg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgJKafxjxQJokb
// SIG // BcybgWl1/YHI0brJ+rTT+Pj31y5inVYwgboGCisGAQQB
...
// SIG // JGjarZOW8pcx/cKzUnXU7m1p5cs5Ngc8XZwGes4J7N14
// SIG // Oa0+AyLs/1KGM0yNh6DjrjsmbU0mypr+RgCacl4E9Azd
// SIG // PGnPs7Y+vBTvBVg5epruTUcPMzgbO9FigBT2MMbe3oJJ
// SIG // +4aLvKVY0V/OGNozgcWPFNKomAyErPjBbvvEvS9LvLHi
// SIG // igddCDYhQBJxlFGubnlDvS+JaEisIlwY57BOVpj/EvK+
// SIG // vLg4NY5ceEwp3OyttNlYP5Ni5davsDXW+OUOU4tJWCxO
// SIG // GyFTphtV7mTO5Sz8Jgwcb4mbkAOxJZmX6cTl3Meo6517
// SIG // 1jYEmMMNHynp0gzdyQiF6jvMLetr+DmooqGCEvAwghLs
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUAB