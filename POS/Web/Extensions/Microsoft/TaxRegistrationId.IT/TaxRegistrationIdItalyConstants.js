System.register([], function (exports_1, context_1) {
    "use strict";
    var TaxRegistrationIdItalyConstants;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [],
        execute: function () {
            TaxRegistrationIdItalyConstants = (function () {
                function TaxRegistrationIdItalyConstants() {
                }
                TaxRegistrationIdItalyConstants.FISCAL_CUSTOMER_DATA_EXTENSION_PROPERTY_NAME = "FiscalCustomerData_3B79847D";
                TaxRegistrationIdItalyConstants.CUSTOMER_FISCAL_CODE_EXTENSION_PROPERTY_NAME = "CustomerFiscalCode_711D3B0C";
                TaxRegistrationIdItalyConstants.IS_FISCAL_CUSTOMER_REQUIRED_FOR_TRANSACTION_PROPERTY_NAME = "IsFiscalCustomerRequiredForTransaction_0B903D6E";
                TaxRegistrationIdItalyConstants.OK_BUTTON_ID = "OKButton";
                TaxRegistrationIdItalyConstants.CANCEL_BUTTON_ID = "CancelButton";
                TaxRegistrationIdItalyConstants.YES_BUTTON_ID = "YesButton";
                TaxRegistrationIdItalyConstants.NO_BUTTON_ID = "NoButton";
                TaxRegistrationIdItalyConstants.YES_BUTTON_RESULT = "Yes";
                TaxRegistrationIdItalyConstants.NO_BUTTON_RESULT = "No";
                TaxRegistrationIdItalyConstants.CUSTOMER_TAX_REGISTRATION_EXTENSION_PROPERTY_NAME = "CustomerTaxRegistration_B994C7CF";
                return TaxRegistrationIdItalyConstants;
            }());
            exports_1("default", TaxRegistrationIdItalyConstants);
        }
    };
});
...
// SIG // k0lG1WzyBUJTjDAtv2BR7bRcm3j+N1oDKnCB+wU4wI2g
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgosQ72YV/2/vW
// SIG // 8kZ4+B4F/g3uQJpb4F3b1ttAwy9RsHIwgboGCisGAQQB
...
// SIG // UDBMK8NCNMJ7IrNSSdlT0l0FiV18lnk0Xh9l+l4DNbuL
// SIG // yYlP+svqKpelHtPTvL4V0XLG906gN36Q7BbFmPtlak49
// SIG // biqITTDTHHCFTMQ/y1LrOoz6guj45A5zHGNx7UpnjPQZ
// SIG // 3LUzjbeSSj0ALWKGAgdXYYZxkyAhuxpfLOC7pQuPvOLB
// SIG // fbwD2qq7dtjSbN2LMJnHS1ZqUv/Yv9tVg16e0ucEUF35
// SIG // zZ/ozUT3s4Cp3dX0mOHgcXyNCp9kx7S0WqbQQX6IdoaX
// SIG // hj8uWwr9/Rs1/Cc2G0ve+N6H8LauSiCgL8xygUeN0AY1
// SIG // kAs6HlslTT2mprtnBgSmCQBhyg3BnGILkaGCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCA+kmow6FW4cAfy
// SIG // vucV/Zd4xX/xLIPr2j2sfqcYySFHhAIGXzvk283wGBMy
// SIG // MDIwMDgyMzA0MDI1MC41NThaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIByj24H2
// SIG // WcnK7cZiWGBHTwaT0RqMv6hDzvRYszW3kVuyMIH6Bgsq
...
// SIG // AQAXMwhVU8MOr27MHsJIG/ONcBtlMacMA02VS3UhWrel
// SIG // THNDSNoh1tQH0+/pouvh9LGrEb8BtEL5++3CnEidiRy5
// SIG // uAG2jTAfwDdHBzykVCphWfWaCCBMzNKWJBRwDoq/SJJh
// SIG // QSTTneWINrBw79AGIQM2IPEP2uNZH29jbpW5NYPyDdij
// SIG // 0TqZbWvcI/0dyh+c80SsqXjABWaOvwaPrGPkz7v89H83
// SIG // GHQ6Ch5mNSM8ooye7aN/y0IK3jpUp61qJM+CDOG0a9uC
// SIG // 4/LDJMGEradXo3+1STHq9XyDWoNnBwhzcFWWhpiOG2/P
// SIG // k1cf/N06CBGmbAYU06kPQSxZERSeF2dY//so
