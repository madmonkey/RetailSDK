System.register(["./FiscalCustomerDialogBase", "PosApi/TypeExtensions", "../../TaxRegistrationIdPolandConstants"], function (exports_1, context_1) {
    "use strict";
    ...
    var FiscalCustomerDialogBase_1, TypeExtensions_1, TaxRegistrationIdPolandConstants_1, EditFiscalCustomerDialog;
    ...
    return {
        ...
        execute: function () {
            EditFiscalCustomerDialog = (function (_super) {
                __extends(EditFiscalCustomerDialog, _super);
                function EditFiscalCustomerDialog() {
                    var _this = _super.call(this) || this;
                    _this.vatId = ko.observable(TypeExtensions_1.StringExtensions.EMPTY);
                    _this.isReadOnly = ko.observable(false);
                    return _this;
                }
                EditFiscalCustomerDialog.prototype.open = function (options) {
                    this._onBeforeClose = options.onBeforeClose;
                    this.isReadOnly(options.readOnly);
                    if (!TypeExtensions_1.ObjectExtensions.isNullOrUndefined(options.fiscalCustomerData)) {
                        this.vatId(options.fiscalCustomerData.VatId);
                    }
                    return _super.prototype.open.call(this, options);
                };
                EditFiscalCustomerDialog.prototype.getVatIdPlaceholder = function () {
                    if (this.isReadOnly) {
                        return this.getResx("Tax_Registration_ID_PL_Vat_Number_Input_Empty_Placeholder");
                    }
                    else {
                        return TypeExtensions_1.StringExtensions.EMPTY;
                    }
                };
                EditFiscalCustomerDialog.prototype._getTemplatedDialogOptions = function (options) {
                    var _this = this;
                    return {
                        title: options.title,
                        ...
                        button1: {
                            id: TaxRegistrationIdPolandConstants_1.default.OK_BUTTON_ID,
                            label: this.getResx("Tax_Registration_ID_PL_OK_Button_Label"),
                            isPrimary: true,
                            onClick: function () { return _this._onOKButtonClick(); }
                        },
                        button2: {
                ...
                EditFiscalCustomerDialog.prototype._onOKButtonClick = function () {
                ...
                EditFiscalCustomerDialog.prototype._onCancelButtonClick = function () {
                    this._closeDialogWithResult({ canceled: true, data: null });
                    return false;
                };
                return EditFiscalCustomerDialog;
            }(FiscalCustomerDialogBase_1.default));
            exports_1("default", EditFiscalCustomerDialog);
        }
    };
});
...
// SIG // IIJJKLQ18E6LSbJB7pYn64OHZsJGExqBuNMomxEXr3Kg
...
// SIG // AgEVMC8GCSqGSIb3DQEJBDEiBCAufAibRl0r/tOglPeY
// SIG // MIATUMNqwDu0lH8FEOg7+1qg7zCBugYKKwYBBAGCNwIB
...
// SIG // cm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQB99nEM
// SIG // UDMaeoacaDIFyHs0EvchStYatDWAe+FXV9sjxaS5FiGZ
// SIG // t1ZmTk1prxaEeJE15VNJR6aC3YON3Y4EMs1sjTa0REsx
// SIG // piEmZND0oPdwdso0/8+xuGyKn0pp/ja+jEAFSp2qyzJS
// SIG // TCfeHIeA+3cyGvyrSLzk/4A7SOeTNyrvGDVWjQalfzXe
// SIG // KoRvU9xBQuQm4AIv605Y6/Y1BeEtipn5zA8LwHm0nn50
// SIG // Eh+2hB5+43O0yyharNW2eVZ5wvL9//sD8M4+5zig7hjK
// SIG // HZGVqP4NKMVqDVE+UGp66r5IoAADyRlDo+Z4jK0lEYct
// SIG // 2dYOPcPE7zbnPv5+ndCWZJRkEuGYoYIS5TCCEuEGCisG
...
// SIG // MDEwDQYJYIZIAWUDBAIBBQAEIL44+a64edPinhpGSqkc
// SIG // Tsk1rxgCvK6ldQbZ0WOcdzpWAgZfOqnO9XAYEzIwMjAw
// SIG // ODIzMDQwMjQ5Ljg4M1owBIACAfSggdCkgc0wgcoxCzAJ
...
// SIG // hkiG9w0BCQQxIgQgXSzUEgiOMBl/ykVtX/rdQtglCUw4
// SIG // PA3Rc8G933zsDrUwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
// SIG // MA0GCSqGSIb3DQEBCwUABIIBABWzh9166LFcQRaO02RY
// SIG // UG7xiUBvv9XlI4FUWSVdVjmMHo9hz3m9oeGX78hZqryN
// SIG // 2I0Gf2bmH6SfSVcC2DtWdTDiyQBW0xCyPf/+yooRE1Jc
// SIG // djLRljvtZGOIITk3pbyWBQhmkI2bvrEdBPx7o+PFrC2B
// SIG // QqNlKGvPLaGXXgKZq7I5IPobQOuSZUCbaM2t2+OxZ8nq
// SIG // ZBhBuGtcMYmO4w9rwBecvJ+m7QXY7bqmdndxfcqLU25x
// SIG // 8OquQuA+BBfLOk2aqZ6DzuELIDCAo5TaVoofGYH5724M
// SIG // yyZdSO3VL/ptMeykDNavfK45DqOSD0Xmfi8K91mOBay9
// SIG // fT/Gi5vc5JQV4DY=
