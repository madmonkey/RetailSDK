System.register(["PosApi/Create/Operations"], function (exports_1, context_1) {
    ...
    var Operations_1, AddFiscalCustomerOperationRequest;
    ...
    return {
        ...
        execute: function () {
            AddFiscalCustomerOperationRequest = (function (_super) {
                __extends(AddFiscalCustomerOperationRequest, _super);
                function AddFiscalCustomerOperationRequest(correlationId) {
                    return _super.call(this, AddFiscalCustomerOperationRequest.OPERATION_ID, correlationId) || this;
                }
                AddFiscalCustomerOperationRequest.OPERATION_ID = 3500;
                return AddFiscalCustomerOperationRequest;
            }(Operations_1.ExtensionOperationRequestBase));
            exports_1("default", AddFiscalCustomerOperationRequest);
        }
    };
});
...
// SIG // XfK1ZOqV+jdNUG6KSDe2Nq7Q//dnw5gGkUeqy0GLLpWg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgKZIKF/AsHS35
// SIG // sOTQJ9D3jlAWJ8AR8Q+qFqF/SgJnXlswgboGCisGAQQB
...
// SIG // jSYvGzwIv+Zv8m+CRtoN0DhRkMSALSBDUCGq5yAYVsUy
// SIG // Gxto/dZb+D/WkRwtIiRHW5BY3LCxOyWeHvw/Lhh/62/t
// SIG // Qov78EO5r/cTj2TW6QofMldylKhHGmC8PLrNOT2K1UwR
// SIG // Y3igJaebQndGIv0C3z9marlhzhyyN039aWAqgGhB9pfg
// SIG // MDs5nZ0XIuBYjM+zm7bxB1CkvDFTzdiSa5nma6sUiKVJ
// SIG // 9EHO8Q41yGvMWHHBBmnRpUC9LGocmwDThoMQnPigwIv0
// SIG // YRKrUk2gT0zFi4QxqAIPsqp9Zgy1pwS+monsBYZCWyIq
// SIG // zPw2LP73vXWIJ3WLcaeVhu7xQ2sTz4VNiKGCEuUwghLh
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCAC6bVysZj+giHE
// SIG // a7EikJXfPe3kSIygXpIvP3QYTeyU0AIGXz0tUEjxGBMy
// SIG // MDIwMDgyMzA0MDI0OS4wMTVaMASAAgH0oIHQpIHNMIHK
...
// SIG // LwYJKoZIhvcNAQkEMSIEIOjSIYXi4oNnBwCO6GKnJ443
// SIG // 1kaIUtxdCv+L3rhLVtoTMIH6BgsqhkiG9w0BCRACLzGB
...
// SIG // 3Dd1ozANBgkqhkiG9w0BAQsFAASCAQCILVBAvDq2D/p0
// SIG // vp0MA30e1Jujm5HtYcdNtHX+eCYg/Y0Z4mi9i7njWv28
// SIG // 8+Oofumgm89NidY4jKTym7v4aeLCzj+RsPgYi0AiEI9D
// SIG // ETan8W0DiK23NGgIgXsx19ggZDcQbMvwFCJKJm8yuifh
// SIG // ls5ebBBtP4Q1MbyoanpS0mobjpSR1ivTBcYhbRvtyvPS
// SIG // JwUuej9h0phwL2GWiGymT+eXFXNftG8+j0kTLB5/NsVw
// SIG // MvcN/2kvIyOk5+Oy6bqAKUPIN+nITaXxgB+QDVa8RPVm
// SIG // lIuI7zS9LApb7gCLOWMjp+YVlAuObBmLtjMEpJqetl6U
// SIG // RZIY5NnI7PQQs19cJHst
