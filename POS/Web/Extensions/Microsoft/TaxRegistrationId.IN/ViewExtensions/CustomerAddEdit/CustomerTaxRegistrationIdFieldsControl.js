System.register(["PosApi/Extend/Views/CustomerAddEditView", "PosApi/TypeExtensions", "../../Entities/DataServiceEntities.g"], function (exports_1, context_1) {
    "use strict";
    ...
    var CustomerAddEditView_1, TypeExtensions_1, DataServiceEntities_g_1, CustomerTaxRegistrationIdFieldsControl;
        ...
        execute: function () {
            CustomerTaxRegistrationIdFieldsControl = (function (_super) {
                ...
                function CustomerTaxRegistrationIdFieldsControl(id, context) {
                    ...
                    _this.customerTaxInformation = null;
                    _this.panNumber = ko.observable(null);
                    return _this;
                }
                ...
                CustomerTaxRegistrationIdFieldsControl.prototype.init = function (state) {
                    ...
                    this.panNumber(this.customerTaxInformation.PanNumber);
                    this.isVisible = true;
                    this.panNumber.subscribe(function (newValue) {
                        _this.customerTaxInformation.PanNumber = newValue;
                ...
                CustomerTaxRegistrationIdFieldsControl.prototype._loadExtensionPropertyValue = function () {
                    try {
                        ...
                        if (TypeExtensions_1.ObjectExtensions.isNullOrUndefined(propertyValue) || TypeExtensions_1.StringExtensions.isNullOrWhitespace(propertyValue.StringValue)) {
                            this.customerTaxInformation = new DataServiceEntities_g_1.Entities.CustomerTaxInformation();
                        }
                        else {
                            this.customerTaxInformation = JSON.parse(propertyValue.StringValue);
                        }
                    }
                    catch (ex) {
                ...
                CustomerTaxRegistrationIdFieldsControl.prototype.updateExtensionPropertyValue = function () {
                    try {
                        var serializedTaxInformation = JSON.stringify(this.customerTaxInformation);
                ...
                CustomerTaxRegistrationIdFieldsControl.CUSTOMER_EXTENSION_PROPERTY_KEY = "CustomerTaxInformation";
...
// SIG // 434vKvhQPfaFL7dxZ980wd+cLdlz3I4fAEOriNFts5Sg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgtRZLPYjUe4R9
// SIG // 2+uhrF5ek8lKi4+ffVDrXZtPhY1B73gwgboGCisGAQQB
...
// SIG // MW1bo6SFjPfwNH2rHHLPN81/f+fJ3SGESEL9DbpmBqpj
// SIG // uzXo/wQ/j303oRGqfH0CjIOna37pdc2e7bENEcn5GBwu
// SIG // 0MhNi5OJK3vUnWU+G28w0S30YhK5XUymjVOLnM/RfJ1E
// SIG // yok8dMCMmxAI0zIKr80kV077g6/ayKz4Mx4CgzUL/Amy
// SIG // 2PGKlJfjpa/JQUFlkMUC9biLFwZ/Ixv/GlXBVgCZcWsU
// SIG // BZ0CgR6z4fzqsjyBfKMYvz7aWhzx003n5QEL+ubf+Nm5
// SIG // oe0kZcbxrLYEy8Nm1m2YJn2d0tyCXRSKttOlzzEIB/ee
// SIG // 9ZFhQNGSELZ8YX1jSdEc1xok57ddptks5KGCEuUwghLh
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCBdKShW1GT5VoPF
// SIG // 6kdG8hrgsOsvwAFEBwneh3J8UukX4AIGXz1EKhjQGBMy
// SIG // MDIwMDgyMzA0MDI0OC4yMzZaMASAAgH0oIHQpIHNMIHK
...
// SIG // LwYJKoZIhvcNAQkEMSIEIJIuQJ3yyxzbpzRtKlBXXR2d
// SIG // VEx0jxAFUPIelQCEZjMNMIH6BgsqhkiG9w0BCRACLzGB
...
// SIG // gmehcDANBgkqhkiG9w0BAQsFAASCAQB6RtWyvbajHGPJ
// SIG // 0XDos8MaxKXFS7GsIoSK+ZvaSsEuv36qyuDHXeRyRVfj
// SIG // HKPE0+WmvS3uokMOft0R7jKsFjMXTScz4IZ6Wl/Qjpi+
// SIG // nrsA/YINUF9n/H0hnI29p0e8bUVf41miFvmQpMXYI3l6
// SIG // C4qq5QD5nyW9RjieIDJJMK7kfwz3LS9EW0mKhIGLbMfW
// SIG // d+9vIhCYq/JnaTE3ls4pfaxUUBwGwGn/nTmxKsO4nZL4
// SIG // 7JS6UBhidoS6mXp7ZiDLhoPDyV5DRyNjOI3/DIHXmLEh
// SIG // o9z5Q/oe1fkhUAgp5Z/g793IcgixDvm3KNyNxLew76UD
// SIG // NnA9Kt6D+tZ4H8ZqrIMl
