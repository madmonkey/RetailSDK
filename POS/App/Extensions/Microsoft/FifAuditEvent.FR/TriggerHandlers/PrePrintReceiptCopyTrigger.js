System.register(["PosApi/Entities", "PosApi/TypeExtensions", "PosApi/Extend/Triggers/PrintingTriggers", "../AuditEvent.Common/Managers"], function (exports_1, context_1) {
    "use strict";
    ...
    var Entities_1, TypeExtensions_1, Triggers, Managers, PrePrintReceiptCopyTrigger;
            ...
            PrePrintReceiptCopyTrigger = (function (_super) {
                ...
                PrePrintReceiptCopyTrigger.prototype.execute = function (options) {
                    ...
                    if (salesReceiptCopyIsPrinted) {
                        var auditEventManager_1 = new Managers.AuditEventManager(this.context);
                        var receiptsManager = new Managers.ReceiptsManager(this.context);
                        return receiptsManager.updateAndPrintReceiptsCopy(options.salesOrder, options.receiptAndPrinterPairs)
                            .then(function (result) {
                            if (!result.canceled) {
                                return auditEventManager_1.registerPrintReceiptCopyAsync(options.salesOrder).then(function () { return void 0; });
                            }
                            else {
...
// SIG // yA24Mq4SmTh5ufhmRPk75HU2f0VnfYZkVDHBEs0w51Gg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgnbjoVCockYKE
// SIG // xGzC/zyG1xfLtDfxkId+HFNnQJXwD78wgboGCisGAQQB
...
// SIG // PGhPZXoALgfqFpO48v9ncwWZixi5hrjQBRDLE+4Jr/Zu
// SIG // z4lZrQO0l9+BFR5X97ortL5yWun3ZgTcIK/HpDU3xtwq
// SIG // zOlDGCM06J+rwIgtYFJ+tV4yYelcgcJwtsTaJf3RGZi3
// SIG // xTX8JYfKd7YASAKPd1yxfKP+41J6O/Ienuth1pZ8G3IK
// SIG // fZaddb7JpJjeIfW4xmCUGIhfFguTsQrk/y27pi6wm7Y3
// SIG // UGzObcQSeu5zr+zexiQ8S04U7y+90pDVhg/x/diqmH1C
// SIG // H0uzWja8v9Or60JbyL7d5iwQ3rgSIKhaITzLifMBT1is
// SIG // Dk1q7cDwFiaN30G/fXazsrOUcPTBMNHITqGCEuUwghLh
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCDAxJg+d7XninLG
// SIG // okJygcM1P6JeknYMFOaeGIa8Siz7FAIGXz0tSNNjGBMy
// SIG // MDIwMDgyMzA0MDI0Ny4wNzdaMASAAgH0oIHQpIHNMIHK
...
// SIG // LwYJKoZIhvcNAQkEMSIEIB9V/CF4eEiB13VTE7AgjqxG
// SIG // wPq1N2gFWpkY/1DGojcPMIH6BgsqhkiG9w0BCRACLzGB
...
// SIG // TeR2JTANBgkqhkiG9w0BAQsFAASCAQBRq2alxV6KIJOZ
// SIG // TeMAegpZm2l600zlSe7M4wG2As7m7ZUVSbJlBeMxZvfN
// SIG // /wA3w7Zctr1SRAxsTJb4wz3yL8CSTqBzt5eKNvL1RyAX
// SIG // Hxvaq5ZukSMOlSbZhl+CsPdx7niyhKHRAjINL4/QDJeG
// SIG // BEjWBpEY3IRNhS+ebzftXsp7rUB3yH+mZ64mCB4EurZu
// SIG // wWN+75vmvRjzV4uuZkyWQm04SrMt/oTjvQvuGCwHmkww
// SIG // Y692urgcGeK04jZ+5nZcAPDSj62WMlcA0fyqmfYUr1gK
// SIG // +4uBdNpphSvZdctCqwz2J/dlOsBtM+wtUfKawNUzIsUZ
// SIG // 5uZCBFprXAAonUUoAJyv
