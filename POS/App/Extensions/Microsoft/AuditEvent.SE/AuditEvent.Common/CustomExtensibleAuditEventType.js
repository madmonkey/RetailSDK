System.register(["PosApi/Entities"], function (exports_1, context_1) {
    ...
    var Entities_1, ExtensibleAuditEventType, CustomExtensibleAuditEventType;
    ...
    return {
        ...
        execute: function () {
            ...
            CustomExtensibleAuditEventType = (function (_super) {
                __extends(CustomExtensibleAuditEventType, _super);
                function CustomExtensibleAuditEventType() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                CustomExtensibleAuditEventType.OfflineModeOn = new ExtensibleAuditEventType("OfflineModeOn");
                CustomExtensibleAuditEventType.OfflineModeOff = new ExtensibleAuditEventType("OfflineModeOff");
                CustomExtensibleAuditEventType.TrainingModeOn = new ExtensibleAuditEventType("TrainingModeOn");
                CustomExtensibleAuditEventType.TrainingModeOff = new ExtensibleAuditEventType("TrainingModeOff");
                CustomExtensibleAuditEventType.CloseShift = new ExtensibleAuditEventType("CloseShift");
                return CustomExtensibleAuditEventType;
            }(ExtensibleAuditEventType));
            exports_1("CustomExtensibleAuditEventType", CustomExtensibleAuditEventType);
        }
    };
});
...
// SIG // SGlIhJIPoO4TPZyiaiX0vgS9s2PQzJt+zthoeNuQrKOg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgzUmzM5pWKKzD
// SIG // /oLMYQ6lUYLf2h/AwAq2PV/yGMou90AwgboGCisGAQQB
...
// SIG // gP7+aXetQ2qsrBCm8LFwPnSGX0FyJaOQQo0gF+y02NqU
// SIG // BHkLMg2bXEFMh+X6monG9yoctqVM7cqodNPIumtlQNts
// SIG // 7ahOnfLvO8DHuF5OGU3N0bdo6Z/xqTDJrZ7ExIwL6ZiC
// SIG // dD7fGc6jyqueGoo1E7lxbm0azIGquXHWJDR2csslnB77
// SIG // qj48ubKtU/5ESmVmX3kadd9eT/ph/oLSw9y3CFhM7Lw0
// SIG // SlqdWcIA6fGVmb1ZE1mc/VADzvv1tENltKFoK4agiWoA
// SIG // BdomOIXV3VOdHGleELm8OkYfZJFjaE+/SOFmbY7AJ0CP
// SIG // GRWhEI/KlyQisqNdbqXfXA/w7nuwhY/M9KGCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCDfLR6LOcN4DRXN
// SIG // /7lCw6Oo8WnBTOIHsNfRv7eNb7PyyQIGXzvjWnNMGBMy
// SIG // MDIwMDgyMzA0MDI1MC42NzFaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIHfyZH1D
// SIG // FBPrb9aOz8mzYn1bE6Fd5wSnlmtrJ40xe/PvMIH6Bgsq
...
// SIG // AQA7o38OqWsSSz/X/dTqncyqlVquXjuSm/TandX1Enlk
// SIG // NVYaU/Kmyp1EBTZSc3XvqU6+lGMlWn/scW6gawA/7/B7
// SIG // aldgWvaGb0Y4jCaQ8VBovTM1rAaiC4m3r+QZqzF6ibgZ
// SIG // yU9UmmgyiUPLfhQIdjyRk7A9S+X/7xqDulT6zXx0E82S
// SIG // OnMbabgcaR/95K2p7YYXhE5WlMol1el7JpkPDMNXT2Rw
// SIG // xXFaoJTQuOvAe5dfFOKoxYYO2ysv9NRAf6t3UQ438fM+
// SIG // SMSovOZrdnldgAt8Y58wAUCp31sd42mLlYfqng3uoWNm
// SIG // D3C/l5onbyZAreSphIbl5wOrdl1e8iTbWLAO
