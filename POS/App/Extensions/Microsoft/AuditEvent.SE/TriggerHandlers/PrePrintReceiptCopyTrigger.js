System.register(["PosApi/Entities", "PosApi/Extend/Triggers/PrintingTriggers", "../AuditEvent.Common/Managers", "PosApi/TypeExtensions"], function (exports_1, context_1) {
    "use strict";
    ...
    var Entities_1, Triggers, Managers, TypeExtensions_1, PrePrintReceiptCopyTrigger;
            ...
            PrePrintReceiptCopyTrigger = (function (_super) {
                ...
                PrePrintReceiptCopyTrigger.prototype.execute = function (options) {
                    ...
                    if (salesReceiptCopyIsPrinted) {
                        ...
                        var receiptsManager_1 = new Managers.ReceiptsManager(this.context);
                        return auditEventManager.registerPrintReceiptCopyAsync(options.salesOrder)
                            .then(function (response) {
                            if (response === Entities_1.ClientEntities.FiscalRegistrationResult.Failed) {
                                return Promise.resolve({ canceled: true });
                            }
                            return receiptsManager_1.updateAndPrintReceiptsCopy(options.salesOrder, options.receiptAndPrinterPairs);
                        })
                            .then(function () {
...
// SIG // 9HWvRvlJYRyG1uVL0O8JH144f44nQEyRGKWzovWvQE2g
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgLSOS+chCnyCE
// SIG // 4sOmLfk1uBcE6sFyGjnA1PnwRwloRs4wgboGCisGAQQB
...
// SIG // XRv+QVwItkoM6L/Ui4/n9qJplW4tanojdfjMiRK9F5kF
// SIG // 71wvogwMWz8QmNUETqM2wMZlD9LDHBs1Ozl3YTubg1yC
// SIG // zevNHRTRCjPt2fl4LbegcQxbDk71o0CC6RANDSvsFOfa
// SIG // 8DvxL41dYxJvo3gKLylPs8SBDkfFOk0eYmdRwxuw3m2j
// SIG // D7IsfgPF8DQof0GBhIgGJDy/UVy+4dkI24/rrn2MXFnO
// SIG // EFuYcIRKPSHVaeJUs2MQA4+lfE3mlToUnY86c3Hv3laJ
// SIG // uY9KAwW1rxb4yb5Eok3szTMVMXthPGZBRdDzp/5spo8y
// SIG // /kxRFujIFe3rP6pOvXByRTV0BlOEV6d5MqGCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCDcT2eRA223wlLa
// SIG // kn3KxcrvMVGbq69S61AsGaU5gVOGhwIGXzvk28zhGBMy
// SIG // MDIwMDgyMzA0MDI0NS40ODVaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIAH3sbgk
// SIG // /91ieGCBRDOg5v9hJ6C+rvWLqfynSONC0yp7MIH6Bgsq
...
// SIG // AQBCXRF3AU5JT62xQl/bxdbE2c6D7bAcW3Nxxjb55zny
// SIG // q6BXYB3269mfk2cZwzOEfC2TW2dbtfeZxg+3G4GItJI4
// SIG // +1dE9I9YDDMouphmSblBMFJM0jDAI/buNZ07zQlB7XWJ
// SIG // Tl5rZpdNH0mKBBgWAcIc+f/h7p5ho7U6abEN41pebBoe
// SIG // hgkOxK1OzClAdYvb32lsMc4jep4knMoBhs4Aglpt9g6X
// SIG // Q3l4Q0JecuOIUrAevt2+iF2RAtSwFRPEeLMsxiR2N5ir
// SIG // lidNbra6CmaiNx2H0zi3rS2KM2+RqI7pUrYlgWZyyqR+
// SIG // m4rcAoRkok6Gr7vKivSfiXfO2PrXWquUA1zZ
