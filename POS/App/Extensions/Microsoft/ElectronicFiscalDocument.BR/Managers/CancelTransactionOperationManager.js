System.register(["PosApi/Entities", "PosApi/TypeExtensions"], function (exports_1, context_1) {
    "use strict";
    var Entities_1, TypeExtensions_1, CancelTransactionOperationManager;
    ...
    return {
        ...
        execute: function () {
            CancelTransactionOperationManager = (function () {
                function CancelTransactionOperationManager() {
                }
                CancelTransactionOperationManager.isJournalCanBeCanceled = function (salesOrder) {
                    return !TypeExtensions_1.ObjectExtensions.isNullOrUndefined(salesOrder) && Entities_1.ClientEntities.ExtensibleTransactionType.Sales.equals(salesOrder.TransactionTypeValue)
                        && salesOrder.EntryStatusValue !== Entities_1.ProxyEntities.TransactionStatus.Voided && !salesOrder.IsReturnByReceipt;
                };
                return CancelTransactionOperationManager;
            }());
            exports_1("default", CancelTransactionOperationManager);
        }
    };
});
...
// SIG // WwS8pSzkKgTKDHgvVee6nY+adygi97VgqE1S7LV5Z46g
...
// SIG // AgEVMC8GCSqGSIb3DQEJBDEiBCAw5yX2P2P9l2wHowNI
// SIG // nyCjXjQ6/hJLCrbqRkzDZ/PTlDCBugYKKwYBBAGCNwIB
...
// SIG // cm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQDImfai
// SIG // QJLPbtRsDiGIN60/wHPQ2/hxB/onrqW6Jijq2JZWfdub
// SIG // xCiS7RP6dOxmTB5s+SbVLG8ecmSTAtrZeeIPQthZqLdW
// SIG // ASUDGwnLV1P34Yo5AbjeJzOKVGZHH0Y3V23iHJrqtnSt
// SIG // jgIpIttkFGSC6rjyVu3a4iZcguiuyMSS3ovGx2dHvW2V
// SIG // OjQ8x3ErSpKyB6wyrN/Gq6W9yZQXCE5tX/9FPv/woXac
// SIG // AWio1jKlLnELELVzq4496RI409GMOMBSLORgblt8pP5C
// SIG // /LhlQBh/g8A/1/J57BOK5jMPLO7ma7Xe3VHsBfiPlxLt
// SIG // wWYcSMYJadufousHKlDBs5fNnqonoYIS5TCCEuEGCisG
...
// SIG // MDEwDQYJYIZIAWUDBAIBBQAEIBqiNQ0nCvOxguFpwgI6
// SIG // M28V8qPUiItCJBQYLs3Id2v+AgZfOqnO9TgYEzIwMjAw
// SIG // ODIzMDQwMjQ1LjcxM1owBIACAfSggdCkgc0wgcoxCzAJ
...
// SIG // hkiG9w0BCQQxIgQgeOErkBbx0XSZxRFXECTs5pI5cGjr
// SIG // wb11Cs50mC8nfqMwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
// SIG // MA0GCSqGSIb3DQEBCwUABIIBAC8+rGEQ1CiQJGZI/aQX
// SIG // dLq/OinAut2GoOP3iUmXawVJAj3uXzN5VhumP8ifwvSv
// SIG // vw32EbaU4ztLg1wAv31wjTn64NBz2JSObKboz/yYh84M
// SIG // XlsGk/wAKSOfnRNi8yngHE2Dg9/HLraTi255uOTHSbSC
// SIG // gqDtNvxhBeKWbwLYyrOCfilW8maPSJEEQ2GHpiPO2dSj
// SIG // 0iKSGzuhzo26rzDMAiOq+A+O81bdZYiYztoysPjDGA02
// SIG // kHNgN/4sza7yAdwNVGeBAcPt4+NyoRqdizyRXg0WyR5I
// SIG // HOP4wK2Mx6Bzjyf6PF1o9MDX8Mo+N4AYlGrmKAsCjsl1
// SIG // ym/qhYB8cXNBzlo=
