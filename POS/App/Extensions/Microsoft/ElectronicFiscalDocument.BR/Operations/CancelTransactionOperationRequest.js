System.register(["PosApi/Create/Operations"], function (exports_1, context_1) {
    ...
    var Operations_1, CancelTransactionOperationRequest;
    ...
    return {
        ...
        execute: function () {
            CancelTransactionOperationRequest = (function (_super) {
                __extends(CancelTransactionOperationRequest, _super);
                function CancelTransactionOperationRequest(correlationId) {
                    return _super.call(this, CancelTransactionOperationRequest.OPERATION_ID, correlationId) || this;
                }
                CancelTransactionOperationRequest.OPERATION_ID = 3510;
                return CancelTransactionOperationRequest;
            }(Operations_1.ExtensionOperationRequestBase));
            exports_1("default", CancelTransactionOperationRequest);
        }
    };
});
...
// SIG // O9cRazM5v/VsOavFiAivVWOxb2u56+gbcDhBTVM6qtOg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg/mExWdkeNxJX
// SIG // iSzOLnzyVurMBVKOCf8U+YSPWL31isQwgboGCisGAQQB
...
// SIG // b+2DOAqY/ZeDMjlVZl3aXVFvWNM9qicY/XKqI5ZiucrU
// SIG // uSljabq0RYnWXdA1/0AD7LUuLpAiOcHPF3lhGk6FGsLF
// SIG // zefVst3xGkTS7lfVZBUoOQncAbXd704p3z2pLchxKNcH
// SIG // bc9TkMmoj/GY3DnJ6y6fF42v1rTwriYep4MEvGJthtFM
// SIG // rGlIah0XAfA6msOyjbri9P6vdz+B9x2PmyoRgNcp4b7R
// SIG // WjIFVBaUHGsy+LyJblsjJZMYYX7y2YZf6nXVXmYOFgvD
// SIG // wz1pBGKHRGlTIb1ovNe3ALZNAr7mY+E4gDXdw1WmSJ7h
// SIG // i5/EzLcSR1uhrLDMgYGlfQFeNilGC1jU36GCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCBAAYUU+PsuLodz
// SIG // 9IMW0ZVYnqU0j5nte6vKUv85UgIkKQIGXzvk28yEGBMy
// SIG // MDIwMDgyMzA0MDI0NC4xNjZaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIFsjgGzp
// SIG // yPtKtAHlIYxiI1FTdPn6qBazgxmAD/eNjz9lMIH6Bgsq
...
// SIG // AQBH3TC96yFiRbK7TLKIjqfXWvMh6FMqalkMfttn94IJ
// SIG // 5jEh8WIoJ7+IU8LxmJp2TQVVAncFubH6i0K5VMWFTZPl
// SIG // pXss99dTpxZbyAvGvfm4Ysw9EJUXuLMxrcrrk3kJ00dm
// SIG // kY1zgRcNgrDBYUERpkS+3lyjMm+9jKkMdUYff8pTMX+W
// SIG // 0NVhOkOGADTnC/7w6y86IwGbbCmmXM27JFtkBAXE7lYX
// SIG // cicmprAr+Dp/90N9/Cz0AvII1aoZgp7e+HD94qudgd6i
// SIG // QVjM7UxzJQDpXAdp+9Dphv3vhXAZBRqAT19A6Oh1Jh9X
// SIG // ujxvUFIwDHNERBXJ47YOvWqz5tzVESQTsuWj
