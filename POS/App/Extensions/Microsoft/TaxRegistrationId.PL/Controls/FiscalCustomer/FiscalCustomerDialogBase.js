System.register(["PosApi/Create/Dialogs", "PosApi/TypeExtensions", "../../Helpers/ErrorHelper"], function (exports_1, context_1) {
    "use strict";
    ...
    var Dialogs, TypeExtensions_1, ErrorHelper_1, FiscalCustomerDialogBase;
    ...
    return {
        ...
        execute: function () {
            FiscalCustomerDialogBase = (function (_super) {
                __extends(FiscalCustomerDialogBase, _super);
                function FiscalCustomerDialogBase() {
                    var _this = _super.call(this) || this;
                    _this._onBeforeClose = null;
                    _this._resolve = null;
                    return _this;
                }
                FiscalCustomerDialogBase.prototype.getResx = function (key) {
                    return this.context.resources.getString(key);
                };
                FiscalCustomerDialogBase.prototype.onReady = function (element) {
                    ko.applyBindings(this, element);
                };
                FiscalCustomerDialogBase.prototype.open = function (options) {
                    var _this = this;
                    return new Promise(function (resolve) {
                        _this._resolve = resolve;
                        _this.openDialog(_this._getTemplatedDialogOptions(options));
                    });
                };
                FiscalCustomerDialogBase.prototype.closeDialog = function () {
                    this._onBeforeClose = null;
                    this._resolve = null;
                    return _super.prototype.closeDialog.call(this);
                };
                FiscalCustomerDialogBase.prototype._getTemplatedDialogOptions = function (options) {
                    throw new Error("Not implemented.");
                };
                FiscalCustomerDialogBase.prototype._closeDialogWithResult = function (result) {
                    var _this = this;
                    if (!TypeExtensions_1.ObjectExtensions.isFunction(this._resolve)) {
                        return;
                    }
                    if (TypeExtensions_1.ObjectExtensions.isFunction(this._onBeforeClose)) {
                        this.isProcessing = true;
                        this._onBeforeClose(this, result)
                            ...
                            _this.isProcessing = false;
                            ErrorHelper_1.ErrorHelper.displaySaveFiscalCustomerErrorAsync(_this.context, reason);
                        });
                    }
                    else {
                ...
                return FiscalCustomerDialogBase;
            }(Dialogs.ExtensionTemplatedDialogBase));
            exports_1("default", FiscalCustomerDialogBase);
        }
    };
});
...
// SIG // iMoXeZ2taRvMYZBCBG5P749ZFopgVcxrVPKRFeUXMhyg
...
// SIG // AgEVMC8GCSqGSIb3DQEJBDEiBCA9rUZOFncCdY/05Lfq
// SIG // q/oYfiV7UgXrjJQ9Hh3933m+sTCBugYKKwYBBAGCNwIB
...
// SIG // cm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQA4snBH
// SIG // ajcWDt7QtE/JbqcMhSkjd8pPV5Sv9Zi5rgY7nr9Mx1TN
// SIG // dNcyJ9ppMz6x2Pb08ridL8AXu4NWIO/c/9h1NDHvlqRM
// SIG // YWjugHsDXNP0eAeeceu6GgCKYF5fkpbqi5gA7cQPftRM
// SIG // R9MamOGl6Xwkvh/+rUgq5Uao3xBmmgyhh40GBtJWibhw
// SIG // M1BkSM+w0lqEjGgYm464LlIsDstkjuUAdNP0w77my77X
// SIG // e4tEFwI/GxWHNJqjfhSqKtZ5ILSHXU4njgs16RKaqdjs
// SIG // 3xUipl+TAgZDQAEHBToBFNIPYbcHcMCDNKEzy+d+zXts
// SIG // RVbBbjeHxqiV0nzKBdPyQdKH9bNroYIS4jCCEt4GCisG
...
// SIG // MDEwDQYJYIZIAWUDBAIBBQAEIH795ASiZb97QJLy8SOI
// SIG // /VlxBN7PyG9swJOlF9XX5x2FAgZfOqoj318YEzIwMjAw
// SIG // ODIzMDQwMjQ2LjgwMlowBIACAfSggdCkgc0wgcoxCzAJ
...
// SIG // 9w0BCQQxIgQgWVwfJ5b9gbAWArVt0dYyR1A349tXvjht
// SIG // Or61+jmr20swgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHk
...
// SIG // CSqGSIb3DQEBCwUABIIBAHzLkO3K2UHw15meFQJ1PO0d
// SIG // 3Od03o0jkI5niSDtFjN8iA1xTabrNLmdKvD8A6+CoNZX
// SIG // 7n6ymNlz/fHbPuq4wcwSFvnjIpJBc07T9XE/xTWeXMJB
// SIG // HjB1mvahMNOEEkExWKzCYyhMXUOc5laGny/siiond1x9
// SIG // YIXepW50PtTVqbvIMZQwpH1GF/C0mLHaSKfnry0EwMTj
// SIG // AH60rmCat/NhsOF6kMdvBI640LzRjC3irM1gzj2PmDwX
// SIG // XHAeKIiqQ12yqBARAPJqiO6CCuu+eQ6IjiYdOt6qBzF9
// SIG // yB3sfjYYgFt1bOsxRcg5pyCP1EEtfoQewESimPWmrcfa
// SIG // iH3glVqeqGQ=
