System.register(["PosApi/Entities", "PosApi/Extend/Views/AddressAddEditView", "PosApi/TypeExtensions", "../../Helpers/ExtensionPropertyHelper", "../../TaxRegistrationIdPolandConstants"], function (exports_1, context_1) {
    "use strict";
    ...
    var Entities_1, AddressAddEditView_1, TypeExtensions_1, ExtensionPropertyHelper_1, TaxRegistrationIdPolandConstants_1, AddressTaxRegistrationIdFieldsControl;
        ...
        execute: function () {
            AddressTaxRegistrationIdFieldsControl = (function (_super) {
                ...
                AddressTaxRegistrationIdFieldsControl.prototype.init = function (state) {
                    ...
                    this.vatId(taxRegistration.RegistrationNumber);
                    this.isVisible = true;
                    this.vatId.subscribe(function (newValue) {
                ...
                AddressTaxRegistrationIdFieldsControl.prototype.getTaxRegistrationFromExtensionProperties = function (extensionProperties) {
                    ...
                    var taxRegistrationExtensionProperty = ExtensionPropertyHelper_1.default.getExtensionPropertyByName(extensionProperties, TaxRegistrationIdPolandConstants_1.default.CUSTOMER_TAX_REGISTRATION_EXTENSION_PROPERTY_NAME);
                ...
                AddressTaxRegistrationIdFieldsControl.prototype.updateCustomerTaxRegistrationExtensionProperty = function (vatId) {
                    var address = this.address;
                    var taxRegistration = this.getTaxRegistrationFromExtensionProperties(address.ExtensionProperties);
                    taxRegistration.RegistrationNumber = vatId;
                    var newExtensionPropertyValue = {
                        StringValue: JSON.stringify(taxRegistration)
                    };
                    address.ExtensionProperties = ExtensionPropertyHelper_1.default.setExtensionPropertyByName(address.ExtensionProperties, TaxRegistrationIdPolandConstants_1.default.CUSTOMER_TAX_REGISTRATION_EXTENSION_PROPERTY_NAME, newExtensionPropertyValue);
...
// SIG // ARST4XTXxVVVfnUj8PG2ZHMzP16vAQeG5LsKIUYM1eSg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgZzSFt5BiKCum
// SIG // HN5c3OUiPN5Xy8tOOSFm7bAOcYlwBJcwgboGCisGAQQB
...
// SIG // iELF2XrtzTdFOsycWqRcNGVkUaG8pFRKUbSyBWM9Df4y
// SIG // ki2EC3FAnV8GboRlSFs1z4LEZvz2Ma6XLDbGuvXy/JP7
// SIG // myCdP0l0gIhRTxHWVfcgWr/zrTN7GB/GFS3opHv6ST2p
// SIG // wTxPAx+kWKBmka36uH/51QIdQLRqw/Hf3C+Caoz0OMEw
// SIG // wNZPYqG1KMbcoGd88aLQBai9eHsv6QG6FHhXgaN+ae3P
// SIG // oGFrS68YKWDWksF1AecII9SENDVomZtBxBwZyxitYEnX
// SIG // rjPk0ValbJ7cYKeqFHHz/D8wqzdtnq/aLQz8fFx6J0VU
// SIG // SZaqJjhkgfiFisTDn6+WdkNMl02/LZUxWKGCEuUwghLh
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCB9hWqR+IlQ0wZf
// SIG // FVECQ4Sbf9yOsybooMWTPCDWygaw+wIGXz0rl4bNGBMy
// SIG // MDIwMDgyMzA0MDI0OS4wODNaMASAAgH0oIHQpIHNMIHK
...
// SIG // LwYJKoZIhvcNAQkEMSIEIBoxmhcV+yLa1X9i1x/kTQ2m
// SIG // T4p8ijMfcarzP7XuPl6ZMIH6BgsqhkiG9w0BCRACLzGB
...
// SIG // IyjdSDANBgkqhkiG9w0BAQsFAASCAQBHmMlqDxA0oSAo
// SIG // IVni+/P53usUQu/ltWwVQ79cT5aepwVtEvLgs1TF6y4H
// SIG // bUm7sm+PHH7ovWZO4PeYoCVGvAVzubPiOCkWcxG38QRZ
// SIG // ko2Ugmm68ADnAR35fJysVyfGystEQ8duGpcIpkg68Ljt
// SIG // PLuG+hyewqwSbcLuKYc/PEdEEux2MuUXvQV7cp+pWjwy
// SIG // Lx3Yr315D72jSS12ln2A7ouMYxq2ZFGbNBqVwM2pSa3P
// SIG // jzFlaeok1DO9gP/KjGhnAlUgHv+qftQKwoQocnWFA6OJ
// SIG // FEcGIHOvUDPOQM21hFK1ERgvx+pBwNuLiQsnopXDOJDc
// SIG // Kc4iohp+mj5MFQSuVbv0
