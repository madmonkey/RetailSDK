            ...
            ErrorHelper = (function () {
                ...
                ErrorHelper.displaySaveFiscalCustomerErrorAsync = function (context, reason) {
                    ...
                    if (reason instanceof Entities_1.ClientEntities.ExtensionError) {
                        ...
                        message = context.resources.getString("Tax_Registration_ID_PL_Fiscal_Customer_Save_Unexpected_Error_Message");
                    }
                    var messageDialogOptions = {
                        title: context.resources.getString("Tax_Registration_ID_PL_Fiscal_Customer_Save_Error_Title"),
                        subTitle: context.resources.getString("Tax_Registration_ID_PL_Fiscal_Customer_Save_Error_Subtitle"),
                        message: message
                    };
...
// SIG // zfjOYX04O4Sdwjk19vw/+XvZCIcRDFN025Yun0ktDAeg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg/C+9pi3w22KZ
// SIG // Kb6m3j6lJ2YLYJr3b7dNiSybXkOZUAkwgboGCisGAQQB
...
// SIG // Yp9EAEMrCEJGXAXKjwF3+JtvJEBXcMP1U5YqCm5R8L8x
// SIG // D5txlGG5S6YnukM0ABPfGeYpsCQqxEvZhz29czSLmySG
// SIG // IpPJuuGzmJZlfVEvTYHJtydBQbVRPnChS7lwsfRtsi4v
// SIG // dE1SWDQIcUQiuNG1A3/V0shZHAYVWuM+3c/ACK31qICh
// SIG // VdLpDZN4CzU/ovQ+VVGRzjUXX1nC4+SQ/P74QVJ3JPUb
// SIG // f/y7B1D5+msuNP/D/EjhwIRKgIB/AYDqJF0w3ygrKKep
// SIG // sDXTax+5E8wVComt1Z+HAZHt6v6UR9GLL9ae/0gs+1hF
// SIG // nzA94ySrww6zTxLB5ZWq8Lq69eddiCi/jaGCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCD11a/qFwF2IpIb
// SIG // iRnGL0PXFS3uFz0Ze7iD8tdVNaVQpAIGXzvk285uGBMy
// SIG // MDIwMDgyMzA0MDI1My42MzdaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIHAj/V5F
// SIG // AM6xfGlvLRgVd8FahpJLObzPtzFjnupuiG6NMIH6Bgsq
...
// SIG // AQDOUNFV8s3F+LZgGtqtbYbFXvE+wDF4s6KRjMocQZCz
// SIG // DZJta4dMRFkyuzbuor1eYPYFACo6+i4Inui/1sTL+jQ/
// SIG // AXzqZMvgMUusgCSzh6oJzG/qcPzbjTOt/KgI7dA8YQrS
// SIG // dj4YAAR0hyjgVl8Q+SDR0I5BX6q3ASGEtkj7wlsc2Fsm
// SIG // WPEjvqf7IYHHPhyC5DAj7PKHIidh725FrLJTzKpAQdVC
// SIG // 1pEnUk8E5zWAEX9y2LFL+8j2fQSILZKbzp34ZrcuDEFT
// SIG // 2J2B/VRFGVNUXW8T7Kw4wsApDAenlsnIPtT5Q87C8g7W
// SIG // 9Le31lg1O9yxYyJ5w+wRj44MJaY/YutZ2co3
