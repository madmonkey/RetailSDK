System.register(["PosApi/Consume/Cart", "PosApi/Consume/Device", "PosApi/Entities", "PosApi/TypeExtensions"], function (exports_1, context_1) {
    "use strict";
    var Cart_1, Device_1, Entities_1, TypeExtensions_1, BuildNumberManager;
    ...
    return {
        ...
        execute: function () {
            BuildNumberManager = (function () {
                function BuildNumberManager(extensionContext) {
                    this._extensionContext = extensionContext;
                }
                BuildNumberManager.prototype.addBuildNumberToCart = function (cart) {
                    var _this = this;
                    return this._extensionContext.runtime.executeAsync(new Device_1.GetApplicationVersionClientRequest())
                        .then(function (response) {
                        var buildNumberAttribute = new Entities_1.ProxyEntities.AttributeTextValueClass();
                        buildNumberAttribute.Name = BuildNumberManager.BUILD_NUMBER_KEY_ID;
                        buildNumberAttribute.TextValue = response.data.result;
                        return _this._extensionContext.runtime.executeAsync(new Cart_1.SaveAttributesOnCartClientRequest([buildNumberAttribute]));
                    })
                        .then(function (response) {
                        _this._extensionContext.logger.logInformational(BuildNumberManager.ADDING_BUILD_NUMBER_LOG_MESSAGE_RESOURCE_ID);
                        return Promise.resolve({ canceled: false });
                    })
                        .catch(function (reason) {
                        _this._extensionContext.logger.logError(TypeExtensions_1.StringExtensions.format(_this._extensionContext.resources.getString(BuildNumberManager.ADDING_BUILD_NUMBER_ERROR_MESSAGE_RESOURCE_ID), JSON.stringify(reason)));
                        return Promise.resolve({ canceled: false });
                    });
                };
                BuildNumberManager.BUILD_NUMBER_KEY_ID = "BUILD_NUMBER_068160BD_AB37_4E88_93FF_418E842BD803";
                BuildNumberManager.ADDING_BUILD_NUMBER_LOG_MESSAGE_RESOURCE_ID = "Build_number_log";
                BuildNumberManager.ADDING_BUILD_NUMBER_ERROR_MESSAGE_RESOURCE_ID = "Build_number_error";
                return BuildNumberManager;
            }());
            exports_1("default", BuildNumberManager);
        }
    };
});
...
// SIG // j9HW6lpTd852tOchJUQCcDWoMHDdrTAPXHrNzvnGxxyg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgI0qo9DkJ6gSe
// SIG // vpJxD0AFoqvq2yLISgqN4qijVtnEPLcwgboGCisGAQQB
...
// SIG // UTJZxvQLnqNSvxoW3xqEIvbAxkfObOw0XuOUGkuPky1e
// SIG // 5nHCyr1gmSc4TRhxFZD8Kiy+ImOMR4Qq2TQJ3FMfg4fY
// SIG // Q+m/kd9bc8fM7zmD6qXjRpg3cyIzNvljUpkjEDeZ4PY+
// SIG // sgF+L0jmrcznaUqUFmfOQrJuzF5WXy5b/cNwYKssNmzy
// SIG // yh1KGFOC4KwvJEBMJt1JtWRA3kjBpdTcVgYK2tyncaFl
// SIG // 059unCUd2s5XP/poKqAfcl10hurx3QxpQ88JpRGQHwq0
// SIG // 2gsgjO/bLy4wVqwVJkx9OBaTbGT7kHygRi9T4mPm0pNx
// SIG // ePAORqQOX3maCzNcsjEFYC+IpBxQEU3voaGCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCBPzPYnsAJ1y+Aq
// SIG // b8LLTk5zhsQ2eOw3sBudKsPWSn/3KAIGXzvk2801GBMy
// SIG // MDIwMDgyMzA0MDI0Ni42MTlaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEINjCMosP
// SIG // Vd/GuLW8YF6tm9qKbukn/JSoSxLT4uGY7MyZMIH6Bgsq
...
// SIG // AQB2JZdDWQehfkdgkhEi6tesMxnntGHDM540KpfO2IIs
// SIG // 4VEJ1uD118Gdzgtmmvz/6XzCRgEM9joC4Ye174lXJSrJ
// SIG // aSg5s3tDRLet6V0UfwaFmQoTX4g0jT9f/DCuUFcY1a1L
// SIG // LJVfnoMMkcPLegdM2Mo5qjyoCpmkUED5vsD+Ztem7AFc
// SIG // 4DaQXPsXmbcVJf7q8/ggSd65/hyOsHWwGg1VKRJXmd0E
// SIG // Fz/0wku7ZXwa/BFf3O+lPNsWD9DojKkBb9GLLRVJ8i7Z
// SIG // PonhMJ0Bn7JtHIEte/x7CIN1m6YV0+XeBb8JxSvr0FCF
// SIG // NZHHJS7496CN+ij/fZr/WZ/oogobVd1AOZgL
