...
(function (Commerce) {
    ...
    (function (UserActivityRecorder) {
        "use strict";
        var UserActivityRecorderState;
        (function (UserActivityRecorderState) {
            UserActivityRecorderState[UserActivityRecorderState["None"] = 0] = "None";
            UserActivityRecorderState[UserActivityRecorderState["Recording"] = 1] = "Recording";
            UserActivityRecorderState[UserActivityRecorderState["RecordingPaused"] = 2] = "RecordingPaused";
            UserActivityRecorderState[UserActivityRecorderState["RecordingCompleted"] = 3] = "RecordingCompleted";
            UserActivityRecorderState[UserActivityRecorderState["Validating"] = 4] = "Validating";
            UserActivityRecorderState[UserActivityRecorderState["ValidationPaused"] = 5] = "ValidationPaused";
        })(UserActivityRecorderState = UserActivityRecorder.UserActivityRecorderState || (UserActivityRecorder.UserActivityRecorderState = {}));
    })(UserActivityRecorder = Commerce.UserActivityRecorder || (Commerce.UserActivityRecorder = {}));
})(Commerce || (Commerce = {}));
var Commerce;
(function (Commerce) {
...
// SIG // Ly0yVL6jZQfCJOQO5iC4mJdls0aQPWO1glLBxoE82heg
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgOTa6/atcwEjs
// SIG // XfeGpIH9RgM/kh8bDctoF8EfTPu0394wgboGCisGAQQB
...
// SIG // XN3t7TYOQKoyk9Q67XbnDWkKM6d3DgDq9iVPRcxBVXQs
// SIG // 5Zjegozsi7o52FOFwVgFKYhbFrmyCdwpNZ3p7r5Y29v/
// SIG // Kh3Jg4VSV1M+SJMCLXxv5vNuwMxfE3ICbNVEU2i2wvDb
// SIG // p7Swc2Q6w2PatPkvZAUz2EBglf9RoKS85TP11TODcW69
// SIG // SKm61n59NuT7xMAzRIpjtEWs5IdYjerP5EQIckkw6NEG
// SIG // gdJ8PtBzL6uOeMmXwJ0cEMmBGP3MQSkHPtGekpmFQrUa
// SIG // N8IuhRoEUWcO0DvPCA5/ZHtOWjIHSg8N+CHPUjacVY4Y
// SIG // 8BRcyV0Q8NTc5kQIImMK4FurJeYJzUou06GCEvEwghLt
...
// SIG // WQoDATAxMA0GCWCGSAFlAwQCAQUABCAuYeugayGK5iPD
// SIG // A5TR+5B7jXPHMaSEDcjOCJcUTxncPwIGXzvk28z5GBMy
// SIG // MDIwMDgyMzA0MDI0NS44MTVaMASAAgH0oIHUpIHRMIHO
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIEHJEZ0r
// SIG // yt0PeF3gBAB2d+wvXDikm1J+UFFetFgkNb5HMIH6Bgsq
...
// SIG // AQAGBdohO+h0u27RRGWZveUocflE0B/HvITPDayis9+Z
// SIG // DIZr+YjVH5d4dgU77xscdMnFO28NgPf8WYb7EBz3vCK5
// SIG // JicFBsvIVFhU3LV/avx+cgwvAvMrFa6SiVOEv3hqJne3
// SIG // wQEyDgTJ5aTTF9xt8zj3xpUzOEKR4WpKx52S4bXZTP8T
// SIG // DiIhusj7fgadg4vonjCXmj5B8+kq8E7LUh4CVSFpRUUq
// SIG // 8CHsISkrgUYjjfb6gwdgnoFQ3euj0BR1Hi6a/olbsS+9
// SIG // YbMElgJWSpoiLmsl/eqqsqgZhcLsiubuz+J3Pfzd3IxQ
// SIG // wUFgSY2UpqXZHXrmaWuPdhqaqEob5MKWxDjY
