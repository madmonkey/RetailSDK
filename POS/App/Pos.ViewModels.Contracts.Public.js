...
(function (Commerce) {
    var Extensibility;
    (function (Extensibility) {
        var InventoryDocumentShippingAndReceivingMode;
        (function (InventoryDocumentShippingAndReceivingMode) {
            InventoryDocumentShippingAndReceivingMode[InventoryDocumentShippingAndReceivingMode["UpdateNow"] = 0] = "UpdateNow";
            InventoryDocumentShippingAndReceivingMode[InventoryDocumentShippingAndReceivingMode["FullOrder"] = 1] = "FullOrder";
        })(InventoryDocumentShippingAndReceivingMode = Extensibility.InventoryDocumentShippingAndReceivingMode || (Extensibility.InventoryDocumentShippingAndReceivingMode = {}));
    })(Extensibility = Commerce.Extensibility || (Commerce.Extensibility = {}));
})(Commerce || (Commerce = {}));
var Commerce;
(function (Commerce) {
...
(function (Commerce) {
    ...
    (function (ViewModels) {
        ...
        var Icons = (function () {
            ...
            Icons.Cancel = "Cancel";
            Icons.CashDrawer = "CashDrawer";
            Icons.ClearSelection = "ClearSelection";
            Icons.Completed = "Completed";
            Icons.Count = "Count";
            Icons.Delete = "Delete";
            Icons.DeliveryTruck = "DeliveryTruck";
            Icons.Edit = "Edit";
            Icons.Email = "Email";
            Icons.Filter = "Filter";
            Icons.Go = "Go";
            Icons.Invoice = "Invoice";
            Icons.LightningBolt = "LightningBolt";
            Icons.MapPin = "MapPin";
            Icons.Money = "Money";
            Icons.MultiSelect = "MultiSelect";
            Icons.Note = "Note";
            Icons.NumberSymbol = "NumberSymbol";
            Icons.PageList = "PageList";
            Icons.Pickup = "Pickup";
            Icons.PreviewNext = "PreviewNext";
            Icons.PreviewPrevious = "PreviewPrevious";
            Icons.Print = "Print";
            Icons.ProductReturn = "ProductReturn";
            Icons.Quantity = "Quantity";
            Icons.Refresh = "Refresh";
            Icons.Save = "Save";
            Icons.Search = "Search";
            Icons.SelectAll = "SelectAll";
            Icons.SetAction = "SetAction";
            Icons.Sort = "Sort";
            Icons.Undo = "Undo";
            Icons.View = "View";
            return Icons;
        }());
        ViewModels.Icons = Icons;
    })(ViewModels = Commerce.ViewModels || (Commerce.ViewModels = {}));
})(Commerce || (Commerce = {}));
...
// SIG // 2WBRfKqI9w7S2o48NF1ptqBNOumduby2MMafOzR/0ICg
...
// SIG // AgEVMC8GCSqGSIb3DQEJBDEiBCAupcpP7UIgX5u9I8Q5
// SIG // jjy+kh/XQgD6FbdI4uUvBEkeFTCBugYKKwYBBAGCNwIB
...
// SIG // cm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBthw5B
// SIG // xBDeYD7Szbe2el4htLLKmUEolbRcWPHre4xcvzo1zp/d
// SIG // zf4w7V/SKvCFN2O16v2U6Gqu/GK2vq3GYugGX9T3O55R
// SIG // o4NwNvdGqAXtlqGwXuNMS1W9/d2Ol7lkjtU3EIrCFeda
// SIG // 3OZ49rRXzWl55JQsz78LJ6SqGqejpM+p4Sexutg6sz9p
// SIG // bj/Svl8i6OZMYk1tp05Wq1e1ZMx9CD6PFg2mY8JvT+So
// SIG // q4ESELyCBW0jn5qNRSvSc1gv0HxIyCpT+jQKwOMWiyTV
// SIG // YHWl6GCo1UIFD6NobSgfGcT2/iUE8VzxEYieGmawaj4t
// SIG // I0MKQjL4kPlK7ax+7KMOzY3YDzWLoYIS5TCCEuEGCisG
...
// SIG // MDEwDQYJYIZIAWUDBAIBBQAEIPp/Aak0gfJZtX9UVAAc
// SIG // qKGs9k33ERt2QAGUiCSs+cJtAgZfOtY7SbMYEzIwMjAw
// SIG // ODIzMDQwMjQ4Ljg2OFowBIACAfSggdCkgc0wgcoxCzAJ
...
// SIG // hkiG9w0BCQQxIgQgecgBJm9StnUIyKCQfWwN2e5P7wtD
// SIG // dFp6tNvf4bgwjzUwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
// SIG // MA0GCSqGSIb3DQEBCwUABIIBAIqLgtRkGCLvKNVc9Pip
// SIG // 6gZrZT5DRZVaZHcL7t4Iyt/taUxnATu7dJYSPSkatl/f
// SIG // 3HW+qRUYX3CMBpkQ7g64rgBoMI6+82nSy0OYU9o2M/7m
// SIG // LI52liMb6oBtgxu4+Xt8CRNrzPiWZ0+Kt0HsyX0TgBcz
// SIG // cYXvDuSrOqGcUq4IP4wjdfM2qoVLMH72VuloNu3O64Zu
// SIG // qCB1AnpDa6Pn3TvV8M2Y4nUM1re4KMPHPQ0LS5E+l3zi
// SIG // Ih8ZlPIbVeIdZqc5UWSVDy3ru9snmpixUaOWbY3UNQT6
// SIG // BHitzD050rpss2gnWG0r7ua+wT3o5r23fGZi0lVDtEyE
// SIG // ju/GvXDLDMv/CMk=
