...
(function (DualDisplay) {
    ...
    var DualDisplayInitializer = (function (_super) {
        ...
        function DualDisplayInitializer(isIndependentPackagingEnabled) {
            var _this = _super.call(this) || this;
            _this._isIndependentPackagingEnabled = isIndependentPackagingEnabled;
            return _this;
        }
        DualDisplayInitializer.prototype.configureEnvironmentPrerequisites = function (userAgent) {
            this._configureStorage();
            _super.prototype.configureEnvironmentPrerequisites.call(this, userAgent);
        };
        DualDisplayInitializer.prototype.loadApplicationAsync = function (correlationId, userAgent) {
            var _this = this;
            var dualDisplayView = [
                {
                    page: "DualDisplayView",
                    phonePage: "DualDisplayView",
                    path: "DualDisplay/DualDisplayView",
                    viewController: DualDisplayViewControllerAdapter
                },
            ];
            this._registerViews(dualDisplayView);
            var loadApplicationAsyncQueue = new Commerce.AsyncQueue();
            var packagesConfig;
            loadApplicationAsyncQueue.enqueue(function () {
                ...
                var getDeviceConfigurationDataAsync = DualDisplay.DualDisplayMessaging.sendRequest(getDeviceConfigurationDataRequest)
                    ...
                    Commerce.CSSHelpers.applyThemeAsync(correlationId, responseData.deviceConfiguration);
                });
                var getExtensionPackagesConfigRequest = new Commerce.DualDisplay.GetExtensionPackagesConfigurationDataRequest();
                var getExtensionPackagesConfigurationResult = DualDisplay.DualDisplayMessaging.sendRequest(getExtensionPackagesConfigRequest)
                    .done(function (responseData) {
                    packagesConfig = responseData;
                });
                return VoidAsyncResult.join([getChannelConfigurationDataAsync, getDeviceConfigurationDataAsync, getExtensionPackagesConfigurationResult]);
            }).enqueue(function () {
                var request = new Commerce.Extensibility.LoadExtensionsRequest(correlationId, Commerce.ApplicationContext.Instance.channelConfiguration.ChannelCountryRegionISOCode, packagesConfig);
                return Commerce.AsyncResult.fromPromise(Commerce.Runtime.executeAsync(request)).recoverOnFailure(function (errors) {
                    Commerce.RetailLogger.dualDisplayLoadExtensionsFailed(correlationId, Commerce.ErrorHelper.serializeError(errors));
                    return Commerce.VoidAsyncResult.createResolved();
                });
            }).enqueue(function () {
                ...
                return VoidAsyncResult.join([getCurrentCartDataAsync, getCurrentCustomerDataAsync, getCurrentLogonStateDataAsync]);
            }).enqueue(function () {
                return _this.convertWinJSPromiseToAsyncResult(WinJS.UI.processAll());
            });
            return loadApplicationAsyncQueue.run().done(function () {
                var splashScreen = document.getElementById("splashScreen");
                if (!Commerce.ObjectExtensions.isNullOrUndefined(splashScreen)) {
                    $(splashScreen).remove();
                }
                Commerce.TaskRecorder.taskRecorder = {
                    isActivated: false,
                    ...
                    activateRecorder: function () {
                        throw new Error("TaskRecorder is not implemented on DualDisplay.");
                    }
                };
                Commerce.Controls.ContentHost.ContentHostWinJSControl.contentHostInstance.render(false);
                Commerce.ViewModelAdapter.navigate("DualDisplayView");
                DualDisplay.DualDisplayMessaging.sendReadyMessage();
            });
        };
        DualDisplayInitializer.prototype.initializeApplicationFrameworkAsync = function (correlationId) {
            var _this = this;
            return _super.prototype.loadExtensibilityFrameworkAsync.call(this, correlationId, this._isIndependentPackagingEnabled)
                .done(function (extensionsLoaderFactory) {
                var extensionsLoader = extensionsLoaderFactory.createDualDisplayExtensionsLoader(_this.createExtensionsLoaderOptions());
                ...
                compositionLoader.addRequestHandler(Commerce.Extensibility.LoadExtensionStringResourcesFromFileClientRequestHandler, function () {
                    return { extensionsLoader: extensionsLoader };
                });
        ...
        DualDisplayInitializer.prototype.onInitializationComplete = function (correlationId) {
            Commerce.RetailLogger.dualDisplayAppLaunch(correlationId);
        };
        DualDisplayInitializer.prototype.displayLastResortErrorMessage = function (errorMessage) {
            var messageDialog = new Windows.UI.Popups.MessageDialog(errorMessage);
            messageDialog.showAsync();
        };
        DualDisplayInitializer.prototype._configureStorage = function () {
            var containerStorage = Pos.ApplicationDataContainerStorage.instance;
            var cacheStorage = new Commerce.Framework.DictionaryStorage();
            containerStorage.getKeys().forEach(function (key) {
                cacheStorage.setItem(key, containerStorage.getItem(key));
            });
            var persistentStorage = new Commerce.Framework.CachedStorage(cacheStorage, containerStorage);
    ...
    DualDisplay.DualDisplayInitializer = DualDisplayInitializer;
    var DualDisplayViewControllerAdapter = (function (_super) {
        __extends(DualDisplayViewControllerAdapter, _super);
        function DualDisplayViewControllerAdapter() {
            ...
            _this._dualDisplayViewController = new DualDisplay.ViewControllers.DualDisplayViewController();
            return _this;
        }
        Object.defineProperty(DualDisplayViewControllerAdapter.prototype, "viewModel", {
            get: function () {
                return this._dualDisplayViewController.viewModel;
            },
            enumerable: true,
            configurable: true
        });
        DualDisplayViewControllerAdapter.prototype.load = function () {
            this._dualDisplayViewController.load();
        };
        DualDisplayViewControllerAdapter.prototype.onCreated = function (element) {
            this._element = element;
            this._dualDisplayViewController.onCreated(element);
        };
        DualDisplayViewControllerAdapter.prototype.onShown = function () {
            this._dualDisplayViewController.onShown();
        };
        DualDisplayViewControllerAdapter.prototype.onReady = function (element) {
            _super.prototype.onReady.call(this, element);
            this._dualDisplayViewController.onReady(element);
        };
        DualDisplayViewControllerAdapter.prototype.onHidden = function () {
            this._dualDisplayViewController.onHidden();
        };
        DualDisplayViewControllerAdapter.prototype.dispose = function () {
            Commerce.ObjectExtensions.tryDispose(this._dualDisplayViewController);
            this._dualDisplayViewController = null;
            _super.prototype.dispose.call(this);
        };
        return DualDisplayViewControllerAdapter;
...
(function (Pos) {
    "use strict";
    var ModernPosInitializerBase = (function (_super) {
        __extends(ModernPosInitializerBase, _super);
        function ModernPosInitializerBase(config) {
            var _this = _super.call(this, config) || this;
            _this.commerceAuthenticationAudience = "Modern POS";
            return _this;
        }
        ModernPosInitializerBase.prototype.configureEnvironmentPrerequisites = function (userAgent) {
            this._configureStorage();
            _super.prototype.configureEnvironmentPrerequisites.call(this, userAgent);
        };
        ModernPosInitializerBase.prototype.createAzureActiveDirectoryAdapter = function (aadAuthority, aadTenantId, aadClientId, aadRetailServerResourceId) {
            return new Commerce.Host.WwaAADAuthenticationAdapter(aadAuthority, aadTenantId, aadClientId, aadRetailServerResourceId);
        };
        ModernPosInitializerBase.prototype.displayLastResortErrorMessage = function (errorMessage) {
            var messageDialog = new Windows.UI.Popups.MessageDialog(errorMessage);
            messageDialog.showAsync();
        };
        ModernPosInitializerBase.prototype.navigateToInitialPage = function () {
            if (Commerce.Helpers.DeviceActivationHelper.isDeviceActivationCompleted()) {
        ...
        ModernPosInitializerBase.prototype.onInitializationComplete = function (correlationId) {
        ...
        ModernPosInitializerBase.prototype.getOsVersion = function () {
            try {
                var deviceFamily = Windows.System.Profile.AnalyticsInfo.versionInfo.deviceFamily;
                var deviceFamilyVersion = Windows.System.Profile.AnalyticsInfo.versionInfo.deviceFamilyVersion;
                var versionToProcess = Number(deviceFamilyVersion);
                if (Commerce.NumberExtensions.isNullNaNOrZero(versionToProcess)) {
                    return null;
                }
                var partSizeInBits = Math.pow(2, 16);
                var versionPartsCount = 4;
                var versionParts = [];
                for (var i = 0; i < versionPartsCount; ++i) {
                    var versionPart = versionToProcess & (partSizeInBits - 1);
                    versionParts.push("" + versionPart);
                    versionToProcess = (versionToProcess - versionPart) / partSizeInBits;
                }
                if (versionToProcess !== 0) {
                    return null;
                }
                versionParts = versionParts.reverse();
                return deviceFamily + " " + versionParts.join(".");
            }
            catch (exception) {
                return null;
            }
        };
        ModernPosInitializerBase.prototype._configureStorage = function () {
            var copyFromLocalStorage = !Pos.ApplicationDataContainerStorage.hasContainer() && Commerce.Framework.LocalStorage.isSupported();
            var containerStorage = Pos.ApplicationDataContainerStorage.instance;
            if (copyFromLocalStorage) {
                this._transferValuesFromLocalStorage(containerStorage);
            }
            var cacheStorage = new Commerce.Framework.DictionaryStorage();
            containerStorage.getKeys().forEach(function (key) {
                cacheStorage.setItem(key, containerStorage.getItem(key));
        ...
        ModernPosInitializerBase.prototype._transferValuesFromLocalStorage = function (containerStorage) {
            var localStorage = Commerce.Framework.LocalStorage.instance;
            var existingContent = Commerce.StringExtensions.EMPTY;
            var keysToTransfer = localStorage.getKeys().filter(function (key) { return Commerce.ObjectExtensions.isNumber(Commerce.ApplicationStorageIDs[key]); });
            keysToTransfer.forEach(function (key, keyIndex) {
                var value = localStorage.getItem(key);
                containerStorage.setItem(key, value);
                var newLine = keyIndex === 0 ? Commerce.StringExtensions.EMPTY : Commerce.StringExtensions.NEW_LINE;
                existingContent += Commerce.StringExtensions.format("{0}Key='{1}';Length='{2}'", newLine, key, value.length);
            });
            keysToTransfer.forEach(function (key) {
                localStorage.removeItem(key);
            });
            var fromStorageName = Commerce.PrototypeHelper.getPrototypeChainTypeName(Object.getPrototypeOf(localStorage));
            var toStorageName = Commerce.PrototypeHelper.getPrototypeChainTypeName(Object.getPrototypeOf(containerStorage));
            Commerce.RetailLogger.storageValuesTransfer(fromStorageName, toStorageName, existingContent);
        };
        return ModernPosInitializerBase;
    }(Pos.PosInitializerBase));
    Pos.ModernPosInitializerBase = ModernPosInitializerBase;
})(Pos || (Pos = {}));
var Pos;
(function (Pos) {
    "use strict";
    var ModernPosInitializer = (function (_super) {
        __extends(ModernPosInitializer, _super);
        function ModernPosInitializer() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        ModernPosInitializer.prototype.isScreenCaptureAvailable = function () {
            try {
                return Commerce.ObjectExtensions.isFunction(Microsoft.Dynamics.Commerce.ClientBroker.ScreenCapture.takeScreenshotAsync);
            }
            catch (error) {
                return false;
            }
        };
        ModernPosInitializer.prototype.isIndependentPackagingEnabledAsync = function (correlationId, runtime) {
            return Commerce.AsyncResult.createResolved(false);
        };
        return ModernPosInitializer;
    }(Pos.ModernPosInitializerBase));
    Pos.ModernPosInitializer = ModernPosInitializer;
})(Pos || (Pos = {}));
var Pos;
(function (Pos) {
    "use strict";
    var initializer = Commerce.Config.isDualDisplay ? new DualDisplay.DualDisplayInitializer(false) : new Pos.ModernPosInitializer({});
...
(function (Commerce) {
    ...
    (function (Host) {
        ...
        var WwaAADAuthenticationAdapter = (function (_super) {
            __extends(WwaAADAuthenticationAdapter, _super);
            function WwaAADAuthenticationAdapter(aadAuthority, aadTenantId, aadClientId, aadRetailServerResourceId) {
                var _this = _super.call(this, aadAuthority, aadTenantId, aadClientId, aadRetailServerResourceId) || this;
                _this._tokenResponse = null;
                _this._isAADContextInitialized = false;
                _this._currentUserId = null;
                _this._settingsPaneCommandStartedProcessing = false;
                ...
                pane.addEventListener("accountcommandsrequested", _this.setupAccountSettingsPane.bind(_this));
                return _this;
            }
            WwaAADAuthenticationAdapter.prototype.initialize = function () {
                if (!Commerce.StringExtensions.isNullOrWhitespace(this._aadLoginUrl)) {
                    this._isAADContextInitialized = true;
                }
            };
            WwaAADAuthenticationAdapter.prototype.login = function () {
                return this._acquireToken(this.aadRetailServerResourceId)
                    .map(function (result) {
                    if (!result.canceled) {
            ...
            WwaAADAuthenticationAdapter.prototype.logout = function () {
                ...
                this.clearCache();
                WebAuthenticationCoreManager.findAccountProviderAsync(WwaAADAuthenticationAdapter.AAD_PROVIDER_ID, this._aadLoginUrl).done(function (provider) {
            ...
            Object.defineProperty(WwaAADAuthenticationAdapter.prototype, "_aadLoginUrl", {
                get: function () {
                    var aadLoginUrl;
                    if (Commerce.StringExtensions.isNullOrWhitespace(this.aadAuthority) || Commerce.StringExtensions.isNullOrWhitespace(this.aadTenantId)) {
                        aadLoginUrl = Commerce.Configuration.ConfigurationProvider.getValue("AADLoginUrl");
                    }
                    else {
                        aadLoginUrl = Commerce.UrlHelper.formatBaseUrl(this.aadAuthority) + this.aadTenantId;
                    }
                    return aadLoginUrl;
                },
                enumerable: true,
            ...
            WwaAADAuthenticationAdapter.prototype._acquireToken = function (resourceId) {
                ...
                if (!this._isAADContextInitialized
                    ...
                    || Commerce.StringExtensions.isNullOrWhitespace(this.aadClientId)) {
                    Commerce.RetailLogger.librariesAuthenticationProviderAuthenticationFailed(Commerce.ErrorHelper.formatErrorMessage(error));
                ...
                queue.enqueue(function () { return WwaAADAuthenticationAdapter.mapAsyncResult(WebAuthenticationCoreManager.findAccountProviderAsync(WwaAADAuthenticationAdapter.AAD_PROVIDER_ID, self._aadLoginUrl)); })
                    .enqueue(function (provider) {
                    if (Commerce.ObjectExtensions.isNullOrUndefined(provider)) {
                        Commerce.RetailLogger.librariesAuthenticationProviderNotFound(WwaAADAuthenticationAdapter.AAD_PROVIDER_ID, self.aadAuthority);
                        var error_1 = new Commerce.Proxy.Entities.Error(Commerce.ErrorTypeEnum.MICROSOFT_DYNAMICS_POS_AADCONFIGURATION_ERROR.serverErrorCode);
                        Commerce.RetailLogger.librariesAuthenticationProviderAuthenticationFailed(Commerce.ErrorHelper.formatErrorMessage(error_1));
                        return Commerce.AsyncResult.createRejected([error_1]);
                    }
                    else {
                    ...
                    var request = new WebTokenRequest(foundProvider, Commerce.StringExtensions.EMPTY, _this.aadClientId);
                    request.properties.insert(WwaAADAuthenticationAdapter.REQUEST_PROPERTY_RESOURCE, _this.aadRetailServerResourceId);
            ...
            WwaAADAuthenticationAdapter.prototype.setupAccountSettingsPane = function (eventArgs, pane) {
                ...
                var self = this;
                var correlationId = TsLogging.Utils.generateGuid();
                Commerce.RetailLogger.librariesAuthenticationAADSettingUpAccountSettingsPane(this.aadAuthority, correlationId);
                WebAuthenticationCoreManager.findAccountProviderAsync(WwaAADAuthenticationAdapter.AAD_PROVIDER_ID, this._aadLoginUrl).done(function (provider) {
                    var request = new WebTokenRequest(provider, Commerce.StringExtensions.EMPTY, _this.aadClientId);
                    request.properties.insert(WwaAADAuthenticationAdapter.REQUEST_PROPERTY_RESOURCE, _this.aadRetailServerResourceId);
                    var commandField = new WebAccountProviderCommand(provider, function (commandParameter) {
                        ...
                        WebAuthenticationCoreManager.requestTokenAsync(request).done(function (tokenResult) {
                            Commerce.RetailLogger.librariesAuthenticationAADAcquiredToken(_this.aadAuthority, correlationId);
                            ...
                            if (tokenResult.responseStatus === WebTokenRequestStatus.success) {
                                ...
                                switch (tokenResult.responseStatus) {
                                    ...
                                    default:
                                        ...
                                        Commerce.RetailLogger.librariesAuthenticationFailedToRequestToken(self.aadAuthority, errorCode, errorDescription);
...
(function (Commerce) {
    ...
    (function (Host) {
        "use strict";
        var WwaApplication = (function (_super) {
            __extends(WwaApplication, _super);
            function WwaApplication() {
                var _this = _super.call(this, Commerce.Proxy.Entities.ApplicationTypeEnum.MposForWindows, {
                ...
                Commerce.RetailLogger.applicationType(Commerce.StringExtensions.EMPTY, _this.getApplicationType(), Commerce.Proxy.Entities.ApplicationTypeEnum[_this.getApplicationType()]);
                return _this;
            }
            WwaApplication.prototype.getApplicationName = function () {
                return Commerce.StringResourceManager.getString("string_0");
            };
    ...
    (function (Host) {
        ...
        var WwaGlobalization = (function (_super) {
            ...
            WwaGlobalization.prototype.setApplicationLanguageAsync = function (languageTag) {
                ...
                Windows.Globalization.ApplicationLanguages.primaryLanguageOverride = Host.Globalization.CultureHelper.resolveAvailableUICulture(languageTag, this.getDefaultLanguageTag(), this._getSupportedLanguageTags());
                return Commerce.VoidAsyncResult.createResolved();
            };
            WwaGlobalization.prototype.getDefaultLanguageTag = function () {
                return this._getSupportedLanguageTags()[0] || "en-US";
            };
            WwaGlobalization.prototype._getSupportedLanguageTags = function () {
...
(function (Commerce) {
    ...
    (function (Host) {
        ...
        var WwaHost = (function () {
            ...
            WwaHost.prototype.initializeAsync = function () {
                return Commerce.VoidAsyncResult.createResolved();
            };
            return WwaHost;
        }());
                        ...
                        this._barcodeScanner.claimScannerAsync()
                            ...
                            if (claimedScanner) {
                                try {
                                    ...
                                    Commerce.RetailLogger.peripheralsBarcodeScannerEnableFailed(Commerce.ErrorHelper.serializeError(e));
                                    asyncResult.reject([new Commerce.Proxy.Entities.Error(Commerce.ErrorTypeEnum.PERIPHERALS_BARCODE_SCANNER_ENABLE_FAILED)]);
                                }
                            }
                            else {
            ...
            var DualDisplay = (function () {
                ...
                DualDisplay.prototype.sendCustomerChangedMessage = function () {
                    this._sendMessage({
                        ...
                        args: { customer: Commerce.Session.instance.customerContext.customer }
                    });
                };
                DualDisplay.prototype.sendDualDisplayConfigurationChangedMessage = function (hardwareProfile) {
                    this._sendMessage({
                        type: "dualDisplayConfigurationChanged",
                        args: {
                            webBrowserUrl: hardwareProfile.DualDisplayWebBrowserUrl,
                            imageRotatorInterval: hardwareProfile.DualDisplayImageRotatorInterval,
                            imageRotatorPath: hardwareProfile.DualDisplayImageRotatorPath,
                            receiptWidthPercentage: hardwareProfile.DualDisplayReceiptWidthPercentage,
                            displayType: hardwareProfile.DualDisplayDisplayType
                        }
                    });
                };
                DualDisplay.prototype.sendIsLoggedOnStateChangedMessage = function (args) {
                    this._sendMessage({
                        type: "isLoggedOnStateChanged",
                        args: {
                            isLoggedOn: args.isLoggedOn,
                            currentEmployee: args.currentEmployee
                        }
                    });
                };
                ...
                DualDisplay.prototype._sendMessage = function (message) {
                    if (message.type === "getChannelConfigurationDataResponse" ||
                        ...
                        message.type === "getExtensionPackagesConfigurationDataResponse") {
                ...
                DualDisplay.prototype._handleMessage = function (message) {
                    ...
                    switch (data.type) {
                        ...
                        case "getCurrentLogonStateDataRequest":
                            ...
                            break;
                        case "getExtensionPackagesConfigurationDataRequest":
                            this._handleMessageGetExtensionPackagesConfigurationDataRequest();
                            break;
                        default:
                            break;
                    }
                ...
                DualDisplay.prototype._handleMessageGetExtensionPackagesConfigurationDataRequest = function () {
                    var _this = this;
                    ...
                    Commerce.Runtime.executeAsync(request)
                        ...
                        _this._sendMessage({
                            type: "getExtensionPackagesConfigurationDataResponse",
            ...
            var Printer = (function () {
                ...
                Printer.prototype.prepareContentUnsafe = function (printableReceipts) {
                    ...
                    printableReceipts.forEach(function (receipt) {
                        ...
                        printBuffer = _this._processImageMarkers(printBuffer);
                ...
                Printer.prototype._processImageMarkers = function (printBuffer) {
                    var imgRegEx = "<I:(.+?)>";
                    var regExp = new RegExp(imgRegEx);
                    var match = regExp.exec(printBuffer);
                    while (!Commerce.ObjectExtensions.isNullOrUndefined(match)) {
                        printBuffer = printBuffer.replace(match[0], Commerce.StringExtensions.format("<img src=\"data:image/png;base64,{0}\"/>", match[1]));
                        match = regExp.exec(printBuffer);
                    }
                    return printBuffer;
                };
...
(function (Pos) {
    ...
    var CryptographicBuffer = Cryptography.CryptographicBuffer;
    var BinaryStringEncoding = Cryptography.BinaryStringEncoding;
    var ApplicationDataContainerStorage = (function () {
        function ApplicationDataContainerStorage(container) {
            this._container = container;
        }
        Object.defineProperty(ApplicationDataContainerStorage, "instance", {
            get: function () {
                if (Commerce.ObjectExtensions.isNullOrUndefined(ApplicationDataContainerStorage._instance)) {
                    var container = Windows.Storage.ApplicationData.current.localSettings.createContainer(ApplicationDataContainerStorage.CONTAINER_NAME, Windows.Storage.ApplicationDataCreateDisposition.always);
                    ApplicationDataContainerStorage._instance = new ApplicationDataContainerStorage(container);
                }
                return ApplicationDataContainerStorage._instance;
            },
            enumerable: true,
            configurable: true
        });
        ApplicationDataContainerStorage.hasContainer = function () {
            return Windows.Storage.ApplicationData.current.localSettings.containers.hasKey(ApplicationDataContainerStorage.CONTAINER_NAME);
        };
        ApplicationDataContainerStorage.prototype.getItem = function (key) {
            var currentChunkIndex = 0;
            var currentKey = this._getSplitKey(key, currentChunkIndex);
            if (Commerce.ObjectExtensions.isString(this._container.values[currentKey])) {
                return this._container.values[currentKey];
            }
            var chunks = [];
            while (this._container.values.hasKey(currentKey)) {
                chunks.push(this._container.values[currentKey]);
                currentChunkIndex = currentChunkIndex + 1;
                currentKey = this._getSplitKey(key, currentChunkIndex);
            }
            if (chunks.length === 0) {
                return null;
            }
            return this._combine(chunks);
        };
        ApplicationDataContainerStorage.prototype.setItem = function (key, value) {
            var _this = this;
            if (Commerce.StringExtensions.isNullOrWhitespace(key)) {
                throw new Error("ApplicationDataContainerStorage setItem: key cannot be null, undefined or whitespace.");
            }
            if (Commerce.ObjectExtensions.isNullOrUndefined(value)) {
                throw new Error("ApplicationDataContainerStorage setItem: value cannot be null or undefined.");
            }
            var storedSplitKeysCount = 1;
            if (Commerce.StringExtensions.isEmpty(value)) {
                this._container.values[this._getSplitKey(key, 0)] = Commerce.StringExtensions.EMPTY;
            }
            else {
                var chunks = this._split(value);
                chunks.forEach(function (chunk, index) {
                    _this._container.values[_this._getSplitKey(key, index)] = chunk;
                });
                storedSplitKeysCount = chunks.length;
            }
            this._removeSplitKeysStartingFromIndex(key, storedSplitKeysCount);
        };
        ApplicationDataContainerStorage.prototype.removeItem = function (key) {
            this._removeSplitKeysStartingFromIndex(key, 0);
        };
        ApplicationDataContainerStorage.prototype.clear = function () {
            this._container.values.clear();
        };
        ApplicationDataContainerStorage.prototype.getKeys = function () {
            var suffixRemover = function (key) { return key.substr(0, key.lastIndexOf(ApplicationDataContainerStorage.SPLIT_KEY_DELIMITER)); };
            var keysWithoutSuffix = this._getStoredKeys().map(suffixRemover);
            return Commerce.ArrayExtensions.distinct(keysWithoutSuffix);
        };
        ApplicationDataContainerStorage.prototype._split = function (value) {
            var buffer = CryptographicBuffer.convertStringToBinary(value, BinaryStringEncoding.utf8);
            var byteArray = new Uint8Array(CryptographicBuffer.copyToByteArray(buffer));
            var chunks = [];
            var chunksCount = Math.ceil(byteArray.length / ApplicationDataContainerStorage.MAX_SPLIT_VALUE_SIZE_IN_BYTES);
            for (var chunk = 0; chunk < chunksCount; chunk++) {
                var start = chunk * ApplicationDataContainerStorage.MAX_SPLIT_VALUE_SIZE_IN_BYTES;
                var end = Math.min(start + ApplicationDataContainerStorage.MAX_SPLIT_VALUE_SIZE_IN_BYTES, byteArray.length);
                chunks.push(byteArray.subarray(start, end));
            }
            return chunks;
        };
        ApplicationDataContainerStorage.prototype._combine = function (chunks) {
            var totalLength = chunks.reduce(function (previousLength, chunk) { return chunk.length + previousLength; }, 0);
            ...
            var buffer = CryptographicBuffer.createFromByteArray(byteArray);
            return CryptographicBuffer.convertBinaryToString(BinaryStringEncoding.utf8, buffer);
        };
        ApplicationDataContainerStorage.prototype._getStoredKeys = function () {
            var keys = [];
            var element = this._container.values.getView().first();
            while (element.hasCurrent) {
                keys.push(element.current.key);
                if (!element.moveNext()) {
                    break;
                }
            }
        ...
        ApplicationDataContainerStorage.prototype._getSplitKey = function (key, chunkIndex) {
            return Commerce.StringExtensions.format("{0}{1}{2}", key, ApplicationDataContainerStorage.SPLIT_KEY_DELIMITER, chunkIndex);
        };
        ApplicationDataContainerStorage.prototype._removeSplitKeysStartingFromIndex = function (key, chunkStartIndex) {
            var currentKey = this._getSplitKey(key, chunkStartIndex);
            while (this._container.values.hasKey(currentKey)) {
                this._container.values.remove(currentKey);
                chunkStartIndex = chunkStartIndex + 1;
                currentKey = this._getSplitKey(key, chunkStartIndex);
            }
        };
        ApplicationDataContainerStorage.MAX_SPLIT_VALUE_SIZE_IN_BYTES = 8000;
        ApplicationDataContainerStorage.CONTAINER_NAME = "PosStorageContainer";
        ApplicationDataContainerStorage.SPLIT_KEY_DELIMITER = "_";
        return ApplicationDataContainerStorage;
    }());
    Pos.ApplicationDataContainerStorage = ApplicationDataContainerStorage;
})(Pos || (Pos = {}));
var Commerce;
(function (Commerce) {
    var Payments;
...
ko.bindingHandlers.winControl = {
    init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
        Commerce.Host.instance.timers.setImmediate(function () {
            ...
            var _loop_2 = function (memberName) {
...
// SIG // 2z2T36btIGdi8lB33sqINBsa7nFUWRFFpwYsLew5+M6g
...
// SIG // AgEVMC8GCSqGSIb3DQEJBDEiBCACkGB9cOBO6xjSLhvE
// SIG // foY9boBanwEIQiE5jmJKWfRfrDCBugYKKwYBBAGCNwIB
...
// SIG // cm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBXi+sI
// SIG // M2GkMOax72zhhsS77fAbdTanvkLjdiewOxZ0AFS9iGrI
// SIG // 62CRAYSeEpBr6o/BQiiimn5E9JAywx5DoXdUSQ7qBWo3
// SIG // 9uG3gHG22ZYHr91z3A+Qvpd9oCCqIl0ag3SVhJeh/mXF
// SIG // Ec4Zw0MksijmuCd5wx6hQWJXaY1PtfYZTlQZFlZVfbGQ
// SIG // UaSko6ZuwQGjWZ9c+Nkhsei3dd+9CxRMOaziQpLv0YzD
// SIG // 0IlbVrfay5JYCKznfFf6Q3T8lVarxYaJC2UUc0R93AUT
// SIG // bB3QLwYEbjhKRop3HajXtI/02IhJaB4Zg9eDrvZoEZcf
// SIG // XZveSpEhIT9c+AyJznydR0i0DoG7oYIS8TCCEu0GCisG
...
// SIG // MDEwDQYJYIZIAWUDBAIBBQAEIHYHMTaqx2Jk063PSrGH
// SIG // leVz3tkZjyCj03G8BTs+Uw5HAgZfPAgD04QYEzIwMjAw
// SIG // ODIzMDQwMzQ1LjY5NFowBIACAfSggdSkgdEwgc4xCzAJ
...
// SIG // 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgNAdswIlzppcU
// SIG // LGrwQ4IFHMBE+cE+aejr1VuihlxZ7F4wgfoGCyqGSIb3
...
// SIG // /TzWM58Y/KQSC8gGMA0GCSqGSIb3DQEBCwUABIIBAHYX
// SIG // EdztDnfxnG0jO2nT9JihogrPBdM3qWu9qS+NG7z2aRLn
// SIG // UcxXDwTIveC4YOsXA0WRDoTafLYqd5F8itrw3MNmeTh5
// SIG // kus+sFGXR3dAXyCHHIiSiNDzehOKrVV5pcko25Jx9pAL
// SIG // HEP/VU1XhHfqZXk9HoCSYwKAiFUu/6EcUjvhL5FuYV+P
// SIG // ozADiR31blkjhzU2Nsz0sLFPNlXj+dSAYNaUkihWbLZk
// SIG // OGJ004f0IRYhiQ59FPVnTZQC/HofTXljOglQ4UUwAXXw
// SIG // ARvCsJXAJSa4gwjHiwMh6o56oKKp6QxnAu1oK94Ewamo
// SIG // j0eGv9uUGd7BOqIDNt0/NWP9mkcezgo=
