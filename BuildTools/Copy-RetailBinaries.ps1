<#
.SYNOPSIS
    Copies the built Retail binaries to AX build.

.DESCRIPTION
    This script is intended for use in the Dynamics AX Development environment
    to automate the build of Retail Sdk as part of the AX build.
#>
Param(
...
try
{
    ...
    # $fileName = 'some dll's file name built in Retail Sdk'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCEUXpUw6aaPQiX
# Y/HSLZI4+2dOVMiopRoCcFHFOQY4I6CCDYEwggX/MIID56ADAgECAhMzAAABh3IX
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILfmnBgd
# afIPRbVLo4b+P9qfWlaLYwTO9C0QhbFhU7C+MIG6BgorBgEEAYI3AgEMMYGrMIGo
...
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAAC/XutF
# 2sYBK+PpQPnkSitd2Yd7uvG3c6XUqkkBsk3x12TQyqRDiTaULR/mB6ZgV+H4T5R+
# s8MtBSsjnfv3T9MGDzaYGF+8CnDaRhx54ibcoo06M+P3JSf/X80krtE5p0Vospup
# tAFOIxEruP4cORyW3IkIuxnhztvTqh2nIgbi2NCvOeUU0ioNpScQkB9zDeNbCExN
# zdj251gMt6lI9f1mcgQMtZKqMPFuWsZaQG2oMCkgNqOhbIQtf7Sp2I6Ynrqhrad5
# lEe4zwmWI2mjm6hWAm97zOf+EXGZwbtx1oPGkemgtKeZuo4qzISXnC5jx6WAhNvV
# ccyUKe/Z1QyOuZ6hghLxMIIS7QYKKwYBBAGCNwMDATGCEt0wghLZBgkqhkiG9w0B
# BwKgghLKMIISxgIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBVQYLKoZIhvcNAQkQAQSg
# ggFEBIIBQDCCATwCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg6ag2
# jzZzSLJM3wN7RsDtWt4h6YFaG2f7TYzeFf3M/6cCBl875WucIBgTMjAyMDA4MjMw
# NDAzNDQuNzYxWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# MQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCD6JU2n7DqdjmmxHTOTqsA1
# mgmCceH6XjNgfXtHff0F0zCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIBuS
...
# 87gf5anATtTylHBXzMG4NDsIFzrgdb+2AUi0+VrjeM8s0FUbhGSLgmP/FcsU2HCf
# V8wmCh0nE9l7HvknHo7thh+HQCn2jeWHCQ4y4o5t3DBQ0wsq8vSCIOaQ7rISs6wa
# u/FJ1bGCx1Sy6/X4k7htqJRoxsGgjp95bFt26K/8D793GuO4PGtd1iw1uRJSxtVj
# fspQunu6eF1fC7v2AZ6SpAqzzooKmKH7bxPdiiZcZRB6fIWmSvJfJsEzAQC+OPwA
# dNSMLk9AJMbmsAPXxiBWFsKRwjtnO+fygYeNd6cH/+mxz0g09aQzdLeDBbrgPu0r
# gowkuEHO3cdLY7vpsc20EQ==
