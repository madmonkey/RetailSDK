<#
.SYNOPSIS
    Copies the built Retail packages to the package output.
...
try
{
    ...
    # RetailCombinedPackage package
    Copy-FileWithCheck -fromFilePath (Join-Path -Path $retailSdkSourcePath -ChildPath 'Packages\RetailDeployablePackage\RetailDeployablePackage.zip') `
                       -toFilePath (Join-Path -Path $BuildPackagePath -ChildPath "RetailDeployablePackage_$BuildVersion.zip")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA18TYLgS8hGcjP
# QRrCYEyCgbeqV+zrPJcEtKb3PzLerqCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# tv1kDha6N/tVWRspX1pDnq85qZUo6juArJe21lkMDjCBugYKKwYBBAGCNwIBDDGB
...
# quQoakTdhUqybO1jQJcvzaugzdH5Ow/Yi8xEvNOUXyuTd3ZHXaXF7fn+idwZlMjf
# 4/U10a3eBfuK7R6Wmm9Jdn4Jv5DfPb/Yz4CN5t/LYo00qOPWNdroUUGWtHgY3K7/
# dL/UsQEWQ/tbEO7Nam8IlyOl1bZrgiz6KLcrdLxOHPgodpOMn1N1rITf1Q/3hukN
# 2aXE8FFhEwDK6bUdzP3wDF/uJMwWvQkfnFFJNehqiT93ol7uGk4umfaRJPJBD7wp
# uXw/24LO4RYdLm5D60LYqM8f8pzikYyDOIDuYfMhjL39e96nHBF3fpkzmKAVqNfd
# 7vXx3jueAlNe/c4/87q3oYIS4jCCEt4GCisGAQQBgjcDAwExghLOMIISygYJKoZI
...
# IGdEacCjFbXlOh+idQhN5oRmQjtrlEb0lrIQ0niE/rV2AgZfPUPRUxIYEzIwMjAw
# ODIzMDQwMzQyLjgxOVowBIACAfSggdCkgc0wgcoxCzAJBgNVBAYTAlVTMQswCQYD
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQg+fM6DKw8hDDf7SgrPTzorW5h73x2229lhfT/
# 3xkLbBowgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCCOPhKvogUeGkGhaxtC
...
# wJXmPwWjbKm3SVm5jXZolsa3MA0GCSqGSIb3DQEBCwUABIIBAJ0cEw5raEGvSrS0
# MbcAXlRtOP1aFP/OdcXu42E4d1DH7c0UDNByFTadVBs7l8Jr8H01UfUUD1RVoh1F
# +ZUeFMmFAC1z7L9FG2cB7n6C69yk+/8QRNcm+WwbPPX8NAeWH0gEYk8MJzW72K6f
# 0NeoEfsXgRFzi5PRQ0/hIHISZV3LphfLUCKoNR2Kovxrkdt9v4v9DcE2rwpB8OIb
# JFKU+Qjd6UCAejRba5ODnPzGpANpHKVK/90OX05HKS2Qwqx/Khxa8Feo2N6e4sak
# //piWAl4QPyTG+hWXJLCRQ+7wkKBOwl7+Ms0SF4RUE3SyFj/zfPrkeOtpHlcqyB3
# ELMwJ8Y=
