...
namespace Contoso
{
    namespace Retail.Deployment.PackageSetup
    {
        ...
        using Microsoft.Dynamics.Retail.Deployment.Toolkit;
        using Microsoft.Dynamics.Retail.Deployment.SelfService.BootstrapperLibrary;
        ...
        public static class Program
        {
            ...
            private const string SettingsArgument = "-Config";
            private static Action<string> progressMessageLogger;
            private static ParameterDictionary parameterDictionary;
            ...
            private static void Execute(string[] args, Assembly assembly)
            {
                ...
                parameterDictionary = CommandLineParser.Parse(args);
                executeInSilentMode = parameterDictionary.ContainsKey(ParameterConstants.QuietMode);

                uiMode = !executeInSilentMode; 
                ...
                InstallerDiagnostics.CleanupLogDirectories(cleanupDiagnosticsLogFilePath: logFilePath);
            ...
            {
                string configurationSettingsFilePath;
                ...
                if (!parameterDictionary.ContainsKey(ParameterConstants.Settings))
                {
                    // Try to lookup settings file that was downloaded from AX and put side by side with bootstrapper.
                    // Otherwise, the Settings is just passed-thru.
                    configurationSettingsFilePath = Utilities.GetSettingsFilePathIfExists(assembly.Location, progressMessageLogger);
