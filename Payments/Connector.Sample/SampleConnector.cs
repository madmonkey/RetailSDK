...
namespace Microsoft.Dynamics
{
    namespace Retail.SampleConnector.Portable
    {
        ...
        public class SampleConnector : SampleProcessorIdentifier, IPaymentProcessor, IPaymentProcessorExtension, IPaymentReferenceProvider
        {
            #region Contants
        ...
        private const string DefaultEnvironment = "INT";
            ...
            /// <summary>
            /// Gets the internal propert activedGiftCards.
            /// </summary>
            ...
            private static List<PaymentError> ProcessActivateGiftCardResult(ActivateGiftCardResponse response, ActivateGiftCardRequest request)
            {
                ...
                */
                ...
                // Set approval state depending on Available Balance value and whether the gift card has already been actived.
            ...
            private static bool ProcessCaptureResult(CaptureResponse response, CaptureRequest request, IList<PaymentError> errors)
            {
                ...
                */
                ...
                bool isApproved = CaptureResult.Success.ToString().Equals(response.CaptureResult, StringComparison.InvariantCulture);
            ...
            private static List<PaymentError> ProcessVoidResult(VoidResponse response, VoidRequest request)
            {
                ...
                */
                ...
                bool isApproved = VoidResult.Success.ToString().Equals(response.VoidResult, StringComparison.InvariantCulture);
            ...
            private static List<PaymentError> ProcessRefundResult(RefundResponse response, RefundRequest request)
            {
                ...
                */
                ...
                bool isApproved = isGiftCardTransaction
                    ? RefundResult.Success.ToString().Equals(response.RefundResult, StringComparison.InvariantCulture) || giftCardHasBeenActivated
                    : RefundResult.Success.ToString().Equals(response.RefundResult, StringComparison.InvariantCulture);
                if (isApproved)
                {
