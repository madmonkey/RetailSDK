    ...
    namespace Retail.SampleConnector.Portable
    {
        ...
        internal class AuthorizeResponse : ResponseBase
        {
            ...
            internal static Response ConvertTo(AuthorizeResponse authorizeResponse)
            {
                ...
                PaymentUtilities.AddPropertyIfPresent(authorizationRespnseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.PaymentTrackingId, authorizeResponse.PaymentTrackingId);
                PaymentUtilities.AddPropertyIfPresent(authorizationRespnseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.SupportsMultipleCaptures, "True");
