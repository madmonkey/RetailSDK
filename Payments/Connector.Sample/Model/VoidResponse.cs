    ...
    namespace Retail.SampleConnector.Portable
    {
        ...
        internal class VoidResponse : ResponseBase
        {
            ...
            internal static Response ConvertTo(VoidResponse voidResponse)
            {
                ...
                PaymentUtilities.AddPropertyIfPresent(voidRespnseProperties, GenericNamespace.VoidResponse, VoidResponseProperties.CloseAmount, voidResponse.CloseAmount);
                PaymentUtilities.AddPropertyIfPresent(voidRespnseProperties, GenericNamespace.VoidResponse, VoidResponseProperties.PaymentTrackingId, voidResponse.PaymentTrackingId);
