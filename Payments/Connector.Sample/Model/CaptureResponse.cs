    ...
    namespace Retail.SampleConnector.Portable
    {
        ...
        internal class CaptureResponse : ResponseBase
        {
            ...
            internal static Response ConvertTo(CaptureResponse captureResponse)
            {
                ...
                PaymentUtilities.AddPropertyIfPresent(captureRespnseProperties, GenericNamespace.CaptureResponse, CaptureResponseProperties.PaymentTrackingId, captureResponse.PaymentTrackingId);
