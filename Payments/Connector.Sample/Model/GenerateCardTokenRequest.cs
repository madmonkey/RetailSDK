        ...
        internal class GenerateCardTokenRequest : RequestBase
        {
            ...
            internal static GenerateCardTokenRequest ConvertFrom(Request request, PaymentProperty[] requiredInteractionProperties)
            {
                ...
                if (cardProperties != null)
                {
                    ...
                    {
                        if (GenericNamespace.PaymentCard.Equals(cardProperty.Namespace, StringComparison.InvariantCulture) && IsCustomCardProperty(cardProperty.Name))
                        {
                ...
                {
                    if (GenericNamespace.PaymentCard.Equals(requestProperty.Namespace, StringComparison.InvariantCulture)
