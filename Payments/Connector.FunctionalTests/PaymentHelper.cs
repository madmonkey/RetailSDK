namespace Microsoft.Dynamics
{
    namespace Retail.Connector.FunctionalTests
    {
        ...
        internal sealed class PaymentHelper
        {
            ...
            /// <summary>
            /// Get payment properties of the activate gift card transaction data from the test context.
            /// </summary>
            /// <returns>Array with properties.</returns>
            public PaymentProperty[] GetActivateProperties()
            {
                var properties = new List<PaymentProperty>();
                this.TryAddStringProperty(properties, GenericNamespace.TransactionData, TransactionDataProperties.CardNumber, this.testContext, ColumnName.CardNumber);
                this.TryAddStringProperty(properties, GenericNamespace.TransactionData, TransactionDataProperties.CurrencyCode, this.testContext, ColumnName.CurrencyCode);
                this.TryAddDecimalProperty(properties, GenericNamespace.TransactionData, TransactionDataProperties.Amount, this.testContext, ColumnName.Amount);
                this.TryAddStringProperty(properties, GenericNamespace.TransactionData, TransactionDataProperties.IndustryType, this.testContext, ColumnName.IndustryType);
                this.TryAddStringProperty(properties, GenericNamespace.TransactionData, TransactionDataProperties.AllowPartialAuthorization, this.testContext, ColumnName.AllowPartialAuthorization);
            ...
            /// <summary>
            /// Get payment properties of the load gift card transaction data from the test context.
            /// </summary>
            /// <returns>Array with properties.</returns>
            public PaymentProperty[] GetLoadGiftCardProperties()
            {
            ...
            /// <summary>
            /// Get payment properties of the balance on gift card transaction from the test context.
            /// </summary>
            /// <returns>An array of properties derived from the test context.</returns>
            public PaymentProperty[] GetBalanceOnGiftCardProperties()
            {
                List<PaymentProperty> properties = new List<PaymentProperty>();
                this.TryAddStringProperty(properties, GenericNamespace.TransactionData, TransactionDataProperties.CardNumber, this.testContext, ColumnName.CardNumber);
                return properties.ToArray();
            ...
            public void AssertPropertyNotNull(Hashtable actualProperties, string expectedPropertyNamespace, string expectedPropertyName)
            {
                ...
                {
                    throw new ArgumentNullException(nameof(actualProperties));
                }
            ...
            public void AssertPropertyValueMatch(Hashtable propertyTable1, string propertyNamespace1, string propertyName1, Hashtable propertyTable2, string propertyNamespace2, string propertyName2)
            {
                ...
                {
                    throw new ArgumentNullException(nameof(propertyTable1));
                }

                if (propertyTable2 == null)
                {
                    throw new ArgumentNullException(nameof(propertyTable2));
                }
            ...
            public Request CreateAuthorizeRequest(Response tokenizeResponse)
            {
                ...
                {
                    throw new ArgumentNullException(nameof(tokenizeResponse));
                }
            ...
            /// <summary>
            /// Creates a void request for a gift card transaction.
            /// </summary>
            /// <returns>The void request.</returns>
            public Request CreateVoidRequestForGiftCard()
            {
                Request voidRequest = this.GetNewRequestWithMechantAccount();
                voidRequest.Properties = this.CombineProperties(voidRequest.Properties, this.GetPaymentCardProperties());
                List<PaymentProperty> properties = new List<PaymentProperty>(voidRequest.Properties);
                this.TryAddDecimalProperty(properties, GenericNamespace.TransactionData, TransactionDataProperties.Amount, this.testContext, ColumnName.Amount);
                voidRequest.Properties = properties.ToArray();

                return voidRequest;
            }

            /// <summary>
            /// Creates a void request for a gift card transaction from an authorization response.
            /// </summary>
            /// <param name="authorizeResponse">The authorization response.</param>
            /// <returns>The void request.</returns>
            public Request CreateVoidRequestForGiftCard(Response authorizeResponse)
            {
                if (authorizeResponse == null)
                {
                    return this.CreateVoidRequestForGiftCard();
                }
                ...
                var voidRequest = this.GetNewRequestWithMechantAccount();
                voidRequest.Locale = authorizeResponse.Locale;
                voidRequest.Properties = this.CombineProperties(voidRequest.Properties, cardProperties, new PaymentProperty[] { authorizationResponsePropertyList });
                return voidRequest;
            }
            ...
            public Request CreateRefundRequestFromCaptureResponse(Response captureResponse)
            {
                ...
                {
                    throw new ArgumentNullException(nameof(captureResponse));
                }
            ...
            {
                Type paymentManagerType = typeof(PaymentProcessorManager);
                PropertyInfo propertyInfo = paymentManagerType.GetProperty("Connectors", BindingFlags.Static | BindingFlags.NonPublic);
                propertyInfo.SetValue(null, Enumerable.Empty<IPaymentProcessor>());
            ...
            private void LoadPaymentProcessors(string connectorType)
            {
                ...
                PaymentProcessorManager.LoadAllAssemblies(new string[] { connectorPath });
