namespace Microsoft.Dynamics
{
    ...
    {
        using System;
        using Microsoft.Dynamics.Commerce.Tests.Utilities.Attributes;
        ...
        public class PaymentProcessorFunctionalTests
        {
            ...
            public void PaymentProcessor_Create_PortableEmptyPath()
            {
                ...
                // Act.
                SDKManager.Portable.PaymentProcessorManager.Create(string.Empty);
            ...
            public void PaymentProcessor_Create_DesktopEmptyPath()
            {
                ...
                // Act.
                SDKManager.PaymentProcessorManager.Create(string.Empty);
            ...
            {
                // Arrange.
                SDKManager.Portable.PaymentProcessorManager.Create(PaymentHelper.PortableConnectorPath);

                // Act.
                SDKManager.Portable.PaymentProcessorManager.GetPaymentProcessor("DoesNotExist");
            ...
            #region Activate Gift Card test
            /// <summary>
            /// Validates basic activation of gift card. Expects success and correct amount.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("00162AD3-BB94-D07A-B096-7466BD6F8A77")]
            [DeploymentItem(@"TestData\PaymentProcessor_ActivateGiftCard_Basic.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_ActivateGiftCard_Basic.xml", "PaymentProcessor_ActivateGiftCard_Basic", DataAccessMethod.Sequential)]
            public void PaymentProcessor_ActivateGiftCard_Basic()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request request = this.GetActivateRequest();
                this.helper.PrintRequestWhenDebug(request);

                // Act.
                Response response = processor.ActivateGiftCard(request, null);
                ...
                const decimal ExpectedAvailableBalance = 1000M;
                this.helper.AssertPropertyMatch(requestProperties, responseProperties, GenericNamespace.MerchantAccount, MerchantAccountProperties.ServiceAccountId);
                this.helper.AssertPropertyValue(responseProperties, GenericNamespace.ActivateGiftCardResponse, ActivateGiftCardResponseProperties.ActivateGiftCardResult, ActivateGiftCardResult.Success.ToString());
                this.helper.AssertPropertyValue(responseProperties, GenericNamespace.ActivateGiftCardResponse, ActivateGiftCardResponseProperties.AvailableBalance, ExpectedAvailableBalance);
                this.helper.AssertPropertyNotNull(responseProperties, GenericNamespace.ActivateGiftCardResponse, ActivateGiftCardResponseProperties.Last4Digits);
            }
            #endregion

            #region Reactive same Gift Card
            /// <summary>
            /// Validates correct Gift Card activation behavior when attempt is made to activate same Gift Card. Expect error returned in Response.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("36D4677A-A27C-BCBF-B100-1A52B05F6944")]
            [DeploymentItem(@"TestData\PaymentProcessor_ActivateGiftCard_Basic.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_ActivateGiftCard_Basic.xml", "PaymentProcessor_ActivateGiftCard_Basic", DataAccessMethod.Sequential)]
            public void PaymentProcessor_ActivateGiftCard_Reactivation()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request activateRequest = this.GetActivateRequest();
                this.helper.PrintRequestWhenDebug(activateRequest);

                // Act.
                Response response1 = processor.ActivateGiftCard(activateRequest, null);
                Response response2 = processor.ActivateGiftCard(activateRequest, null);

                // Assert.
                this.helper.AssertResponseNotNull(response1);
                this.helper.PrintResponseWhenDebug(response1);

                this.helper.AssertResponseNotNull(response2);
                this.helper.AssertResponseErrorCode(response2, ErrorCode.CardAlreadyActivated);
                this.helper.PrintResponseWhenDebug(response2);
            }
            #endregion

            #region Gift Card activation with incorrect Card Type
            /// <summary>
            /// Validates correct Gift Card activation behavior when attempting to use a Card Type other than 'GiftCard'.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("4D8ED458-ABD1-D117-38C6-59C468534802")]
            [DeploymentItem(@"TestData\PaymentProcessor_ActivateGiftCard_IncorrectCardType.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_ActivateGiftCard_IncorrectCardType.xml", "PaymentProcessor_ActivateGiftCard_IncorrectCardType", DataAccessMethod.Sequential)]
            public void PaymentProcessor_ActivateGiftCard_IncorrectCardType()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request request = this.GetActivateRequest();
                ...
                this.helper.AssertResponseNotNull(response);
                this.helper.AssertResponseErrorCode(response, ErrorCode.CardTypeNotSupported);
                this.helper.PrintResponseWhenDebug(response);
            }
            #endregion

            #region Gift Card activation with invalid card type
            /// <summary>
            /// Validates correct Gift Card activation behavior when attempting to use a Card Type not supported.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("B5F8CA5F-863A-C166-52AA-54315D4DCD6B")]
            [DeploymentItem(@"TestData\PaymentProcessor_ActivateGiftCard_InvalidCardType.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_ActivateGiftCard_InvalidCardType.xml", "PaymentProcessor_ActivateGiftCard_InvalidCardType", DataAccessMethod.Sequential)]
            public void PaymentProcessor_ActivateGiftCard_InvalidCardType()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request request = this.GetActivateRequest();
            ...
            #region Balance on Gift Card tests
            /// <summary>
            /// Validates basic retrieval of balance on gift card. Expect a success and correct amount.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("EE606647-B3C4-5BA1-B2F2-3FAA88BDC82D")]
            [DeploymentItem(@"TestData\PaymentProcessor_BalanceOnGiftCard_Basic.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_BalanceOnGiftCard_Basic.xml", "PaymentProcessor_BalanceOnGiftCard_Basic", DataAccessMethod.Sequential)]
            public void PaymentProcessor_BalanceOnGiftCard_Basic()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request activateRequest = this.GetActivateRequest();
                Request bogcRequest = this.GetBalanceOnGiftCardRequest();
                this.helper.PrintRequestWhenDebug(bogcRequest);

                // Act.
                Response activateResponse = processor.ActivateGiftCard(activateRequest, null);
                Response bogcResponse = processor.BalanceOnGiftCard(bogcRequest, null);

                // Assert.
                this.helper.AssertResponseNotNull(activateResponse);
                this.helper.PrintResponseWhenDebug(activateResponse);

                this.helper.AssertResponseNotNull(bogcResponse);
                this.helper.PrintResponseWhenDebug(bogcResponse);

                Hashtable bogcResponseProperties = PaymentProperty.ConvertToHashtable(bogcResponse.Properties);
                this.helper.AssertPropertyValue(bogcResponseProperties, GenericNamespace.BalanceOnGiftCardResponse, BalanceOnGiftCardProperties.BalanceOnGiftCardResult, BalanceOnGiftCardResult.Success.ToString());

                const decimal ExpectedAvailableBalance = 1000M;
                this.helper.AssertPropertyValue(bogcResponseProperties, GenericNamespace.BalanceOnGiftCardResponse, BalanceOnGiftCardProperties.AvailableBalance, ExpectedAvailableBalance);
            }

            /// <summary>
            /// Validates whether the attempt to retrieve balance on a gift card not yet activated
            /// returns the expected 0 balance as well as failure response.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("846BF798-35A7-A39A-E8E3-BA48BF207BAD")]
            [DeploymentItem(@"TestData\PaymentProcessor_BalanceOnGiftCard_NotActivated.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_BalanceOnGiftCard_NotActivated.xml", "PaymentProcessor_BalanceOnGiftCard_NotActivated", DataAccessMethod.Sequential)]
            public void PaymentProcessor_BalanceOnGiftCard_NotActivated()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request request = this.GetBalanceOnGiftCardRequest();
                this.helper.PrintRequestWhenDebug(request);

                // Act.
                Response response = processor.BalanceOnGiftCard(request, null);

                // Assert.
                this.helper.AssertResponseNotNull(response);
                this.helper.PrintResponseWhenDebug(response);

                this.helper.AssertResponseErrorCode(response, ErrorCode.CardNotActivated);

                Hashtable responseProperties = PaymentProperty.ConvertToHashtable(response.Properties);
                this.helper.AssertPropertyValue(responseProperties, GenericNamespace.BalanceOnGiftCardResponse, BalanceOnGiftCardProperties.BalanceOnGiftCardResult, BalanceOnGiftCardResult.Failure.ToString());

                const decimal ExpectedAvailableBalance = 0.0M;
                this.helper.AssertPropertyValue(responseProperties, GenericNamespace.BalanceOnGiftCardResponse, BalanceOnGiftCardProperties.AvailableBalance, ExpectedAvailableBalance);
            }
            #endregion

            #region Load Gift Card test
            /// <summary>
            /// Validates basic loading of gift card. Expects success and correct amount.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("9252D3E9-F6F1-EB3A-815E-CA89B7E0024B")]
            [DeploymentItem(@"TestData\PaymentProcessor_LoadGiftCard_Basic.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_LoadGiftCard_Basic.xml", "PaymentProcessor_LoadGiftCard_Basic", DataAccessMethod.Sequential)]
            public void PaymentProcessor_LoadGiftCard_Basic()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request activateRequest = this.GetActivateRequest();
                Request loadRequest = this.GetLoadGiftCardRequest();
                this.helper.PrintRequestWhenDebug(loadRequest);

                // Act.
                Response activateResponse = processor.ActivateGiftCard(activateRequest, null);
                Response loadResponse = processor.LoadGiftCard(loadRequest, null);

                // Assert.
                this.helper.PrintResponseWhenDebug(activateResponse);
                this.helper.AssertResponseNotNull(activateResponse);
                this.helper.PrintResponseWhenDebug(loadResponse);
                this.helper.AssertResponseNotNull(loadResponse);

                const decimal ExpectedAvailableBalance = 500M;
                Hashtable loadResponseProperties = PaymentProperty.ConvertToHashtable(loadResponse.Properties);
                this.helper.AssertPropertyValue(loadResponseProperties, GenericNamespace.LoadGiftCardResponse, LoadGiftCardResponseProperties.LoadGiftCardResult, LoadGiftCardResult.Success.ToString());
                this.helper.AssertPropertyValue(loadResponseProperties, GenericNamespace.LoadGiftCardResponse, LoadGiftCardResponseProperties.AvailableBalance, ExpectedAvailableBalance);
            }

            /// <summary>
            /// Validates attempt to load a gift card that has not been activated. Expects error.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("87860D6C-64BC-A189-5244-A831724020CC")]
            [DeploymentItem(@"TestData\PaymentProcessor_LoadGiftCard_CardNotActivated.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_LoadGiftCard_CardNotActivated.xml", "PaymentProcessor_LoadGiftCard_CardNotActivated", DataAccessMethod.Sequential)]
            public void PaymentProcessor_LoadGiftCard_CardNotActivated()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request request = this.GetLoadGiftCardRequest();
                this.helper.PrintRequestWhenDebug(request);

                // Act.
                Response response = processor.LoadGiftCard(request, null);
            ...
            #region Authorize Gift Card Tests
            /// <summary>
            /// Validates basic activation and authorization of Gift Card.
            ...
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("5B5DC1D2-E38F-3267-E77F-DDE2C0D007A2")]
            [DeploymentItem(@"TestData\PaymentProcessor_AuthorizeGiftCard_Basic.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_AuthorizeGiftCard_Basic.xml", "PaymentProcessor_AuthorizeGiftCard_Basic", DataAccessMethod.Sequential)]
            public void PaymentProcessor_Authorize_GiftCardAuthorizeBasic()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request activateGiftCardRequest = this.GetActivateRequest();
                Request authGiftCardRequest = this.GetAuthorizeRequest();
                this.helper.PrintRequestWhenDebug(authGiftCardRequest);

                // Act.
                Response activateGiftCardResponse = processor.ActivateGiftCard(activateGiftCardRequest, null);
                Response authGiftCardResponse = processor.Authorize(authGiftCardRequest, null);

                // Assert.
                this.helper.PrintResponseWhenDebug(activateGiftCardResponse);
                this.helper.AssertResponseNotNull(activateGiftCardResponse);
                this.helper.AssertResponseNoError(activateGiftCardResponse);

                this.helper.PrintResponseWhenDebug(authGiftCardResponse);
                this.helper.AssertResponseNotNull(authGiftCardResponse);
                this.helper.AssertResponseNoError(authGiftCardResponse);

                Hashtable authGiftCardResponseProperties = PaymentProperty.ConvertToHashtable(authGiftCardResponse.Properties);
                Hashtable authGiftCardRequestProperties = PaymentProperty.ConvertToHashtable(authGiftCardRequest.Properties);

                this.helper.AssertNoMerchantCredential(authGiftCardResponse.Properties);
                this.helper.AssertNoPCIProperties(authGiftCardResponseProperties);
                this.helper.AssertPropertyMatch(authGiftCardRequestProperties, authGiftCardResponseProperties, GenericNamespace.MerchantAccount, MerchantAccountProperties.ServiceAccountId);
                this.helper.AssertPropertyValue(authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.AuthorizationResult, AuthorizationResult.Success.ToString());
                this.helper.AssertPropertyValueMatch(authGiftCardRequestProperties, GenericNamespace.PaymentCard, PaymentCardProperties.CardType, authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.CardType);
                this.helper.AssertPropertyValueMatch(authGiftCardRequestProperties, GenericNamespace.TransactionData, TransactionDataProperties.Amount, authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.ApprovedAmount);
                this.helper.AssertPropertyNotNull(authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.ProviderTransactionId);
                this.helper.AssertPropertyValueMatch(authGiftCardRequestProperties, GenericNamespace.TransactionData, TransactionDataProperties.CurrencyCode, authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.CurrencyCode);
                this.helper.AssertPropertyNotNull(authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.Last4Digits);
                this.helper.AssertPropertyValueMatch(authGiftCardRequestProperties, GenericNamespace.PaymentCard, PaymentCardProperties.IsSwipe, authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.IsSwiped);
                this.helper.AssertPropertyValue(authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.TransactionType, TransactionType.Authorize.ToString());
                ...
                if (this.testContext.TryGetDecimalValue(ColumnName.ExpectedAvailableBalance, out expectedAvailableBalance))
                {
                    ...
                    if (PaymentProperty.GetPropertyValue(authGiftCardResponseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.AvailableBalance, out actualAvailableBalance))
                    {
                ...
                // Arrange 2.
                Request captureRequest = this.helper.CreateCaptureRequest(authGiftCardResponse);
            ...
            /// <summary>
            /// Validates correct gift card authorization behavior when gift card has not been activated. Expected failure.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("BFA9DB2D-10A0-4541-1CD1-BE45CDCFBEF7")]
            [DeploymentItem(@"TestData\PaymentProcessor_Authorize_GiftCardAuthorizeNotActivated.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_Authorize_GiftCardAuthorizeNotActivated.xml", "PaymentProcessor_Authorize_GiftCardAuthorizeNotActivated", DataAccessMethod.Sequential)]
            public void PaymentProcessor_Authorize_GiftCardAuthorizeNotActivated()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request authGiftCardRequest = this.GetAuthorizeRequest();
                ...
                // Act.
                Response response = processor.Authorize(authGiftCardRequest, null);

                // Assert.
                this.helper.AssertResponseErrorCode(response, ErrorCode.CardNotActivated);

                Hashtable responseProperties = PaymentProperty.ConvertToHashtable(response.Properties);
                this.helper.AssertPropertyValue(responseProperties, GenericNamespace.AuthorizationResponse, AuthorizationResponseProperties.AuthorizationResult, AuthorizationResult.Failure.ToString());
            }
            #endregion
            ...
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("534E7484-A75C-495B-BFCC-FECEAC384D63")]
            ...
            /// <summary>
            /// Activates and then closes gift card. Expect success.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("737EC213-F2A1-C47F-B5E2-41A4FCF2A66C")]
            [DeploymentItem(@"TestData\PaymentProcessor_Void_CloseGiftCard.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_Void_CloseGiftCard.xml", "PaymentProcessor_Void_CloseGiftCard", DataAccessMethod.Sequential)]
            public void PaymentProcessor_Void_CloseGiftCard()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request activateGiftCardRequest = this.GetActivateRequest();
                Request voidRequest = this.helper.CreateVoidRequestForGiftCard();
                this.helper.PrintRequestWhenDebug(voidRequest);

                // Act.
                processor.ActivateGiftCard(activateGiftCardRequest, null);
                Response voidResponse = processor.Void(voidRequest);
                ...
                const decimal ExpectedCloseAmount = decimal.Zero;
                this.helper.AssertPropertyValue(voidResponseProperties, GenericNamespace.VoidResponse, VoidResponseProperties.CloseAmount, ExpectedCloseAmount);
            }

            /// <summary>
            /// Activates, authorizes, and then voids a gift card. Expect success.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            ...
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("737EC213-F2A1-C47F-B5E2-41A4FCF2A66C")]
            [DeploymentItem(@"TestData\PaymentProcessor_Void_BasicGiftCard.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_Void_BasicGiftCard.xml", "PaymentProcessor_Void_BasicGiftCard", DataAccessMethod.Sequential)]
            public void PaymentProcessor_Void_BasicGiftCard()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request activateGiftCardRequest = this.GetActivateRequest();
                ...
                Request voidRequest = this.helper.CreateVoidRequestForGiftCard(authorizeResponse);
                this.helper.PrintRequestWhenDebug(voidRequest);
            ...
            /// <summary>
            /// Validates refund failures, expects different failure results.
            /// </summary>
            [TestMethod]
            [TestOwner("rexu")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("837C9C6B-DC80-4FE7-96C9-AA6D5C3DC662")]
            [DeploymentItem(@"TestData\PaymentProcessor_Refund_FailureResult.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_Refund_FailureResult.xml", "PaymentProcessor_Refund_FailureResult", DataAccessMethod.Sequential)]
            public void PaymentProcessor_Refund_FailureResult()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request refundRequest = this.GetRefundRequest();
                ...
                Hashtable refundResponseProperties = PaymentProperty.ConvertToHashtable(refundResponse.Properties);
                string actualRefundResult;
                PaymentProperty.GetPropertyValue(refundResponseProperties, GenericNamespace.RefundResponse, RefundResponseProperties.RefundResult, out actualRefundResult);
                string expectedRefundResult = this.testContext.GetStringValue(ColumnName.ExpectedRefundResult);
                Assert.AreEqual(expectedRefundResult, actualRefundResult, this.ErrorFormat("The refund result is not expected."));

                string expectedErrorCode = null;
                if (this.testContext.TryGetStringValue(ColumnName.ExpectedErrorCode, out expectedErrorCode))
                {
                    this.helper.AssertResponseErrorCode(refundResponse, expectedErrorCode);
                }
            }
            ...
            /// <summary>
            /// Validates basic refund for activated gift card, expects success.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("8F5B0756-943B-5837-C0E2-47C0E2C63C64")]
            [DeploymentItem(@"TestData\PaymentProcessor_Refund_GiftCardBasic.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_Refund_GiftCardBasic.xml", "PaymentProcessor_Refund_GiftCardBasic", DataAccessMethod.Sequential)]
            public void PaymentProcessor_Refund_GiftCardBasic()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request activateGiftCardRequest = this.GetActivateRequest();
                ...
                const decimal ExpectedApprovedAmount = 1.0M;
                this.helper.AssertPropertyValue(refundResponseProperties, GenericNamespace.RefundResponse, RefundResponseProperties.ApprovedAmount, ExpectedApprovedAmount);
            }

            /// <summary>
            /// Validates correct gift card refund behavior be producing two error messages when gift card has not been activated prior to refund request. Expects two errors codes.
            /// </summary>
            [TestMethod]
            [TestOwner("faromani")]
            [TestStatus(TestStatus.Stabilizing)]
            [TestPriority(Priority.P1)]
            [ExecutionGroup(ExecutionGroup.BAT)]
            [TestKey("73A30167-1B34-83E7-2392-2008C0F6E94F")]
            [DeploymentItem(@"TestData\PaymentProcessor_Refund_GiftCardNotActivated.xml", "TestData")]
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", @"TestData\PaymentProcessor_Refund_GiftCardNotActivated.xml", "PaymentProcessor_Refund_GiftCardNotActivated", DataAccessMethod.Sequential)]
            public void PaymentProcessor_Refund_GiftCardNotActivated()
            {
                // Arrange.
                IPaymentProcessor processor = this.helper.GetPaymentProcessor();
                Request refundRequest = this.GetRefundRequest();
                ...
                this.helper.PrintResponseWhenDebug(refundResponse);
                this.helper.AssertResponseNotNull(refundResponse);
                this.helper.AssertResponseErrorCode(refundResponse, ErrorCode.CardNotActivated);
                this.helper.AssertResponseErrorCode(refundResponse, ErrorCode.Decline);

                const decimal ExpectedApprovalAmount = 0.0M;
                Hashtable refundResponseProperties = PaymentProperty.ConvertToHashtable(refundResponse.Properties);
                this.helper.AssertPropertyValue(refundResponseProperties, GenericNamespace.RefundResponse, RefundResponseProperties.RefundResult, RefundResult.Failure.ToString());
                this.helper.AssertPropertyValue(refundResponseProperties, GenericNamespace.RefundResponse, RefundResponseProperties.ApprovedAmount, ExpectedApprovalAmount);
            }
            #endregion
            ...
            /// </summary>
            [Ignore]
            [IgnoreReason(0, IgnoreReason.TestInfrastructureFeatureDependent, "The SSL certificate has expired on https://paymentacceptsample.cloud.int.dynamics.com used by Test Connector.")]
            [TestMethod]
            [TestOwner("rexu")]
            ...
            private Request GetActivateRequest()
            {
                Request activateRequest = this.helper.GetNewRequestWithMechantAccount();
                var cardProperties = this.helper.GetPaymentCardProperties();
                var activateProperties = this.helper.GetActivateProperties();
                activateRequest.Properties = this.helper.CombineProperties(activateRequest.Properties, cardProperties, activateProperties);
                return activateRequest;
            }

            private Request GetLoadGiftCardRequest()
            {
                Request loadGCRequest = this.helper.GetNewRequestWithMechantAccount();
                PaymentProperty[] cardProperties = this.helper.GetPaymentCardProperties();
                PaymentProperty[] loadProperties = this.helper.GetLoadGiftCardProperties();
                loadGCRequest.Properties = this.helper.CombineProperties(loadGCRequest.Properties, cardProperties, loadProperties);
                return loadGCRequest;
            }

            private Request GetBalanceOnGiftCardRequest()
            {
                Request bogcRequest = this.helper.GetNewRequestWithMechantAccount();
                PaymentProperty[] cardProperties = this.helper.GetPaymentCardProperties();
                PaymentProperty[] bogcProperties = this.helper.GetBalanceOnGiftCardProperties();
                bogcRequest.Properties = this.helper.CombineProperties(bogcRequest.Properties, cardProperties, bogcProperties);
                return bogcRequest;
            }
