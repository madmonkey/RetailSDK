                ...
                if (response != null && response.Errors == null && response.Properties != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(paymentAcceptUrl))
                    {
                        this.PaymentAcceptUrl = string.Format(
                            ...
                            paymentAcceptUrl,
                            Uri.EscapeDataString(this.fontSize),
                            Uri.EscapeDataString(this.fontFamily),
                            Uri.EscapeDataString(this.labelColor),
                            Uri.EscapeDataString(this.textBackgroundColor),
                            Uri.EscapeDataString(this.textColor),
                            Uri.EscapeDataString(this.disabledTextBackgroundColor),
                            Uri.EscapeDataString(this.columnNumber));
            ...
            private void RetrievePaymentAcceptResult()
            {
                ...
                Server.Transfer(
                    string.Format(
                        ...
                        Uri.EscapeDataString(cardTokenResult),
                        Uri.EscapeDataString(authorizationResult),
                        Uri.EscapeDataString(captureResult),
                        Uri.EscapeDataString(voidResult),
