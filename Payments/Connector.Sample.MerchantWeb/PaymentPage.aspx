            ...
            if (typeof message == "string" && message.length > 0) {
                ...
                switch (messageObject.type) {
                    case "msax-cc-height":
                        ...
                        document.getElementById("HeightTextBox").value = messageObject.value;
                        // Set focus on iframe
                        var iframe = document.getElementById("CardPageFrame");
                    ...
                    case "msax-cc-error":
                        ...
                        for (var i = 0; i < paymentErrors.length; i++) {
                            errorLabel.innerText += paymentErrors[i].Code + ":" + paymentErrors[i].Message + " ";
                        }
                        break;
...
<body id="PaymentPageBody" onload="bodyOnload();">
    ...
    <div>
        ...
        <div>
            <div>Received frame height</div>
            <div><asp:TextBox ID="HeightTextBox" ReadOnly="true" runat="server"></asp:TextBox></div>
            <br />
