...
namespace Microsoft.Dynamics
{
    namespace Retail.SampleConnector
    {
        ...
        public class SampleConnector : SampleTenderProcessor, IPaymentProcessor
        {
            ...
            {
                Microsoft.Dynamics.Retail.PaymentSDK.Portable.Response responsePortable =
                    this.portableSampleConnector.ActivateGiftCard(request.ToPortable(), requiredInteractionProperties: null);
                return responsePortable.ToDesktop();
            }
            ...
            {
                Microsoft.Dynamics.Retail.PaymentSDK.Portable.Response responsePortable =
                   this.portableSampleConnector.LoadGiftCard(request.ToPortable(), requiredInteractionProperties: null);
                return responsePortable.ToDesktop();
            }
            ...
            {
                Microsoft.Dynamics.Retail.PaymentSDK.Portable.Response responsePortable =
                   this.portableSampleConnector.BalanceOnGiftCard(request.ToPortable(), requiredInteractionProperties: null);
                return responsePortable.ToDesktop();
            }
