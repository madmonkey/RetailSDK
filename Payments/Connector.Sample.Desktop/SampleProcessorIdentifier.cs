...
namespace Microsoft.Dynamics
{
    namespace Retail.SampleConnector
    {
        ...
        public class SampleProcessorIdentifier : IProcessorIdentifier
        {
            ...
            public string Name
            {
                get { return Resource.ConnectorName; }
            }
            ...
            {
                get { return Resource.ConnectorCopyrightInformation; }
            }
