...
-->
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardPage.aspx.cs" Inherits="Contoso.Retail.SampleConnector.PaymentAcceptWeb.CardPage" %>
...
<head runat="server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            ...
            if (hostPageOrigin != "") {
                ...
                if (resultField.value != "") {
                    var partialAuthField = document.getElementById("IsPartialAuthorizationPendingHiddenField");
                    if (partialAuthField.value == "True") {
                        // Disable inputs
                        disableInputs(false);

                        // Partial authorization need user confirmation. Do not send result access code just yet.
                        var approvedAmountField = document.getElementById("ApprovedAmountHiddenField");

                        // Cross domain message: send approved amount to the request page for confirmation.
                        messageObject.type = "msax-cc-partialamount";
                        messageObject.value = approvedAmountField.value;
                        parent.postMessage(JSON.stringify(messageObject), hostPageOrigin);
                    }
                    else {
                        // Disable inputs
                        ...
                        // Cross domain message: send result access code to the request page.
        ...
        function receiveMessage(event) {
            ...
            if (typeof message == "string" && message.length > 0) {
                ...
                switch (messageObject.type) {
                    case "msax-cc-swipe":
                        // Parse swipe data and fill in inputs
                        handleSwipe(messageObject.value);
                        break;
                    case "msax-cc-amount":
                        // Set payment amount
                    ...
                    case "msax-cc-submit":
                        ...
                        break;
                    case "msax-cc-partialok":
                        // Submit page using ASP.NET AJAX
                        // DO NOT USE form.submit(). IT WILL TRIGGER THE PARENT PAGE TO RELOAD IN SOME SCENARIOS.
                        document.getElementById("IsPartialAuthorizationConfirmedHiddenField").value = messageObject.value; // true or false
                        document.getElementById("SubmitButton").click();
                        break;
                    default:
        ...
        // Sends the page height to the host page.
        function sendDimensions() {
            ...
            if (hostPageOrigin != "") {
                ...
                // Cross domain message: send iframe height to the request page for auto-sizing.
                var messageObject = new Object();
        ...
        function disableInputs(maskInputs) {
            var cardEntryModeDropDownList = document.getElementById("CardEntryModeDropDownList");
            if (cardEntryModeDropDownList != null) {
            ...
            var securityCodeTextBox = document.getElementById("SecurityCodeTextBox");
            if (securityCodeTextBox != null) {
                if (maskInputs && securityCodeTextBox.value != "") {
                    securityCodeTextBox.value = "****";
                }
        ...
        // Parses track data when entry mode is swipe. Otherwise, just eat the swipe.
        function handleSwipe(swipe) {
            var cardEntryModeDropDownList = document.getElementById("CardEntryModeDropDownList");
            
            if (cardEntryModeDropDownList != null && cardEntryModeDropDownList.options[cardEntryModeDropDownList.selectedIndex].value == "swipe") {
                if (!ParseSwipe(swipe)) {
    ...
    <link href="CSS/CardPage.css" rel="stylesheet" type="text/css" />
    <!-- Override styles -->
    <style type="text/css">
...
<body onload="bodyOnload();">
    ...
    <div class="msax-Control">
        ...
        <div><asp:HiddenField ID="IsPartialAuthorizationConfirmedHiddenField" runat="server" /></div>
        ...
        <asp:UpdatePanel ID="ResultUpdatePannel" runat="server">
            <ContentTemplate>
                ...
                <asp:HiddenField ID="ApprovedAmountHiddenField" runat="server" />
                <asp:HiddenField ID="IsPartialAuthorizationPendingHiddenField" runat="server" />
